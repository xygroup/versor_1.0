...
not contain any large blocks of data or anything.
 ...
 this "extension allows you to combine a collection of buffer pointers into a
single OpenGL object, allowing you to change all the buffer pointers by binding
a different vertex array object
...
class VAO {
 ...
 public:
  void generate() {
    ...
    //                glVertexAttribPointer(GL::POS, mSize, mType , bNorm, 0,
    //                data);
  ...
  void bind() { glBindVertexArrayAPPLE(mIdx); }

...
inline Tsd gp(const Tsd& a, const Sca& b) {
  return Tsd(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0], a[4] * b[0]);
}

inline Ori_Flp gp(const Tsd& a, const Ori& b) {
  return Ori_Flp(-a[1] * b[0], -a[2] * b[0], -a[3] * b[0],
                 a[0] * b[0] - a[4] * b[0], -a[1] * b[0], -a[2] * b[0],
                 -a[3] * b[0]);
}

inline Inf gp(const Tsd& a, const Inf& b) {
  return Inf(a[0] * b[0] + a[4] * b[0]);
}

inline Tsd gp(const Tsd& a, const Mnk& b) {
  return Tsd(a[4] * b[0], -a[1] * b[0], -a[2] * b[0], -a[3] * b[0],
             a[0] * b[0]);
}

inline Hyp_Flp gp(const Tsd& a, const Hyp& b) {
  return Hyp_Flp(-a[1] * b[0], -a[2] * b[0], -a[3] * b[0],
                 a[0] * b[0] - a[4] * b[0], a[0] * b[1] + a[4] * b[1],
                 -a[1] * b[0], -a[2] * b[0], -a[3] * b[0]);
}

inline Inf_Sph gp(const Tsd& a, const Pss& b) {
  return Inf_Sph(a[3] * b[0], -a[2] * b[0], a[1] * b[0], a[4] * b[0],
                 a[0] * b[0]);
}

inline Pnt_Flp gp(const Tsd& a, const Pnt& b) {
  return Pnt_Flp(
      a[0] * b[0] - a[1] * b[3], a[0] * b[1] - a[2] * b[3],
      a[0] * b[2] - a[3] * b[3], a[0] * b[3] - a[4] * b[3],
      a[0] * b[4] - a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[4] * b[4],
      -a[1] * b[1] + a[2] * b[0], -a[1] * b[2] + a[3] * b[0],
      -a[2] * b[2] + a[3] * b[1], -a[1] * b[3] + a[4] * b[0],
      -a[2] * b[3] + a[4] * b[1], -a[3] * b[3] + a[4] * b[2]);
}
...
inline Tvt gp(const Tsd& a, const Par& b) {
  return Tvt(
      ...
      a[0] * b[2] + a[2] * b[5] - a[3] * b[4], a[0] * b[3] - a[4] * b[3],
      a[0] * b[4] - a[4] * b[4], a[0] * b[5] - a[4] * b[5],
...
inline Par_Dfp gp(const Tsd& a, const Cir& b) {
  return Par_Dfp(
      ...
      a[1] * b[6] + a[2] * b[7] + a[3] * b[8], a[0] * b[0] - a[4] * b[0],
      a[0] * b[1] - a[4] * b[1], a[0] * b[2] - a[4] * b[2],
...
inline Pnt_Dfp gp(const Tsd& a, const Sph& b) {
  return Pnt_Dfp(
      a[3] * b[3] + a[4] * b[0], -a[2] * b[3] + a[4] * b[1],
      a[1] * b[3] + a[4] * b[2], a[2] * b[0] + a[3] * b[1],
      -a[1] * b[0] + a[3] * b[2], -a[1] * b[1] - a[2] * b[2],
      a[0] * b[0] + a[3] * b[3], a[0] * b[1] - a[2] * b[3],
      a[0] * b[2] + a[1] * b[3], a[0] * b[3] - a[4] * b[3],
      a[0] * b[4] - a[1] * b[2] + a[2] * b[1] - a[3] * b[0] + a[4] * b[4]);
}

inline Tvt gp(const Tsd& a, const Sta& b) {
  return Tvt(a[1] * b[3] + a[2] * b[4] + a[3] * b[5],
             a[0] * b[0] + a[1] * b[4] - a[2] * b[3],
             a[0] * b[1] + a[1] * b[5] - a[3] * b[3],
             a[0] * b[2] + a[2] * b[5] - a[3] * b[4], a[0] * b[3] - a[4] * b[3],
             a[0] * b[4] - a[4] * b[4], a[0] * b[5] - a[4] * b[5],
...
inline Drv gp(const Tsd& a, const Drv& b) {
  return Drv(a[0] * b[0] + a[4] * b[0], a[0] * b[1] + a[4] * b[1],
             a[0] * b[2] + a[4] * b[2]);
}

inline Drb gp(const Tsd& a, const Drb& b) {
  return Drb(a[0] * b[0] + a[4] * b[0], a[0] * b[1] + a[4] * b[1],
             a[0] * b[2] + a[4] * b[2]);
}

inline Drt gp(const Tsd& a, const Drt& b) {
  return Drt(a[0] * b[0] + a[4] * b[0]);
}

inline Tnv_Flp gp(const Tsd& a, const Tnv& b) {
  return Tnv_Flp(a[1] * b[0] + a[2] * b[1] + a[3] * b[2],
                 a[1] * b[1] - a[2] * b[0], a[1] * b[2] - a[3] * b[0],
                 a[2] * b[2] - a[3] * b[1], a[0] * b[0] - a[4] * b[0],
                 a[0] * b[1] - a[4] * b[1], a[0] * b[2] - a[4] * b[2],
...
inline Tnv_Dfp gp(const Tsd& a, const Tnb& b) {
  return Tnv_Dfp(a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2], a[0] * b[0] - a[4] * b[0],
                 a[0] * b[1] - a[4] * b[1], a[0] * b[2] - a[4] * b[2],
                 a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2],
                 -a[1] * b[2] + a[2] * b[1] - a[3] * b[0],
                 -a[1] * b[2] + a[2] * b[1] - a[3] * b[0]);
}
...
inline Ori_Dfp gp(const Tsd& a, const Tnt& b) {
  return Ori_Dfp(a[3] * b[0], -a[2] * b[0], a[1] * b[0], a[3] * b[0],
                 -a[2] * b[0], a[1] * b[0], a[0] * b[0] - a[4] * b[0]);
}

inline Inf_Par gp(const Tsd& a, const Lin& b) {
  return Inf_Par(a[4] * b[3], a[4] * b[4], a[4] * b[5],
                 a[1] * b[3] + a[2] * b[4] + a[3] * b[5],
...
inline Inf_Cir gp(const Tsd& a, const Pln& b) {
  return Inf_Cir(
      a[4] * b[0], a[4] * b[1], a[4] * b[2], a[2] * b[0] + a[3] * b[1],
      -a[1] * b[0] + a[3] * b[2], -a[1] * b[1] - a[2] * b[2], a[0] * b[0],
      a[0] * b[1], a[0] * b[2],
      a[0] * b[3] - a[1] * b[2] + a[2] * b[1] - a[3] * b[0] + a[4] * b[3]);
}

inline Tsd gp(const Tsd& a, const Flp& b) {
  return Tsd(a[4] * b[3], a[0] * b[0] - a[1] * b[3] + a[4] * b[0],
             a[0] * b[1] - a[2] * b[3] + a[4] * b[1],
             a[0] * b[2] - a[3] * b[3] + a[4] * b[2], a[0] * b[3]);
}

inline Inf_Sph gp(const Tsd& a, const Dfp& b) {
  return Inf_Sph(a[0] * b[0] - a[3] * b[3] + a[4] * b[0],
                 a[0] * b[1] + a[2] * b[3] + a[4] * b[1],
                 a[0] * b[2] - a[1] * b[3] + a[4] * b[2], a[0] * b[3],
                 a[4] * b[3]);
}

inline Inf_Cir gp(const Tsd& a, const Dll& b) {
  return Inf_Cir(a[0] * b[0], a[0] * b[1], a[0] * b[2],
...
inline Inf_Par gp(const Tsd& a, const Dlp& b) {
  return Inf_Par(
      ...
      -a[1] * b[1] + a[2] * b[0], -a[1] * b[2] + a[3] * b[0],
      -a[2] * b[2] + a[3] * b[1], a[4] * b[0], a[4] * b[1], a[4] * b[2]);
}

inline Inf_Par gp(const Tsd& a, const Vec& b) {
  return Inf_Par(a[0] * b[0], a[0] * b[1], a[0] * b[2],
                 -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 -a[1] * b[1] + a[2] * b[0], -a[1] * b[2] + a[3] * b[0],
                 -a[2] * b[2] + a[3] * b[1], a[4] * b[0], a[4] * b[1],
                 a[4] * b[2]);
}
...
inline Inf_Cir gp(const Tsd& a, const Biv& b) {
  return Inf_Cir(a[0] * b[0], a[0] * b[1], a[0] * b[2],
                 -a[2] * b[0] - a[3] * b[1], a[1] * b[0] - a[3] * b[2],
                 a[1] * b[1] + a[2] * b[2], a[4] * b[0], a[4] * b[1],
                 a[4] * b[2], a[1] * b[2] - a[2] * b[1] + a[3] * b[0]);
}

inline Inf_Sph gp(const Tsd& a, const Tri& b) {
  return Inf_Sph(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[0] * b[0],
                 a[4] * b[0]);
}

inline Pnt_Flp gp(const Tsd& a, const Aff& b) {
  return Pnt_Flp(a[0] * b[0] - a[1] * b[3], a[0] * b[1] - a[2] * b[3],
                 a[0] * b[2] - a[3] * b[3], a[0] * b[3] - a[4] * b[3],
                 -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 -a[1] * b[1] + a[2] * b[0], -a[1] * b[2] + a[3] * b[0],
                 -a[2] * b[2] + a[3] * b[1], -a[1] * b[3] + a[4] * b[0],
...
inline Tvt gp(const Tsd& a, const Afl& b) {
  return Tvt(a[1] * b[3] + a[2] * b[4] + a[3] * b[5],
             ...
             a[0] * b[4] - a[4] * b[4], a[0] * b[5] - a[4] * b[5],
             -a[2] * b[0] - a[3] * b[1], a[1] * b[0] - a[3] * b[2],
             a[1] * b[1] + a[2] * b[2], a[1] * b[3] + a[2] * b[4] + a[3] * b[5],
             a[1] * b[4] - a[2] * b[3] + a[4] * b[0],
             a[1] * b[5] - a[3] * b[3] + a[4] * b[1],
             a[2] * b[5] - a[3] * b[4] + a[4] * b[2],
             a[1] * b[2] - a[2] * b[1] + a[3] * b[0]);
...
inline Flp_Afp gp(const Tsd& a, const Afp& b) {
  return Flp_Afp(a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2], a[0] * b[0] - a[4] * b[0],
                 a[0] * b[1] - a[4] * b[1], a[0] * b[2] - a[4] * b[2],
...
inline Trt gp(const Tsd& a, const Dap& b) {
  return Trt(a[1] * b[0] + a[2] * b[1] + a[3] * b[2] + a[4] * b[3],
             a[1] * b[1] - a[2] * b[0], a[1] * b[2] - a[3] * b[0],
             a[2] * b[2] - a[3] * b[1], a[0] * b[0] - a[4] * b[0],
             a[0] * b[1] - a[4] * b[1], a[0] * b[2] - a[4] * b[2], -a[1] * b[3],
             -a[2] * b[3], -a[3] * b[3],
...
inline Pnt_Dfp gp(const Tsd& a, const Daf& b) {
  return Pnt_Dfp(a[3] * b[3] + a[4] * b[0], -a[2] * b[3] + a[4] * b[1],
                 a[1] * b[3] + a[4] * b[2], a[2] * b[0] + a[3] * b[1],
                 -a[1] * b[0] + a[3] * b[2], -a[1] * b[1] - a[2] * b[2],
                 a[0] * b[0] + a[3] * b[3], a[0] * b[1] - a[2] * b[3],
                 a[0] * b[2] + a[1] * b[3], a[0] * b[3] - a[4] * b[3],
...
inline Par_Dfp gp(const Tsd& a, const Dal& b) {
  return Par_Dfp(a[2] * b[0] + a[3] * b[1] + a[4] * b[3],
                 -a[1] * b[0] + a[3] * b[2] + a[4] * b[4],
                 -a[1] * b[1] - a[2] * b[2] + a[4] * b[5],
                 a[1] * b[3] + a[2] * b[4] + a[3] * b[5],
                 a[0] * b[0] - a[4] * b[0], a[0] * b[1] - a[4] * b[1],
                 a[0] * b[2] - a[4] * b[2], a[1] * b[4] - a[2] * b[3],
                 a[1] * b[5] - a[3] * b[3], a[2] * b[5] - a[3] * b[4],
...
inline Inf_Par gp(const Tsd& a, const Mnv& b) {
  return Inf_Par(a[4] * b[0], a[4] * b[1], a[4] * b[2],
                 a[1] * b[0] + a[2] * b[1] + a[3] * b[2],
                 a[1] * b[1] - a[2] * b[0], a[1] * b[2] - a[3] * b[0],
                 a[2] * b[2] - a[3] * b[1], a[0] * b[0], a[0] * b[1],
                 a[0] * b[2]);
}
...
inline Mtd gp(const Tsd& a, const Rot& b) {
  return Mtd(a[0] * b[0], a[0] * b[1], a[0] * b[2], a[0] * b[3],
             ...
             a[1] * b[2] + a[2] * b[3] + a[3] * b[0], a[4] * b[0], a[4] * b[1],
             a[4] * b[2], a[4] * b[3], a[1] * b[3] - a[2] * b[2] + a[3] * b[1]);
}
...
inline Tsd gp(const Tsd& a, const Dil& b) {
  return Tsd(a[0] * b[0] + a[4] * b[1], a[1] * b[0] - a[1] * b[1],
...
inline Trt gp(const Tsd& a, const Trv& b) {
  return Trt(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] + a[3] * b[3],
             ...
             a[2] * b[3] - a[3] * b[2], a[0] * b[1] - a[4] * b[1],
             a[0] * b[2] - a[4] * b[2], a[0] * b[3] - a[4] * b[3], a[1] * b[0],
             a[2] * b[0], a[3] * b[0],
...
inline Mtd gp(const Tsd& a, const Mtd& b) {
  return Mtd(a[0] * b[0] + a[4] * b[7], a[0] * b[1] + a[4] * b[8],
             a[0] * b[2] + a[4] * b[9], a[0] * b[3] + a[4] * b[10],
             a[0] * b[4] + a[1] * b[0] - a[1] * b[7] - a[2] * b[1] +
                 a[2] * b[8] - a[3] * b[2] + a[3] * b[9] + a[4] * b[4],
             a[0] * b[5] + a[1] * b[1] - a[1] * b[8] + a[2] * b[0] -
                 a[2] * b[7] - a[3] * b[3] + a[3] * b[10] + a[4] * b[5],
             a[0] * b[6] + a[1] * b[2] - a[1] * b[9] + a[2] * b[3] -
                 a[2] * b[10] + a[3] * b[0] - a[3] * b[7] + a[4] * b[6],
             a[0] * b[7] + a[4] * b[0], a[0] * b[8] + a[4] * b[1],
             a[0] * b[9] + a[4] * b[2], a[0] * b[10] + a[4] * b[3],
             a[0] * b[11] + a[1] * b[3] - a[1] * b[10] - a[2] * b[2] +
                 a[2] * b[9] + a[3] * b[1] - a[3] * b[8] + a[4] * b[11]);
}

inline Tsd gp(const Tsd& a, const Trs& b) {
  return Tsd(a[0] * b[0], a[0] * b[1] + a[1] * b[0] + a[4] * b[1],
             a[0] * b[2] + a[2] * b[0] + a[4] * b[2],
             a[0] * b[3] + a[3] * b[0] + a[4] * b[3], a[4] * b[0]);
}
...
inline Rtc gp(const Tsd& a, const Rtc& b) {
  return Rtc(
      ...
      a[0] * b[3] - a[4] * b[3],
      a[0] * b[4] - a[1] * b[0] + a[1] * b[11] - a[2] * b[1] + a[2] * b[12] -
          a[3] * b[2] + a[3] * b[13] + a[4] * b[4],
      a[0] * b[5] - a[4] * b[5], a[0] * b[6] - a[4] * b[6],
      a[0] * b[7] - a[4] * b[7],
      a[0] * b[8] - a[1] * b[1] + a[1] * b[12] + a[2] * b[0] - a[2] * b[11] -
          a[3] * b[14] + a[3] * b[15] + a[4] * b[8],
      a[0] * b[9] - a[1] * b[2] + a[1] * b[13] + a[2] * b[14] - a[2] * b[15] +
          a[3] * b[0] - a[3] * b[11] + a[4] * b[9],
      a[0] * b[10] - a[1] * b[14] + a[1] * b[15] - a[2] * b[2] + a[2] * b[13] +
          a[3] * b[1] - a[3] * b[12] + a[4] * b[10],
...
inline Mtt gp(const Tsd& a, const Mtt& b) {
  return Mtt(
      ...
      a[0] * b[4] - a[4] * b[4], a[0] * b[5] - a[4] * b[5],
      a[0] * b[6] - a[4] * b[6],
      a[0] * b[7] + a[1] * b[0] - a[1] * b[10] - a[2] * b[1] + a[2] * b[11] -
          a[3] * b[2] + a[3] * b[12] + a[4] * b[7],
      a[0] * b[8] + a[1] * b[1] - a[1] * b[11] + a[2] * b[0] - a[2] * b[10] -
          a[3] * b[3] + a[3] * b[13] + a[4] * b[8],
      a[0] * b[9] + a[1] * b[2] - a[1] * b[12] + a[2] * b[3] - a[2] * b[13] +
          a[3] * b[0] - a[3] * b[10] + a[4] * b[9],
      ...
      a[0] * b[14] - a[4] * b[14],
      a[0] * b[15] + a[1] * b[3] - a[1] * b[13] - a[2] * b[2] + a[2] * b[12] +
          a[3] * b[1] - a[3] * b[11] + a[4] * b[15]);
}

inline Mtt gp(const Tsd& a, const Rtt& b) {
  return Mtt(a[0] * b[0] + a[1] * b[4] + a[2] * b[5] + a[3] * b[6],
             a[0] * b[1] + a[1] * b[5] - a[2] * b[4] + a[3] * b[7],
             a[0] * b[2] + a[1] * b[6] - a[2] * b[7] - a[3] * b[4],
             a[0] * b[3] + a[1] * b[7] + a[2] * b[6] - a[3] * b[5],
             a[0] * b[4] - a[4] * b[4], a[0] * b[5] - a[4] * b[5],
             a[0] * b[6] - a[4] * b[6], a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
             a[1] * b[1] + a[2] * b[0] - a[3] * b[3],
...
inline Mtd gp(const Tsd& a, const Rtd& b) {
  return Mtd(a[0] * b[0] + a[4] * b[4], a[0] * b[1] + a[4] * b[5],
             a[0] * b[2] + a[4] * b[6], a[0] * b[3] + a[4] * b[7],
             a[1] * b[0] - a[1] * b[4] - a[2] * b[1] + a[2] * b[5] -
                 a[3] * b[2] + a[3] * b[6],
             a[1] * b[1] - a[1] * b[5] + a[2] * b[0] - a[2] * b[4] -
                 a[3] * b[3] + a[3] * b[7],
             a[1] * b[2] - a[1] * b[6] + a[2] * b[3] - a[2] * b[7] +
                 a[3] * b[0] - a[3] * b[4],
             a[0] * b[4] + a[4] * b[0], a[0] * b[5] + a[4] * b[1],
             a[0] * b[6] + a[4] * b[2], a[0] * b[7] + a[4] * b[3],
             a[1] * b[3] - a[1] * b[7] - a[2] * b[2] + a[2] * b[6] +
                 a[3] * b[1] - a[3] * b[5]);
}
...
inline Trt gp(const Tsd& a, const Tvd& b) {
  return Trt(
      ...
      a[1] * b[2] - a[2] * b[1], a[1] * b[3] - a[3] * b[1],
      a[2] * b[3] - a[3] * b[2], a[0] * b[1] - a[4] * b[1],
      a[0] * b[2] - a[4] * b[2], a[0] * b[3] - a[4] * b[3],
...
inline Tvt gp(const Tsd& a, const Trt& b) {
  return Tvt(
      ...
      a[1] * b[3] - a[1] * b[13] - a[2] * b[2] + a[2] * b[12] + a[3] * b[1] -
          a[3] * b[11]);
}
...
inline Mtt gp(const Tsd& a, const Rvd& b) {
  return Mtt(
      ...
      a[0] * b[4] - a[4] * b[4], a[0] * b[5] - a[4] * b[5],
      a[0] * b[6] - a[4] * b[6],
      a[1] * b[0] - a[1] * b[7] - a[2] * b[1] + a[2] * b[8] - a[3] * b[2] +
          a[3] * b[9],
      a[1] * b[1] - a[1] * b[8] + a[2] * b[0] - a[2] * b[7] - a[3] * b[3] +
          a[3] * b[10],
      a[1] * b[2] - a[1] * b[9] + a[2] * b[3] - a[2] * b[10] + a[3] * b[0] -
          a[3] * b[7],
      ...
      a[0] * b[11] - a[4] * b[11],
      a[1] * b[3] - a[1] * b[10] - a[2] * b[2] + a[2] * b[9] + a[3] * b[1] -
          a[3] * b[8]);
}
...
inline Tvt gp(const Tsd& a, const Tvt& b) {
  return Tvt(
      ...
      a[0] * b[12] + a[1] * b[6] - a[3] * b[4] + a[4] * b[2],
      a[0] * b[13] + a[2] * b[6] - a[3] * b[5] + a[4] * b[3],
      a[0] * b[14] + a[1] * b[3] - a[1] * b[13] - a[2] * b[2] + a[2] * b[12] +
          a[3] * b[1] - a[3] * b[11] + a[4] * b[14]);
}
...
inline Tvt gp(const Tsd& a, const Bst& b) {
  return Tvt(
      ...
      a[0] * b[3] + a[2] * b[6] - a[3] * b[5], a[0] * b[4] - a[4] * b[4],
      a[0] * b[5] - a[4] * b[5], a[0] * b[6] - a[4] * b[6],
...
inline Tsd ip(const Tsd& a, const Tsd& b) {
  return Tsd(a[0] * b[0] + a[4] * b[4], a[0] * b[1], a[0] * b[2], a[0] * b[3],
             a[0] * b[4]);
}
...
inline Tsd sp(const Tsd& tsd, const Rot& rot) {
  ...
  Mtd t3(t1[0] * t2[0], t1[1] * t2[0], t1[2] * t2[0], t1[3] * t2[0],
         ...
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2], t1[0] * t2[4],
         t1[1] * t2[4], t1[2] * t2[4], t1[3] * t2[4],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1]);
  const Rot& t4 = rot;
  Rot t5 = reverse(t4);
  return Tsd(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3],
...
inline Tsd sp(const Tsd& tsd, const Mot& mot) {
  ...
  Mtd t3(t1[0] * t2[0], t1[1] * t2[0], t1[2] * t2[0], t1[3] * t2[0],
         ...
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[6] * t2[0] -
             t1[6] * t2[4],
         t1[0] * t2[4], t1[1] * t2[4], t1[2] * t2[4], t1[3] * t2[4],
...
inline Tsd sp(const Tsd& tsd, const Dil& dil) {
  const Dil& t1 = dil;
  const Tsd& t2 = tsd;
  Tsd t3(t1[0] * t2[0] + t1[1] * t2[4], t1[0] * t2[1] + t1[1] * t2[1],
         t1[0] * t2[2] + t1[1] * t2[2], t1[0] * t2[3] + t1[1] * t2[3],
         t1[0] * t2[4] + t1[1] * t2[0]);
  const Dil& t4 = dil;
  Dil t5 = reverse(t4);
  return Tsd(t3[0] * t5[0] + t3[4] * t5[1], t3[1] * t5[0] - t3[1] * t5[1],
             t3[2] * t5[0] - t3[2] * t5[1], t3[3] * t5[0] - t3[3] * t5[1],
             t3[0] * t5[1] + t3[4] * t5[0]);
}
...
inline Tsd sp(const Tsd& tsd, const Trv& trv) {
  const Trv& t1 = trv;
  const Tsd& t2 = tsd;
  Trt t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] + t1[3] * t2[3],
         t1[1] * t2[2] - t1[2] * t2[1], t1[1] * t2[3] - t1[3] * t2[1],
         t1[2] * t2[3] - t1[3] * t2[2], t1[1] * t2[0] + t1[1] * t2[4],
         t1[2] * t2[0] + t1[2] * t2[4], t1[3] * t2[0] + t1[3] * t2[4],
         t1[0] * t2[1], t1[0] * t2[2], t1[0] * t2[3],
         t1[0] * t2[4] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3],
         -t1[1] * t2[2] + t1[2] * t2[1], -t1[1] * t2[3] + t1[3] * t2[1],
         -t1[2] * t2[3] + t1[3] * t2[2]);
  const Trv& t4 = trv;
  Trv t5 = reverse(t4);
  return Tsd(t3[0] * t5[0] + t3[7] * t5[1] + t3[8] * t5[2] + t3[9] * t5[3],
...
inline Tsd sp(const Tsd& tsd, const Mtd& mtd) {
  const Mtd& t1 = mtd;
  const Tsd& t2 = tsd;
  Mtd t3(t1[0] * t2[0] + t1[7] * t2[4], t1[1] * t2[0] + t1[8] * t2[4],
         t1[2] * t2[0] + t1[9] * t2[4], t1[3] * t2[0] + t1[10] * t2[4],
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[4] * t2[0] -
             t1[4] * t2[4] + t1[7] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3] + t1[5] * t2[0] -
             t1[5] * t2[4] + t1[7] * t2[2] - t1[8] * t2[1] + t1[10] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[6] * t2[0] -
             t1[6] * t2[4] + t1[7] * t2[3] - t1[9] * t2[1] - t1[10] * t2[2],
         t1[0] * t2[4] + t1[7] * t2[0], t1[1] * t2[4] + t1[8] * t2[0],
         t1[2] * t2[4] + t1[9] * t2[0], t1[3] * t2[4] + t1[10] * t2[0],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1] + t1[8] * t2[3] -
             t1[9] * t2[2] + t1[10] * t2[1] + t1[11] * t2[0] - t1[11] * t2[4]);
  const Mtd& t4 = mtd;
  Mtd t5 = reverse(t4);
  return Tsd(
      t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3] +
...
inline Tsd sp(const Tsd& tsd, const Trs& trs) {
  const Trs& t1 = trs;
  const Tsd& t2 = tsd;
  Tsd t3(t1[0] * t2[0], t1[0] * t2[1] + t1[1] * t2[0] - t1[1] * t2[4],
         t1[0] * t2[2] + t1[2] * t2[0] - t1[2] * t2[4],
         t1[0] * t2[3] + t1[3] * t2[0] - t1[3] * t2[4], t1[0] * t2[4]);
  const Trs& t4 = trs;
  Trs t5 = reverse(t4);
  return Tsd(t3[0] * t5[0], t3[0] * t5[1] + t3[1] * t5[0] + t3[4] * t5[1],
             t3[0] * t5[2] + t3[2] * t5[0] + t3[4] * t5[2],
             t3[0] * t5[3] + t3[3] * t5[0] + t3[4] * t5[3], t3[4] * t5[0]);
}
...
inline Tsd sp(const Tsd& tsd, const Rtc& rtc) {
  const Rtc& t1 = rtc;
  const Tsd& t2 = tsd;
  Rtc t3(t1[0] * t2[0] + t1[3] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3] +
             t1[11] * t2[4],
         ...
         t1[3] * t2[0] + t1[3] * t2[4],
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[4] * t2[0] -
             t1[4] * t2[4] + t1[11] * t2[1] + t1[12] * t2[2] + t1[13] * t2[3],
         t1[5] * t2[0] + t1[5] * t2[4], t1[6] * t2[0] + t1[6] * t2[4],
         t1[7] * t2[0] + t1[7] * t2[4],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[8] * t2[0] - t1[8] * t2[4] +
             t1[11] * t2[2] - t1[12] * t2[1] + t1[14] * t2[3] + t1[15] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] + t1[9] * t2[0] - t1[9] * t2[4] +
             t1[11] * t2[3] - t1[13] * t2[1] - t1[14] * t2[2] - t1[15] * t2[2],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[10] * t2[0] - t1[10] * t2[4] +
             t1[12] * t2[3] - t1[13] * t2[2] + t1[14] * t2[1] + t1[15] * t2[1],
         t1[0] * t2[4] - t1[3] * t2[1] - t1[5] * t2[2] - t1[6] * t2[3] +
             t1[11] * t2[0],
         t1[1] * t2[4] - t1[3] * t2[2] + t1[5] * t2[1] - t1[7] * t2[3] +
             t1[12] * t2[0],
         t1[2] * t2[4] - t1[3] * t2[3] + t1[6] * t2[1] + t1[7] * t2[2] +
             t1[13] * t2[0],
         t1[5] * t2[3] - t1[6] * t2[2] + t1[7] * t2[1] + t1[14] * t2[0] +
             t1[15] * t2[4],
         -t1[5] * t2[3] + t1[6] * t2[2] - t1[7] * t2[1] + t1[14] * t2[4] +
             t1[15] * t2[0]);
  const Rtc& t4 = rtc;
  Rtc t5 = reverse(t4);
  return Tsd(
...
inline Tsd sp(const Tsd& tsd, const Mtt& mtt) {
  const Mtt& t1 = mtt;
  const Tsd& t2 = tsd;
  Mtt t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3] +
             t1[10] * t2[4],
         ...
         t1[3] * t2[0] + t1[5] * t2[3] - t1[6] * t2[2] + t1[13] * t2[4] +
             t1[14] * t2[1],
         t1[4] * t2[0] + t1[4] * t2[4], t1[5] * t2[0] + t1[5] * t2[4],
         t1[6] * t2[0] + t1[6] * t2[4],
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[7] * t2[0] -
             t1[7] * t2[4] + t1[10] * t2[1] + t1[11] * t2[2] + t1[12] * t2[3],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3] + t1[8] * t2[0] -
             t1[8] * t2[4] + t1[10] * t2[2] - t1[11] * t2[1] + t1[13] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[9] * t2[0] -
             t1[9] * t2[4] + t1[10] * t2[3] - t1[12] * t2[1] - t1[13] * t2[2],
         ...
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1] + t1[11] * t2[3] -
             t1[12] * t2[2] + t1[13] * t2[1] + t1[15] * t2[0] - t1[15] * t2[4]);
  const Mtt& t4 = mtt;
  Mtt t5 = reverse(t4);
  return Tsd(
      t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3] +
...
inline Tsd sp(const Tsd& tsd, const Rtd& rtd) {
  const Rtd& t1 = rtd;
  const Tsd& t2 = tsd;
  Mtd t3(t1[0] * t2[0] + t1[4] * t2[4], t1[1] * t2[0] + t1[5] * t2[4],
         t1[2] * t2[0] + t1[6] * t2[4], t1[3] * t2[0] + t1[7] * t2[4],
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[4] * t2[1] +
             t1[5] * t2[2] + t1[6] * t2[3],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3] + t1[4] * t2[2] -
             t1[5] * t2[1] + t1[7] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[4] * t2[3] -
             t1[6] * t2[1] - t1[7] * t2[2],
         t1[0] * t2[4] + t1[4] * t2[0], t1[1] * t2[4] + t1[5] * t2[0],
         t1[2] * t2[4] + t1[6] * t2[0], t1[3] * t2[4] + t1[7] * t2[0],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1] + t1[5] * t2[3] -
             t1[6] * t2[2] + t1[7] * t2[1]);
  const Rtd& t4 = rtd;
  Rtd t5 = reverse(t4);
  return Tsd(
...
inline Tsd sp(const Tsd& tsd, const Trt& trt) {
  const Trt& t1 = trt;
  const Tsd& t2 = tsd;
  Tvt t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3] +
             t1[10] * t2[4],
         t1[1] * t2[0] + t1[4] * t2[2] - t1[5] * t2[1] + t1[11] * t2[4],
         t1[2] * t2[0] + t1[4] * t2[3] - t1[6] * t2[1] + t1[12] * t2[4],
         t1[3] * t2[0] + t1[5] * t2[3] - t1[6] * t2[2] + t1[13] * t2[4],
...
inline Tsd sp(const Tsd& tsd, const Rvd& rvd) {
  ...
  Mtt t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3] +
             t1[7] * t2[4],
         t1[1] * t2[0] + t1[4] * t2[2] - t1[5] * t2[1] + t1[8] * t2[4] +
             t1[11] * t2[3],
         t1[2] * t2[0] + t1[4] * t2[3] - t1[6] * t2[1] + t1[9] * t2[4] -
             t1[11] * t2[2],
         t1[3] * t2[0] + t1[5] * t2[3] - t1[6] * t2[2] + t1[10] * t2[4] +
             t1[11] * t2[1],
         t1[4] * t2[0] + t1[4] * t2[4], t1[5] * t2[0] + t1[5] * t2[4],
         t1[6] * t2[0] + t1[6] * t2[4],
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[7] * t2[1] +
             t1[8] * t2[2] + t1[9] * t2[3],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3] + t1[7] * t2[2] -
             t1[8] * t2[1] + t1[10] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[7] * t2[3] -
             t1[9] * t2[1] - t1[10] * t2[2],
         t1[0] * t2[4] - t1[4] * t2[1] - t1[5] * t2[2] - t1[6] * t2[3] +
             t1[7] * t2[0],
         t1[1] * t2[4] - t1[4] * t2[2] + t1[5] * t2[1] + t1[8] * t2[0] -
             t1[11] * t2[3],
         t1[2] * t2[4] - t1[4] * t2[3] + t1[6] * t2[1] + t1[9] * t2[0] +
             t1[11] * t2[2],
         t1[3] * t2[4] - t1[5] * t2[3] + t1[6] * t2[2] + t1[10] * t2[0] -
             t1[11] * t2[1],
...
inline Tsd sp(const Tsd& tsd, const Tvt& tvt) {
  ...
  Tvt t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3] +
         ...
         t1[3] * t2[4] - t1[5] * t2[3] + t1[6] * t2[2] + t1[13] * t2[0],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1] + t1[11] * t2[3] -
             t1[12] * t2[2] + t1[13] * t2[1] + t1[14] * t2[0] - t1[14] * t2[4]);
  const Tvt& t4 = tvt;
  Tvt t5 = reverse(t4);
  return Tsd(
      t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3] +
...
inline Tsd sp(const Tsd& tsd, const Bst& bst) {
  ...
  Tvt t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3] +
         ...
         t1[6] * t2[0] + t1[6] * t2[4],
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[7] * t2[0] -
             t1[7] * t2[4] + t1[10] * t2[1],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3] + t1[8] * t2[0] -
             t1[8] * t2[4] + t1[10] * t2[2],
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[9] * t2[0] -
...
inline Tsd re(const Tsd& tsd, const Vec& vec) {
  ...
  const Tsd& t2 = tsd;
  Tsd t3 = involute(t2);
  Inf_Par t4(t1[0] * t3[0], t1[1] * t3[0], t1[2] * t3[0],
             t1[0] * t3[1] + t1[1] * t3[2] + t1[2] * t3[3],
             t1[0] * t3[2] - t1[1] * t3[1], t1[0] * t3[3] - t1[2] * t3[1],
             t1[1] * t3[3] - t1[2] * t3[2], t1[0] * t3[4], t1[1] * t3[4],
             t1[2] * t3[4]);
  const Vec& t5 = vec;
  Vec t6 = reverse(t5);
  return Tsd(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2],
...
inline Tsd re(const Tsd& tsd, const Pln& pln) {
  ...
  const Tsd& t2 = tsd;
  Tsd t3 = involute(t2);
  Inf_Cir t4(t1[0] * t3[4], t1[1] * t3[4], t1[2] * t3[4],
             t1[0] * t3[2] + t1[1] * t3[3], -t1[0] * t3[1] + t1[2] * t3[3],
             -t1[1] * t3[1] - t1[2] * t3[2], t1[0] * t3[0], t1[1] * t3[0],
             t1[2] * t3[0],
             t1[0] * t3[3] - t1[1] * t3[2] + t1[2] * t3[1] + t1[3] * t3[0] -
                 t1[3] * t3[4]);
  const Pln& t5 = pln;
  Pln t6 = reverse(t5);
  return Tsd(-t4[6] * t6[0] - t4[7] * t6[1] - t4[8] * t6[2],
             -t4[2] * t6[3] + t4[4] * t6[0] + t4[5] * t6[1] - t4[8] * t6[3] +
                 t4[9] * t6[2],
...
inline Tsd re(const Tsd& tsd, const Dll& dll) {
  ...
  const Tsd& t2 = tsd;
  Tsd t3 = involute(t2);
  Inf_Cir t4(t1[0] * t3[0], t1[1] * t3[0], t1[2] * t3[0],
             t1[0] * t3[2] + t1[1] * t3[3] + t1[3] * t3[0] - t1[3] * t3[4],
             -t1[0] * t3[1] + t1[2] * t3[3] + t1[4] * t3[0] - t1[4] * t3[4],
             -t1[1] * t3[1] - t1[2] * t3[2] + t1[5] * t3[0] - t1[5] * t3[4],
             t1[0] * t3[4], t1[1] * t3[4], t1[2] * t3[4],
             t1[0] * t3[3] - t1[1] * t3[2] + t1[2] * t3[1]);
  const Dll& t5 = dll;
  Dll t6 = reverse(t5);
  return Tsd(-t4[0] * t6[0] - t4[1] * t6[1] - t4[2] * t6[2],
             t4[0] * t6[4] + t4[1] * t6[5] - t4[4] * t6[0] - t4[5] * t6[1] +
                 t4[6] * t6[4] + t4[7] * t6[5] - t4[9] * t6[2],
             -t4[0] * t6[3] + t4[2] * t6[5] + t4[3] * t6[0] - t4[5] * t6[2] -
                 t4[6] * t6[3] + t4[8] * t6[5] + t4[9] * t6[1],
             -t4[1] * t6[3] - t4[2] * t6[4] + t4[3] * t6[1] + t4[4] * t6[2] -
                 t4[7] * t6[3] - t4[8] * t6[4] - t4[9] * t6[0],
...
inline Tsd re(const Tsd& tsd, const Lin& lin) {
  ...
  const Tsd& t2 = tsd;
  Tsd t3 = involute(t2);
  Inf_Par t4(t1[3] * t3[4], t1[4] * t3[4], t1[5] * t3[4],
             ...
             t1[3] * t3[0], t1[4] * t3[0], t1[5] * t3[0]);
  const Lin& t5 = lin;
  Lin t6 = reverse(t5);
  return Tsd(t4[7] * t6[3] + t4[8] * t6[4] + t4[9] * t6[5],
...
inline Tsd re(const Tsd& tsd, const Pnt& pnt) {
  ...
  const Tsd& t2 = tsd;
  Tsd t3 = involute(t2);
  Pnt_Flp t4(t1[0] * t3[0] + t1[3] * t3[1], t1[1] * t3[0] + t1[3] * t3[2],
             t1[2] * t3[0] + t1[3] * t3[3], t1[3] * t3[0] + t1[3] * t3[4],
             t1[0] * t3[1] + t1[1] * t3[2] + t1[2] * t3[3] + t1[4] * t3[0] -
                 t1[4] * t3[4],
             t1[0] * t3[2] - t1[1] * t3[1], t1[0] * t3[3] - t1[2] * t3[1],
             t1[1] * t3[3] - t1[2] * t3[2], t1[0] * t3[4] - t1[3] * t3[1],
             t1[1] * t3[4] - t1[3] * t3[2], t1[2] * t3[4] - t1[3] * t3[3]);
  const Pnt& t5 = pnt;
  Pnt t6 = reverse(t5);
  return Tsd(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[3] * t6[4] -
                 t4[4] * t6[3],
...
inline Tsd re(const Tsd& tsd, const Par& par) {
  ...
  const Tsd& t2 = tsd;
  Tsd t3 = involute(t2);
  Tvt t4(t1[3] * t3[1] + t1[4] * t3[2] + t1[5] * t3[3] + t1[9] * t3[4],
         ...
         t1[5] * t3[0] + t1[5] * t3[4],
         t1[0] * t3[2] + t1[1] * t3[3] + t1[6] * t3[0] - t1[6] * t3[4] +
             t1[9] * t3[1],
         -t1[0] * t3[1] + t1[2] * t3[3] + t1[7] * t3[0] - t1[7] * t3[4] +
             t1[9] * t3[2],
         -t1[1] * t3[1] - t1[2] * t3[2] + t1[8] * t3[0] - t1[8] * t3[4] +
             t1[9] * t3[3],
  ...
  const Par& t5 = par;
  Par t6 = reverse(t5);
  return Tsd(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2] + t4[4] * t6[6] +
...
inline Tsd re(const Tsd& tsd, const Cir& cir) {
  ...
  const Tsd& t2 = tsd;
  Tsd t3 = involute(t2);
  Par_Dfp t4(t1[0] * t3[2] + t1[1] * t3[3] + t1[6] * t3[4],
             -t1[0] * t3[1] + t1[2] * t3[3] + t1[7] * t3[4],
             -t1[1] * t3[1] - t1[2] * t3[2] + t1[8] * t3[4],
             t1[6] * t3[1] + t1[7] * t3[2] + t1[8] * t3[3],
             t1[0] * t3[0] + t1[0] * t3[4], t1[1] * t3[0] + t1[1] * t3[4],
             t1[2] * t3[0] + t1[2] * t3[4],
             t1[3] * t3[0] - t1[3] * t3[4] + t1[6] * t3[2] - t1[7] * t3[1] +
                 t1[9] * t3[3],
             t1[4] * t3[0] - t1[4] * t3[4] + t1[6] * t3[3] - t1[8] * t3[1] -
                 t1[9] * t3[2],
             t1[5] * t3[0] - t1[5] * t3[4] + t1[7] * t3[3] - t1[8] * t3[2] +
                 t1[9] * t3[1],
  ...
  const Cir& t5 = cir;
  Cir t6 = reverse(t5);
  return Tsd(t4[4] * t6[3] + t4[5] * t6[4] + t4[6] * t6[5] + t4[7] * t6[0] +
                 t4[8] * t6[1] + t4[9] * t6[2] + t4[10] * t6[6] +
                 t4[11] * t6[7] + t4[12] * t6[8] - t4[13] * t6[9],
             -t4[1] * t6[3] - t4[2] * t6[4] + t4[3] * t6[6] + t4[7] * t6[7] +
...
inline Tsd re(const Tsd& tsd, const Sph& sph) {
  ...
  const Tsd& t2 = tsd;
  Tsd t3 = involute(t2);
  Pnt_Dfp t4(t1[0] * t3[4] + t1[3] * t3[3], t1[1] * t3[4] - t1[3] * t3[2],
             t1[2] * t3[4] + t1[3] * t3[1], t1[0] * t3[2] + t1[1] * t3[3],
             -t1[0] * t3[1] + t1[2] * t3[3], -t1[1] * t3[1] - t1[2] * t3[2],
             t1[0] * t3[0] - t1[3] * t3[3], t1[1] * t3[0] + t1[3] * t3[2],
             t1[2] * t3[0] - t1[3] * t3[1], t1[3] * t3[0] + t1[3] * t3[4],
             t1[0] * t3[3] - t1[1] * t3[2] + t1[2] * t3[1] + t1[4] * t3[0] -
                 t1[4] * t3[4]);
  const Sph& t5 = sph;
  Sph t6 = reverse(t5);
  return Tsd(-t4[6] * t6[0] - t4[7] * t6[1] - t4[8] * t6[2] - t4[9] * t6[4] -
                 t4[10] * t6[3],
             -t4[2] * t6[4] + t4[4] * t6[0] + t4[5] * t6[1] - t4[8] * t6[4] +
                 t4[10] * t6[2],

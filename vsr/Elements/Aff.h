...
inline Aff gp(const Aff& a, const Sca& b) {
  return Aff(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0]);
}
...
inline Mnk_Aff gp(const Aff& a, const Mnk& b) {
  return Mnk_Aff(a[3] * b[0], a[0] * b[0], a[1] * b[0], a[2] * b[0]);
}

inline Hyp_Pnt gp(const Aff& a, const Hyp& b) {
  return Hyp_Pnt(-a[3] * b[1], a[0] * b[0], a[1] * b[0], a[2] * b[0],
                 a[0] * b[1], a[1] * b[1], a[2] * b[1], a[3] * b[1]);
}

inline Daf gp(const Aff& a, const Pss& b) {
  return Daf(a[2] * b[0], -a[1] * b[0], a[0] * b[0], -a[3] * b[0]);
}
...
inline Bst gp(const Aff& a, const Pnt& b) {
  return Bst(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[3] * b[4],
             ...
             a[1] * b[3] - a[3] * b[1], a[2] * b[3] - a[3] * b[2], a[0] * b[4],
             a[1] * b[4], a[2] * b[4], a[3] * b[4]);
}

inline Pnt_Par gp(const Aff& a, const Par& b) {
  return Pnt_Par(-a[1] * b[0] - a[2] * b[1] + a[3] * b[6],
                 ...
                 a[1] * b[8] - a[2] * b[7], a[0] * b[9] - a[3] * b[6],
                 a[1] * b[9] - a[3] * b[7], a[2] * b[9] - a[3] * b[8],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}

inline Pnt_Cir gp(const Aff& a, const Cir& b) {
  return Pnt_Cir(
      a[2] * b[9] - a[3] * b[3], -a[1] * b[9] - a[3] * b[4],
      a[0] * b[9] - a[3] * b[5], -a[1] * b[0] - a[2] * b[1] - a[3] * b[6],
      a[0] * b[0] - a[2] * b[2] - a[3] * b[7],
      a[0] * b[1] + a[1] * b[2] - a[3] * b[8], -a[1] * b[3] - a[2] * b[4],
...
inline Pnt_Sph gp(const Aff& a, const Sph& b) {
  return Pnt_Sph(a[2] * b[3] + a[3] * b[0], -a[1] * b[3] + a[3] * b[1],
                 a[0] * b[3] + a[3] * b[2], a[2] * b[4], -a[1] * b[4],
                 a[0] * b[4], -a[1] * b[0] - a[2] * b[1],
...
inline Pnt_Par gp(const Aff& a, const Sta& b) {
  return Pnt_Par(-a[1] * b[0] - a[2] * b[1] + a[3] * b[6],
                 ...
                 a[1] * b[5] - a[2] * b[4] + a[3] * b[2],
                 a[0] * b[7] - a[1] * b[6], a[0] * b[8] - a[2] * b[6],
                 a[1] * b[8] - a[2] * b[7], -a[3] * b[6], -a[3] * b[7],
                 -a[3] * b[8], a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Pnt_Sph gp(const Aff& a, const Pln& b) {
  return Pnt_Sph(a[3] * b[0], a[3] * b[1], a[3] * b[2], a[2] * b[3],
                 -a[1] * b[3], a[0] * b[3], -a[1] * b[0] - a[2] * b[1],
                 a[0] * b[0] - a[2] * b[2], a[0] * b[1] + a[1] * b[2],
                 a[3] * b[3],
...
inline Pnt_Dll gp(const Aff& a, const Dll& b) {
  return Pnt_Dll(-a[1] * b[0] - a[2] * b[1] + a[3] * b[3],
...
inline Bst gp(const Aff& a, const Dlp& b) {
  return Bst(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[3] * b[3],
             a[0] * b[1] - a[1] * b[0], a[0] * b[2] - a[2] * b[0],
             a[1] * b[2] - a[2] * b[1], -a[3] * b[0], -a[3] * b[1],
             -a[3] * b[2], a[0] * b[3], a[1] * b[3], a[2] * b[3], a[3] * b[3]);
}
...
inline Biv_Aff gp(const Aff& a, const Biv& b) {
  return Biv_Aff(-a[1] * b[0] - a[2] * b[1], a[0] * b[0] - a[2] * b[2],
                 a[0] * b[1] + a[1] * b[2], a[3] * b[0], a[3] * b[1],
                 a[3] * b[2], a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}

inline Mnk_Daf gp(const Aff& a, const Tri& b) {
  return Mnk_Daf(a[2] * b[0], -a[1] * b[0], a[0] * b[0], -a[3] * b[0]);
}
...
inline Vec_Afl gp(const Aff& a, const Afl& b) {
  return Vec_Afl(-a[1] * b[0] - a[2] * b[1], a[0] * b[0] - a[2] * b[2],
                 a[0] * b[1] + a[1] * b[2],
                 a[0] * b[3] + a[1] * b[4] + a[2] * b[5],
                 a[0] * b[4] - a[1] * b[3] + a[3] * b[0],
                 a[0] * b[5] - a[2] * b[3] + a[3] * b[1],
...
inline Vec_Daf gp(const Aff& a, const Daf& b) {
  return Vec_Daf(a[2] * b[3] + a[3] * b[0], -a[1] * b[3] + a[3] * b[1],
                 a[0] * b[3] + a[3] * b[2], -a[1] * b[0] - a[2] * b[1],
                 a[0] * b[0] - a[2] * b[2], a[0] * b[1] + a[1] * b[2],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Vec_Dal gp(const Aff& a, const Dal& b) {
  return Vec_Dal(-a[1] * b[0] - a[2] * b[1] - a[3] * b[3],
                 a[0] * b[0] - a[2] * b[2] - a[3] * b[4],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[5],
                 a[0] * b[3] + a[1] * b[4] + a[2] * b[5],
...
inline Biv_Daf gp(const Aff& a, const Mnv& b) {
  return Biv_Daf(-a[3] * b[0], -a[3] * b[1], -a[3] * b[2],
                 a[0] * b[0] + a[1] * b[1] + a[2] * b[2],
                 a[0] * b[1] - a[1] * b[0], a[0] * b[2] - a[2] * b[0],
                 a[1] * b[2] - a[2] * b[1]);
}
...
inline Rtc gp(const Aff& a, const Mot& b) {
  return Rtc(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] + a[3] * b[4],
             ...
             a[0] * b[4] + a[1] * b[5] + a[2] * b[6], a[3] * b[1], a[3] * b[2],
             a[3] * b[3], a[0] * b[5] - a[1] * b[4] + a[2] * b[7],
...
inline Ori_Flp gp(const Aff& a, const Dil& b) {
  return Ori_Flp(a[0] * b[0], a[1] * b[0], a[2] * b[0],
                 a[3] * b[0] + a[3] * b[1], a[0] * b[1], a[1] * b[1],
                 a[2] * b[1]);
}
...
inline Rtc gp(const Aff& a, const Mtd& b) {
  return Rtc(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] + a[3] * b[4],
             ...
             a[3] * b[0] + a[3] * b[7], a[0] * b[4] + a[1] * b[5] + a[2] * b[6],
...
inline Par_Tnb gp(const Aff& a, const Rtd& b) {
  return Par_Tnb(a[0] * b[0] - a[1] * b[1] - a[2] * b[2],
                 a[0] * b[1] + a[1] * b[0] - a[2] * b[3],
                 a[0] * b[2] + a[1] * b[3] + a[2] * b[0],
                 a[3] * b[0] + a[3] * b[4], a[3] * b[1] + a[3] * b[5],
...
inline Ori_Par gp(const Aff& a, const Tvd& b) {
  return Ori_Par(
      ...
      a[0] * b[2] - a[1] * b[1], a[0] * b[3] - a[2] * b[1],
      a[1] * b[3] - a[2] * b[2], a[0] * b[4], a[1] * b[4], a[2] * b[4]);
}
...
inline Pnt_Par gp(const Aff& a, const Bst& b) {
  return Pnt_Par(
      ...
      a[1] * b[6] - a[2] * b[5] + a[3] * b[3], a[0] * b[8] - a[1] * b[7],
      a[0] * b[9] - a[2] * b[7], a[1] * b[9] - a[2] * b[8],
      a[0] * b[10] - a[3] * b[7], a[1] * b[10] - a[3] * b[8],
      a[2] * b[10] - a[3] * b[9], a[0] * b[3] - a[1] * b[2] + a[2] * b[1]);
}
...
inline Sca op(const Aff& a, const Pss& b) { return Sca(); }
...
inline Cir op(const Aff& a, const Par& b) {
  return Cir(a[0] * b[4] - a[1] * b[3] + a[3] * b[0],
             a[0] * b[5] - a[2] * b[3] + a[3] * b[1],
             a[1] * b[5] - a[2] * b[4] + a[3] * b[2], a[0] * b[7] - a[1] * b[6],
             a[0] * b[8] - a[2] * b[6], a[1] * b[8] - a[2] * b[7],
             a[0] * b[9] - a[3] * b[6], a[1] * b[9] - a[3] * b[7],
             a[2] * b[9] - a[3] * b[8],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}

inline Sph op(const Aff& a, const Cir& b) {
  return Sph(a[0] * b[7] - a[1] * b[6] + a[3] * b[3],
             a[0] * b[8] - a[2] * b[6] + a[3] * b[4],
             a[1] * b[8] - a[2] * b[7] + a[3] * b[5],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0] - a[3] * b[9],
             a[0] * b[5] - a[1] * b[4] + a[2] * b[3]);
...
inline Cir op(const Aff& a, const Sta& b) {
  return Cir(a[0] * b[4] - a[1] * b[3] + a[3] * b[0],
             a[0] * b[5] - a[2] * b[3] + a[3] * b[1],
             a[1] * b[5] - a[2] * b[4] + a[3] * b[2], a[0] * b[7] - a[1] * b[6],
             a[0] * b[8] - a[2] * b[6], a[1] * b[8] - a[2] * b[7], -a[3] * b[6],
             -a[3] * b[7], -a[3] * b[8],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Pss op(const Aff& a, const Drt& b) { return Pss(-a[3] * b[0]); }
...
inline Sca op(const Aff& a, const Tnt& b) { return Sca(); }
...
inline Cir op(const Aff& a, const Dll& b) {
  return Cir(a[3] * b[0], a[3] * b[1], a[3] * b[2], a[0] * b[4] - a[1] * b[3],
...
inline Afp op(const Aff& a, const Biv& b) {
  return Afp(a[3] * b[0], a[3] * b[1], a[3] * b[2],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}

inline Tnt op(const Aff& a, const Tri& b) { return Tnt(-a[3] * b[0]); }
...
inline Afp op(const Aff& a, const Afl& b) {
  return Afp(a[0] * b[4] - a[1] * b[3] + a[3] * b[0],
             a[0] * b[5] - a[2] * b[3] + a[3] * b[1],
             a[1] * b[5] - a[2] * b[4] + a[3] * b[2],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Sca ip(const Aff& a, const Sca& b) { return Sca(); }

inline Sca ip(const Aff& a, const Ori& b) { return Sca(); }

inline Sca ip(const Aff& a, const Inf& b) { return Sca(-a[3] * b[0]); }

inline Ori ip(const Aff& a, const Mnk& b) { return Ori(a[3] * b[0]); }

inline Sca ip(const Aff& a, const Hyp& b) { return Sca(-a[3] * b[1]); }
...
inline Pnt ip(const Aff& a, const Par& b) {
  return Pnt(-a[1] * b[0] - a[2] * b[1] + a[3] * b[6],
             a[0] * b[0] - a[2] * b[2] + a[3] * b[7],
             a[0] * b[1] + a[1] * b[2] + a[3] * b[8],
             a[0] * b[3] + a[1] * b[4] + a[2] * b[5] + a[3] * b[9],
             a[0] * b[6] + a[1] * b[7] + a[2] * b[8]);
...
inline Cir ip(const Aff& a, const Sph& b) {
  return Cir(a[2] * b[3] + a[3] * b[0], -a[1] * b[3] + a[3] * b[1],
             a[0] * b[3] + a[3] * b[2], a[2] * b[4], -a[1] * b[4], a[0] * b[4],
             -a[1] * b[0] - a[2] * b[1], a[0] * b[0] - a[2] * b[2],
...
inline Cir ip(const Aff& a, const Pln& b) {
  return Cir(a[3] * b[0], a[3] * b[1], a[3] * b[2], a[2] * b[3], -a[1] * b[3],
             a[0] * b[3], -a[1] * b[0] - a[2] * b[1], a[0] * b[0] - a[2] * b[2],
...
inline Dal ip(const Aff& a, const Daf& b) {
  return Dal(a[2] * b[3] + a[3] * b[0], -a[1] * b[3] + a[3] * b[1],
             a[0] * b[3] + a[3] * b[2], -a[1] * b[0] - a[2] * b[1],
             a[0] * b[0] - a[2] * b[2], a[0] * b[1] + a[1] * b[2]);
}

inline Dap ip(const Aff& a, const Dal& b) {
  return Dap(-a[1] * b[0] - a[2] * b[1] - a[3] * b[3],
             a[0] * b[0] - a[2] * b[2] - a[3] * b[4],
             a[0] * b[1] + a[1] * b[2] - a[3] * b[5],
             a[0] * b[3] + a[1] * b[4] + a[2] * b[5]);
}
...
inline Dap ip(const Aff& a, const Mnv& b) {
  return Dap(-a[3] * b[0], -a[3] * b[1], -a[3] * b[2],
             a[0] * b[0] + a[1] * b[1] + a[2] * b[2]);
}
...
inline Aff sp(const Aff& aff, const Rot& rot) {
  ...
  const Rot& t4 = rot;
  Rot t5 = reverse(t4);
  return Aff(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[7] * t5[3],
...
inline Aff sp(const Aff& aff, const Mot& mot) {
  ...
  const Mot& t4 = mot;
  Mot t5 = reverse(t4);
  return Aff(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] + t3[3] * t5[4] +
...
inline Aff sp(const Aff& aff, const Dil& dil) {
  const Dil& t1 = dil;
  const Aff& t2 = aff;
  Ori_Flp t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2],
             t1[0] * t2[3] - t1[1] * t2[3], t1[1] * t2[0], t1[1] * t2[1],
             t1[1] * t2[2]);
  const Dil& t4 = dil;
  Dil t5 = reverse(t4);
  return Aff(t3[0] * t5[0] + t3[4] * t5[1], t3[1] * t5[0] + t3[5] * t5[1],
             t3[2] * t5[0] + t3[6] * t5[1], t3[3] * t5[0] + t3[3] * t5[1]);
}
...
inline Aff sp(const Aff& aff, const Trv& trv) {
  ...
  const Trv& t4 = trv;
  Trv t5 = reverse(t4);
  return Aff(t3[0] * t5[0], t3[1] * t5[0], t3[2] * t5[0],
...
inline Aff sp(const Aff& aff, const Trs& trs) {
  ...
  const Trs& t4 = trs;
  Trs t5 = reverse(t4);
  return Aff(t3[0] * t5[0] + t3[3] * t5[1], t3[1] * t5[0] + t3[3] * t5[2],
...
inline Aff sp(const Aff& aff, const Rtc& rtc) {
  const Rtc& t1 = rtc;
  const Aff& t2 = aff;
  Mtt t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] - t1[4] * t2[3],
...
inline Aff sp(const Aff& aff, const Mtt& mtt) {
  const Mtt& t1 = mtt;
  const Aff& t2 = aff;
  Rtc t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] - t1[7] * t2[3],
...
inline Aff sp(const Aff& aff, const Rtt& rtt) {
  ...
  return Aff(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[7] * t5[3],
             ...
             t3[0] * t5[2] + t3[1] * t5[3] + t3[2] * t5[0] - t3[7] * t5[1],
             t3[0] * t5[4] + t3[1] * t5[5] + t3[2] * t5[6] + t3[3] * t5[0] -
                 t3[4] * t5[1] - t3[5] * t5[2] - t3[6] * t5[3] - t3[7] * t5[7]);
}
...
inline Aff sp(const Aff& aff, const Rtd& rtd) {
  ...
  Par_Tnb t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2],
             t1[0] * t2[1] - t1[1] * t2[0] + t1[3] * t2[2],
             t1[0] * t2[2] - t1[2] * t2[0] - t1[3] * t2[1],
             t1[0] * t2[3] - t1[4] * t2[3], t1[1] * t2[3] - t1[5] * t2[3],
             t1[2] * t2[3] - t1[6] * t2[3], t1[3] * t2[3] - t1[7] * t2[3],
             t1[4] * t2[0] + t1[5] * t2[1] + t1[6] * t2[2],
             t1[4] * t2[1] - t1[5] * t2[0] + t1[7] * t2[2],
             t1[4] * t2[2] - t1[6] * t2[0] - t1[7] * t2[1],
             t1[1] * t2[2] - t1[2] * t2[1] + t1[3] * t2[0],
  ...
  Rtd t5 = reverse(t4);
  return Aff(
      t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] + t3[7] * t5[4] -
          t3[8] * t5[5] - t3[9] * t5[6] - t3[10] * t5[3] - t3[11] * t5[7],
      t3[0] * t5[1] + t3[1] * t5[0] - t3[2] * t5[3] + t3[7] * t5[5] +
          t3[8] * t5[4] - t3[9] * t5[7] + t3[10] * t5[2] + t3[11] * t5[6],
      t3[0] * t5[2] + t3[1] * t5[3] + t3[2] * t5[0] + t3[7] * t5[6] +
          t3[8] * t5[7] + t3[9] * t5[4] - t3[10] * t5[1] - t3[11] * t5[5],
      t3[3] * t5[0] + t3[3] * t5[4] - t3[4] * t5[1] - t3[4] * t5[5] -
          t3[5] * t5[2] - t3[5] * t5[6] - t3[6] * t5[3] - t3[6] * t5[7]);
}
...
inline Aff sp(const Aff& aff, const Tvd& tvd) {
  ...
  const Tvd& t4 = tvd;
  Tvd t5 = reverse(t4);
  return Aff(t3[0] * t5[0] + t3[7] * t5[4], t3[1] * t5[0] + t3[8] * t5[4],
             t3[2] * t5[0] + t3[9] * t5[4],
             t3[0] * t5[1] + t3[1] * t5[2] + t3[2] * t5[3] + t3[3] * t5[0] +
                 t3[3] * t5[4] - t3[7] * t5[1] - t3[8] * t5[2] - t3[9] * t5[3]);
}
...
inline Aff sp(const Aff& aff, const Tsd& tsd) {
  ...
  const Tsd& t4 = tsd;
  Tsd t5 = reverse(t4);
  return Aff(t3[0] * t5[0] + t3[3] * t5[1] + t3[8] * t5[4],
...
inline Aff sp(const Aff& aff, const Trt& trt) {
  ...
  const Trt& t4 = trt;
  Trt t5 = reverse(t4);
  return Aff(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] + t3[3] * t5[7] +
             ...
             t3[0] * t5[4] + t3[1] * t5[5] + t3[2] * t5[6] + t3[3] * t5[0] +
                 t3[3] * t5[10] - t3[5] * t5[1] - t3[5] * t5[11] -
                 t3[6] * t5[2] - t3[6] * t5[12] - t3[7] * t5[3] -
                 t3[7] * t5[13] - t3[11] * t5[4] - t3[12] * t5[5] -
                 t3[13] * t5[6]);
}
...
inline Aff sp(const Aff& aff, const Rvd& rvd) {
  ...
  return Aff(
      ...
      t3[0] * t5[4] + t3[1] * t5[5] + t3[2] * t5[6] + t3[3] * t5[0] +
          t3[3] * t5[7] - t3[4] * t5[1] - t3[4] * t5[8] - t3[5] * t5[2] -
          t3[5] * t5[9] - t3[6] * t5[3] - t3[6] * t5[10] - t3[7] * t5[4] -
          t3[8] * t5[5] - t3[9] * t5[6] - t3[10] * t5[11] + t3[11] * t5[11]);
}
...
inline Aff sp(const Aff& aff, const Bst& bst) {
  const Bst& t1 = bst;
  const Aff& t2 = aff;
  Pnt_Par t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] - t1[7] * t2[3],
             t1[0] * t2[1] - t1[1] * t2[0] + t1[3] * t2[2] - t1[8] * t2[3],
             t1[0] * t2[2] - t1[2] * t2[0] - t1[3] * t2[1] - t1[9] * t2[3],
             t1[0] * t2[3] - t1[4] * t2[0] - t1[5] * t2[1] - t1[6] * t2[2] -
                 t1[10] * t2[3],
             ...
             -t1[7] * t2[1] + t1[8] * t2[0], -t1[7] * t2[2] + t1[9] * t2[0],
             -t1[8] * t2[2] + t1[9] * t2[1], -t1[7] * t2[3] + t1[10] * t2[0],
             -t1[8] * t2[3] + t1[10] * t2[1], -t1[9] * t2[3] + t1[10] * t2[2],
             t1[1] * t2[2] - t1[2] * t2[1] + t1[3] * t2[0]);
  const Bst& t4 = bst;
  Bst t5 = reverse(t4);
  return Aff(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] + t3[3] * t5[7] +
             ...
             t3[0] * t5[4] + t3[1] * t5[5] + t3[2] * t5[6] + t3[3] * t5[0] +
                 t3[3] * t5[10] - t3[5] * t5[1] - t3[6] * t5[2] -
                 t3[7] * t5[3] - t3[11] * t5[4] - t3[12] * t5[5] -
                 t3[13] * t5[6]);
}
...
inline Aff re(const Aff& aff, const Vec& vec) {
  ...
  const Aff& t2 = aff;
  Aff t3 = involute(t2);
  Vec_Aff t4(t1[0] * t3[0] + t1[1] * t3[1] + t1[2] * t3[2],
             t1[0] * t3[1] - t1[1] * t3[0], t1[0] * t3[2] - t1[2] * t3[0],
             t1[1] * t3[2] - t1[2] * t3[1], t1[0] * t3[3], t1[1] * t3[3],
             t1[2] * t3[3]);
  const Vec& t5 = vec;
  Vec t6 = reverse(t5);
  return Aff(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2],
...
inline Aff re(const Aff& aff, const Dlp& dlp) {
  ...
  Bst t4(t1[0] * t3[0] + t1[1] * t3[1] + t1[2] * t3[2] - t1[3] * t3[3],
         t1[0] * t3[1] - t1[1] * t3[0], t1[0] * t3[2] - t1[2] * t3[0],
         t1[1] * t3[2] - t1[2] * t3[1], t1[0] * t3[3], t1[1] * t3[3],
         t1[2] * t3[3], -t1[3] * t3[0], -t1[3] * t3[1], -t1[3] * t3[2],
         -t1[3] * t3[3]);
  const Dlp& t5 = dlp;
  Dlp t6 = reverse(t5);
  return Aff(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[4] * t6[3],
...
inline Aff re(const Aff& aff, const Pln& pln) {
  ...
  const Aff& t2 = aff;
  Aff t3 = involute(t2);
  Pnt_Sph t4(-t1[0] * t3[3], -t1[1] * t3[3], -t1[2] * t3[3], -t1[3] * t3[2],
             t1[3] * t3[1], -t1[3] * t3[0], t1[0] * t3[1] + t1[1] * t3[2],
             -t1[0] * t3[0] + t1[2] * t3[2], -t1[1] * t3[0] - t1[2] * t3[1],
             -t1[3] * t3[3],
             t1[0] * t3[2] - t1[1] * t3[1] + t1[2] * t3[0] - t1[3] * t3[3]);
  const Pln& t5 = pln;
  Pln t6 = reverse(t5);
  return Aff(-t4[2] * t6[3] - t4[7] * t6[0] - t4[8] * t6[1] - t4[10] * t6[2],
...
inline Aff re(const Aff& aff, const Dll& dll) {
  ...
  Pnt_Dll t4(t1[0] * t3[1] + t1[1] * t3[2] - t1[3] * t3[3],
             ...
             t1[1] * t3[3], t1[2] * t3[3], -t1[3] * t3[1] + t1[4] * t3[0],
             -t1[3] * t3[2] + t1[5] * t3[0], -t1[4] * t3[2] + t1[5] * t3[1],
             -t1[3] * t3[3], -t1[4] * t3[3], -t1[5] * t3[3],
             t1[0] * t3[2] - t1[1] * t3[1] + t1[2] * t3[0]);
  const Dll& t5 = dll;
  Dll t6 = reverse(t5);
  return Aff(-t4[1] * t6[0] - t4[2] * t6[1] + t4[4] * t6[4] + t4[5] * t6[5] -
                 t4[13] * t6[2],
...
inline Aff re(const Aff& aff, const Lin& lin) {
  ...
  Pnt_Lin t4(-t1[0] * t3[3], -t1[1] * t3[3], -t1[2] * t3[3], -t1[3] * t3[3],
             -t1[4] * t3[3], -t1[5] * t3[3], -t1[0] * t3[1] - t1[1] * t3[2],
             t1[0] * t3[0] - t1[2] * t3[2], t1[1] * t3[0] + t1[2] * t3[1],
  ...
  const Lin& t5 = lin;
  Lin t6 = reverse(t5);
  return Aff(t4[4] * t6[0] + t4[5] * t6[1] + t4[9] * t6[3] + t4[10] * t6[4] +
                 t4[11] * t6[5],
...
inline Aff re(const Aff& aff, const Pnt& pnt) {
  ...
  Bst t4(t1[0] * t3[0] + t1[1] * t3[1] + t1[2] * t3[2] - t1[4] * t3[3],
         ...
         -t1[4] * t3[0], -t1[4] * t3[1], -t1[4] * t3[2], -t1[4] * t3[3]);
  const Pnt& t5 = pnt;
  Pnt t6 = reverse(t5);
  return Aff(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[4] * t6[4] -
                 t4[7] * t6[3],
...
inline Aff re(const Aff& aff, const Par& par) {
  ...
  const Aff& t2 = aff;
  Aff t3 = involute(t2);
  Pnt_Par t4(t1[0] * t3[1] + t1[1] * t3[2] - t1[6] * t3[3],
             ...
             -t1[7] * t3[2] + t1[8] * t3[1], -t1[6] * t3[3] + t1[9] * t3[0],
             -t1[7] * t3[3] + t1[9] * t3[1], -t1[8] * t3[3] + t1[9] * t3[2],
             t1[0] * t3[2] - t1[1] * t3[1] + t1[2] * t3[0]);
  const Par& t5 = par;
  Par t6 = reverse(t5);
  return Aff(-t4[1] * t6[0] - t4[2] * t6[1] + t4[3] * t6[6] + t4[4] * t6[3] +
...
inline Aff re(const Aff& aff, const Cir& cir) {
  ...
  const Aff& t2 = aff;
  Aff t3 = involute(t2);
  Pnt_Cir t4(-t1[3] * t3[3] + t1[9] * t3[2], -t1[4] * t3[3] - t1[9] * t3[1],
             -t1[5] * t3[3] + t1[9] * t3[0],
  ...
  const Cir& t5 = cir;
  Cir t6 = reverse(t5);
  return Aff(-t4[2] * t6[9] + t4[4] * t6[3] + t4[5] * t6[4] + t4[7] * t6[0] +
...
inline Aff re(const Aff& aff, const Sph& sph) {
  ...
  Pnt_Sph t4(-t1[0] * t3[3] - t1[3] * t3[2], -t1[1] * t3[3] + t1[3] * t3[1],
             -t1[2] * t3[3] - t1[3] * t3[0], -t1[4] * t3[2], t1[4] * t3[1],
             -t1[4] * t3[0], t1[0] * t3[1] + t1[1] * t3[2],
             -t1[0] * t3[0] + t1[2] * t3[2], -t1[1] * t3[0] - t1[2] * t3[1],
             -t1[4] * t3[3],
             t1[0] * t3[2] - t1[1] * t3[1] + t1[2] * t3[0] - t1[4] * t3[3]);
  const Sph& t5 = sph;
  Sph t6 = reverse(t5);
  return Aff(-t4[2] * t6[4] - t4[5] * t6[3] - t4[7] * t6[0] - t4[8] * t6[1] -
                 t4[10] * t6[2],

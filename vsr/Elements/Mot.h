...
inline Rtc gp(const Mot& a, const Pnt& b) {
  return Rtc(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[4] * b[3],
             ...
             a[0] * b[2] - a[2] * b[0] - a[3] * b[1] - a[6] * b[3], a[0] * b[3],
             a[0] * b[4] - a[4] * b[0] - a[5] * b[1] - a[6] * b[2], a[1] * b[3],
             a[2] * b[3], a[3] * b[3],
...
inline Mtt gp(const Mot& a, const Par& b) {
  return Mtt(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[4] * b[3] +
             ...
             a[0] * b[7] - a[1] * b[6] + a[3] * b[8] + a[4] * b[0] -
                 a[5] * b[9] - a[6] * b[2] + a[7] * b[1],
             a[0] * b[8] - a[2] * b[6] - a[3] * b[7] + a[4] * b[1] +
...
inline Mtt gp(const Mot& a, const Sph& b) {
  return Mtt(-a[7] * b[3], a[6] * b[3], -a[5] * b[3], a[4] * b[3], -a[3] * b[3],
             a[2] * b[3], -a[1] * b[3],
             ...
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0] + a[4] * b[3], a[0] * b[3],
...
inline Drv_Lin gp(const Mot& a, const Drb& b) {
  return Drv_Lin(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Drv_Pln gp(const Mot& a, const Drt& b) {
  return Drv_Pln(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[0] * b[0]);
}
...
inline Par_Tnb gp(const Mot& a, const Tnb& b) {
  return Par_Tnb(a[5] * b[0] + a[6] * b[1] + a[7] * b[2],
...
inline Rvd gp(const Mot& a, const Tnt& b) {
  return Rvd(-a[7] * b[0], a[6] * b[0], -a[5] * b[0], a[4] * b[0], -a[3] * b[0],
             a[2] * b[0], -a[1] * b[0], -a[7] * b[0], a[6] * b[0], -a[5] * b[0],
             a[4] * b[0], a[0] * b[0]);
}

inline Lin_Dll gp(const Mot& a, const Lin& b) {
  return Lin_Dll(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[4] * b[3] +
                     a[5] * b[4] + a[6] * b[5],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1] + a[4] * b[4] -
                     a[5] * b[3] + a[7] * b[5],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0] + a[4] * b[5] -
...
inline Lin_Dlp gp(const Mot& a, const Pln& b) {
  return Lin_Dlp(-a[3] * b[3] + a[5] * b[0] + a[6] * b[1] + a[7] * b[2],
...
inline Lin_Dlp gp(const Mot& a, const Flp& b) {
  return Lin_Dlp(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[4] * b[3],
                 a[0] * b[1] - a[1] * b[0] + a[3] * b[2] - a[5] * b[3],
...
inline Lin_Pln gp(const Mot& a, const Dfp& b) {
  return Lin_Pln(-a[3] * b[3], a[2] * b[3], -a[1] * b[3],
                 -a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[7] * b[3],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1] - a[6] * b[3],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0] + a[5] * b[3],
...
inline Mot gp(const Mot& a, const Dll& b) {
  return Mot(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
             a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
             a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0],
...
inline Lin_Pln gp(const Mot& a, const Tri& b) {
  return Lin_Pln(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[7] * b[0],
...
inline Rtc gp(const Mot& a, const Aff& b) {
  return Rtc(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[4] * b[3],
             a[0] * b[1] - a[1] * b[0] + a[3] * b[2] - a[5] * b[3],
             a[0] * b[2] - a[2] * b[0] - a[3] * b[1] - a[6] * b[3], a[0] * b[3],
             -a[4] * b[0] - a[5] * b[1] - a[6] * b[2], a[1] * b[3], a[2] * b[3],
             a[3] * b[3], -a[4] * b[1] + a[5] * b[0] - a[7] * b[2],
             -a[4] * b[2] + a[6] * b[0] + a[7] * b[1],
...
inline Rtc gp(const Mot& a, const Afp& b) {
  return Rtc(-a[3] * b[3] + a[5] * b[0] + a[6] * b[1] + a[7] * b[2],
             ...
             a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
             a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0], -a[6] * b[3], a[5] * b[3],
             -a[4] * b[3], a[5] * b[0] + a[6] * b[1] + a[7] * b[2],
             -a[4] * b[0] + a[6] * b[2] - a[7] * b[1],
             -a[4] * b[1] - a[5] * b[2] + a[7] * b[0],
             a[0] * b[3] - a[4] * b[2] + a[5] * b[1] - a[6] * b[0],
             -a[4] * b[2] + a[5] * b[1] - a[6] * b[0]);
...
inline Mtt gp(const Mot& a, const Dap& b) {
  return Mtt(a[4] * b[0] + a[5] * b[1] + a[6] * b[2],
             ...
             a[0] * b[0] + a[1] * b[1] + a[2] * b[2],
             a[0] * b[1] - a[1] * b[0] + a[3] * b[2],
             a[0] * b[2] - a[2] * b[0] - a[3] * b[1], -a[4] * b[3],
             -a[5] * b[3], -a[6] * b[3],
             a[0] * b[3] + a[4] * b[0] + a[5] * b[1] + a[6] * b[2],
             a[1] * b[3] + a[4] * b[1] - a[5] * b[0] + a[7] * b[2],
             a[2] * b[3] + a[4] * b[2] - a[6] * b[0] - a[7] * b[1],
...
inline Mtt gp(const Mot& a, const Daf& b) {
  return Mtt(-a[7] * b[3], a[6] * b[3], -a[5] * b[3], a[4] * b[3], -a[3] * b[3],
             a[2] * b[3], -a[1] * b[3], a[5] * b[0] + a[6] * b[1] + a[7] * b[2],
             -a[4] * b[0] + a[6] * b[2] - a[7] * b[1],
             -a[4] * b[1] - a[5] * b[2] + a[7] * b[0],
             -a[1] * b[0] - a[2] * b[1] - a[3] * b[2] - a[7] * b[3],
             a[0] * b[0] - a[2] * b[2] + a[3] * b[1] + a[6] * b[3],
...
inline Lin_Dll gp(const Mot& a, const Mnv& b) {
  return Lin_Dll(a[4] * b[0] + a[5] * b[1] + a[6] * b[2],
                 a[4] * b[1] - a[5] * b[0] + a[7] * b[2],
                 a[4] * b[2] - a[6] * b[0] - a[7] * b[1],
                 a[5] * b[2] - a[6] * b[1] + a[7] * b[0],
                 a[0] * b[0] + a[1] * b[1] + a[2] * b[2],
...
inline Mot gp(const Mot& a, const Rot& b) {
  return Mot(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3],
...
inline Mtt gp(const Mot& a, const Trv& b) {
  return Mtt(a[0] * b[0] + a[4] * b[1] + a[5] * b[2] + a[6] * b[3],
             ...
             a[0] * b[3] - a[2] * b[1] - a[3] * b[2], a[4] * b[0], a[5] * b[0],
             a[6] * b[0], a[4] * b[1] + a[5] * b[2] + a[6] * b[3],
...
inline Mot gp(const Mot& a, const Trs& b) {
  return Mot(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0],
...
inline Rtc gp(const Mot& a, const Rtc& b) {
  return Rtc(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[3] * b[14] -
                 a[4] * b[3] + a[5] * b[5] + a[6] * b[6] + a[7] * b[7],
             a[0] * b[1] - a[1] * b[0] + a[2] * b[14] + a[3] * b[2] -
                 a[4] * b[5] - a[5] * b[3] + a[6] * b[7] - a[7] * b[6],
             a[0] * b[2] - a[1] * b[14] - a[2] * b[0] - a[3] * b[1] -
                 a[4] * b[6] - a[5] * b[7] - a[6] * b[3] + a[7] * b[5],
...
inline Mtt gp(const Mot& a, const Mtt& b) {
  return Mtt(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] +
                 a[4] * b[4] + a[5] * b[5] + a[6] * b[6] - a[7] * b[14],
             a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] +
                 a[4] * b[5] - a[5] * b[4] + a[6] * b[14] + a[7] * b[6],
             a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] +
                 a[4] * b[6] - a[5] * b[14] - a[6] * b[4] - a[7] * b[5],
             a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] +
                 a[4] * b[14] + a[5] * b[6] - a[6] * b[5] + a[7] * b[4],
...
inline Mtt gp(const Mot& a, const Tvd& b) {
  return Mtt(a[0] * b[0] + a[4] * b[1] + a[5] * b[2] + a[6] * b[3],
             ...
             a[0] * b[1] + a[1] * b[2] + a[2] * b[3],
             a[0] * b[2] - a[1] * b[1] + a[3] * b[3],
             a[0] * b[3] - a[2] * b[1] - a[3] * b[2], a[4] * b[0] - a[4] * b[4],
...
inline Mtt gp(const Mot& a, const Trt& b) {
  return Mtt(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] +
             ...
             a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] +
                 a[4] * b[5] - a[5] * b[4] + a[7] * b[6],
             a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] +
                 a[4] * b[6] - a[6] * b[4] - a[7] * b[5],
             a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] +
                 a[5] * b[6] - a[6] * b[5] + a[7] * b[4],
...
inline Mot ip(const Mot& a, const Mot& b) {
  return Mot(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3], a[0] * b[1],
...
inline Mot sp(const Mot& mot, const Dil& dil) {
  ...
  const Dil& t4 = dil;
  Dil t5 = reverse(t4);
  return Mot(t3[0] * t5[0] + t3[7] * t5[1], t3[1] * t5[0] + t3[8] * t5[1],
...
inline Mot sp(const Mot& mot, const Trs& trs) {
  const Trs& t1 = trs;
  const Mot& t2 = mot;
  Mot t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2], t1[0] * t2[3],
  ...
  const Trs& t4 = trs;
  Trs t5 = reverse(t4);
  return Mot(t3[0] * t5[0], t3[1] * t5[0], t3[2] * t5[0], t3[3] * t5[0],
...
inline Mot sp(const Mot& mot, const Rtc& rtc) {
  ...
  Rtc t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] + t1[3] * t2[4] +
             t1[5] * t2[5] + t1[6] * t2[6] - t1[7] * t2[7] - t1[14] * t2[3],
         t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[5] -
             t1[5] * t2[4] + t1[6] * t2[7] + t1[7] * t2[6] + t1[14] * t2[2],
         t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] + t1[3] * t2[6] -
             t1[5] * t2[7] - t1[6] * t2[4] - t1[7] * t2[5] - t1[14] * t2[1],
         t1[3] * t2[0] - t1[5] * t2[1] - t1[6] * t2[2] - t1[7] * t2[3],
         t1[0] * t2[4] + t1[1] * t2[5] + t1[2] * t2[6] + t1[4] * t2[0] -
             t1[8] * t2[1] - t1[9] * t2[2] - t1[10] * t2[3] + t1[11] * t2[4] +
         ...
         t1[0] * t2[5] - t1[1] * t2[4] + t1[2] * t2[7] + t1[4] * t2[1] +
             t1[8] * t2[0] - t1[9] * t2[3] + t1[10] * t2[2] + t1[11] * t2[5] -
             t1[12] * t2[4] + t1[13] * t2[7] + t1[14] * t2[6] + t1[15] * t2[6],
         t1[0] * t2[6] - t1[1] * t2[7] - t1[2] * t2[4] + t1[4] * t2[2] +
             t1[8] * t2[3] + t1[9] * t2[0] - t1[10] * t2[1] + t1[11] * t2[6] -
             t1[12] * t2[7] - t1[13] * t2[4] - t1[14] * t2[5] - t1[15] * t2[5],
         t1[0] * t2[7] + t1[1] * t2[6] - t1[2] * t2[5] + t1[4] * t2[3] -
             t1[8] * t2[2] + t1[9] * t2[1] + t1[10] * t2[0] + t1[11] * t2[7] +
             t1[12] * t2[6] - t1[13] * t2[5] + t1[14] * t2[4] + t1[15] * t2[4],
         -t1[3] * t2[4] - t1[5] * t2[5] - t1[6] * t2[6] + t1[7] * t2[7] +
             t1[11] * t2[0] - t1[12] * t2[1] - t1[13] * t2[2] - t1[15] * t2[3],
         -t1[3] * t2[5] + t1[5] * t2[4] - t1[6] * t2[7] - t1[7] * t2[6] +
             t1[11] * t2[1] + t1[12] * t2[0] - t1[13] * t2[3] + t1[15] * t2[2],
         -t1[3] * t2[6] + t1[5] * t2[7] + t1[6] * t2[4] + t1[7] * t2[5] +
             t1[11] * t2[2] + t1[12] * t2[3] + t1[13] * t2[0] - t1[15] * t2[1],
         t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[7] +
             t1[5] * t2[6] - t1[6] * t2[5] + t1[7] * t2[4] + t1[14] * t2[0],
         -t1[3] * t2[7] - t1[5] * t2[6] + t1[6] * t2[5] - t1[7] * t2[4] +
...
inline Mot sp(const Mot& mot, const Mtt& mtt) {
  ...
  Mtt t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3] +
             t1[4] * t2[4] + t1[5] * t2[5] + t1[6] * t2[6] - t1[14] * t2[7],
         t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] +
             t1[4] * t2[5] - t1[5] * t2[4] + t1[6] * t2[7] + t1[14] * t2[6],
         t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] +
             t1[4] * t2[6] - t1[5] * t2[7] - t1[6] * t2[4] - t1[14] * t2[5],
         t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] +
             t1[4] * t2[7] + t1[5] * t2[6] - t1[6] * t2[5] + t1[14] * t2[4],
         t1[4] * t2[0] - t1[5] * t2[1] - t1[6] * t2[2] - t1[14] * t2[3],
         t1[4] * t2[1] + t1[5] * t2[0] - t1[6] * t2[3] + t1[14] * t2[2],
         t1[4] * t2[2] + t1[5] * t2[3] + t1[6] * t2[0] - t1[14] * t2[1],
         t1[0] * t2[4] + t1[1] * t2[5] + t1[2] * t2[6] - t1[3] * t2[7] +
             t1[7] * t2[0] - t1[8] * t2[1] - t1[9] * t2[2] + t1[10] * t2[4] +
             t1[11] * t2[5] + t1[12] * t2[6] - t1[13] * t2[7] - t1[15] * t2[3],
         t1[0] * t2[5] - t1[1] * t2[4] + t1[2] * t2[7] + t1[3] * t2[6] +
             t1[7] * t2[1] + t1[8] * t2[0] - t1[9] * t2[3] + t1[10] * t2[5] -
             t1[11] * t2[4] + t1[12] * t2[7] + t1[13] * t2[6] + t1[15] * t2[2],
         t1[0] * t2[6] - t1[1] * t2[7] - t1[2] * t2[4] - t1[3] * t2[5] +
             t1[7] * t2[2] + t1[8] * t2[3] + t1[9] * t2[0] + t1[10] * t2[6] -
             t1[11] * t2[7] - t1[12] * t2[4] - t1[13] * t2[5] - t1[15] * t2[1],
         ...
         t1[0] * t2[7] + t1[1] * t2[6] - t1[2] * t2[5] + t1[3] * t2[4] +
             t1[7] * t2[3] - t1[8] * t2[2] + t1[9] * t2[1] + t1[10] * t2[7] +
             t1[11] * t2[6] - t1[12] * t2[5] + t1[13] * t2[4] + t1[15] * t2[0]);
  const Mtt& t4 = mtt;
  Mtt t5 = reverse(t4);
  return Mot(
      t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3] +
...
inline Mot sp(const Mot& mot, const Tvd& tvd) {
  ...
  return Mot(t3[0] * t5[0] + t3[7] * t5[1] + t3[8] * t5[2] + t3[9] * t5[3] +
             ...
             t3[9] * t5[0] - t3[9] * t5[4], t3[15] * t5[0] - t3[15] * t5[4]);
}
...
inline Mot sp(const Mot& mot, const Tsd& tsd) {
  ...
  const Tsd& t4 = tsd;
  Tsd t5 = reverse(t4);
  return Mot(t3[0] * t5[0] + t3[7] * t5[4], t3[1] * t5[0] + t3[8] * t5[4],
...
inline Mot sp(const Mot& mot, const Trt& trt) {
  ...
  Mtt t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3] +
         ...
         t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] +
             t1[4] * t2[5] - t1[5] * t2[4] + t1[6] * t2[7],
         t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] +
             t1[4] * t2[6] - t1[5] * t2[7] - t1[6] * t2[4],
         t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] +
             t1[4] * t2[7] + t1[5] * t2[6] - t1[6] * t2[5],
...
inline Mot re(const Mot& mot, const Pln& pln) {
  ...
  const Mot& t2 = mot;
  Mot t3 = involute(t2);
  Lin_Dlp t4(t1[0] * t3[5] + t1[1] * t3[6] - t1[2] * t3[7] - t1[3] * t3[3],
  ...
  const Pln& t5 = pln;
  Pln t6 = reverse(t5);
  return Mot(-t4[4] * t6[0] - t4[5] * t6[1] - t4[6] * t6[2],
...
inline Mot re(const Mot& mot, const Dll& dll) {
  ...
  const Mot& t2 = mot;
  Mot t3 = involute(t2);
  Mot t4(-t1[0] * t3[1] - t1[1] * t3[2] - t1[2] * t3[3],
         t1[0] * t3[0] - t1[1] * t3[3] + t1[2] * t3[2],
         t1[0] * t3[3] + t1[1] * t3[0] - t1[2] * t3[1],
         -t1[0] * t3[2] + t1[1] * t3[1] + t1[2] * t3[0],
  ...
  const Dll& t5 = dll;
  Dll t6 = reverse(t5);
  return Mot(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2],
...
inline Mot re(const Mot& mot, const Lin& lin) {
  ...
  const Mot& t2 = mot;
  Mot t3 = involute(t2);
  Lin_Dll t4(-t1[0] * t3[1] - t1[1] * t3[2] - t1[2] * t3[3] + t1[3] * t3[4] +
                 t1[4] * t3[5] + t1[5] * t3[6],
  ...
  const Lin& t5 = lin;
  Lin t6 = reverse(t5);
  return Mot(t4[4] * t6[3] + t4[5] * t6[4] + t4[6] * t6[5],
...
inline Mot re(const Mot& mot, const Par& par) {
  ...
  Mtt t4(-t1[0] * t3[1] - t1[1] * t3[2] - t1[2] * t3[3] + t1[3] * t3[4] +
         ...
         t1[3] * t3[1] + t1[4] * t3[0] - t1[5] * t3[3],
         t1[3] * t3[2] + t1[4] * t3[3] + t1[5] * t3[0],
         t1[0] * t3[5] + t1[1] * t3[6] - t1[2] * t3[7] + t1[6] * t3[0] -
             t1[7] * t3[1] - t1[8] * t3[2] + t1[9] * t3[4],
         -t1[0] * t3[4] + t1[1] * t3[7] + t1[2] * t3[6] + t1[6] * t3[1] +
             t1[7] * t3[0] - t1[8] * t3[3] + t1[9] * t3[5],
         -t1[0] * t3[7] - t1[1] * t3[4] - t1[2] * t3[5] + t1[6] * t3[2] +
             t1[7] * t3[3] + t1[8] * t3[0] + t1[9] * t3[6],
  ...
  const Par& t5 = par;
  Par t6 = reverse(t5);
  return Mot(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2] + t4[4] * t6[6] +
...
inline Mot re(const Mot& mot, const Cir& cir) {
  ...
  const Mot& t2 = mot;
  Mot t3 = involute(t2);
  Rtc t4(t1[0] * t3[5] + t1[1] * t3[6] - t1[2] * t3[7] - t1[9] * t3[3],
         -t1[0] * t3[4] + t1[1] * t3[7] + t1[2] * t3[6] + t1[9] * t3[2],
         -t1[0] * t3[7] - t1[1] * t3[4] - t1[2] * t3[5] - t1[9] * t3[1],
         -t1[0] * t3[1] - t1[1] * t3[2] - t1[2] * t3[3],
         -t1[3] * t3[1] - t1[4] * t3[2] - t1[5] * t3[3] + t1[6] * t3[4] +
             t1[7] * t3[5] + t1[8] * t3[6] - t1[9] * t3[7],
         t1[0] * t3[0] - t1[1] * t3[3] + t1[2] * t3[2],
         t1[0] * t3[3] + t1[1] * t3[0] - t1[2] * t3[1],
         -t1[0] * t3[2] + t1[1] * t3[1] + t1[2] * t3[0],
         t1[3] * t3[0] - t1[4] * t3[3] + t1[5] * t3[2] + t1[6] * t3[5] -
             t1[7] * t3[4] + t1[8] * t3[7] + t1[9] * t3[6],
         t1[3] * t3[3] + t1[4] * t3[0] - t1[5] * t3[1] + t1[6] * t3[6] -
             t1[7] * t3[7] - t1[8] * t3[4] - t1[9] * t3[5],
         -t1[3] * t3[2] + t1[4] * t3[1] + t1[5] * t3[0] + t1[6] * t3[7] +
  ...
  const Cir& t5 = cir;
  Cir t6 = reverse(t5);
  return Mot(t4[5] * t6[3] + t4[6] * t6[4] + t4[7] * t6[5] + t4[8] * t6[0] +
...
inline Mot re(const Mot& mot, const Sph& sph) {
  ...
  const Sph& t5 = sph;
  Sph t6 = reverse(t5);
  return Mot(-t4[11] * t6[0] - t4[12] * t6[1] - t4[13] * t6[2] -

...
inline Dlp gp(const Dlp& a, const Sca& b) {
  return Dlp(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0]);
}

inline Tvd gp(const Dlp& a, const Ori& b) {
  return Tvd(-a[3] * b[0], a[0] * b[0], a[1] * b[0], a[2] * b[0], -a[3] * b[0]);
}
...
inline Mnk_Dlp gp(const Dlp& a, const Mnk& b) {
  return Mnk_Dlp(-a[3] * b[0], a[0] * b[0], a[1] * b[0], a[2] * b[0]);
}

inline Hyp_Pnt gp(const Dlp& a, const Hyp& b) {
  return Hyp_Pnt(-a[3] * b[0], a[0] * b[0], a[1] * b[0], a[2] * b[0],
                 a[0] * b[1], a[1] * b[1], a[2] * b[1], -a[3] * b[0]);
}

inline Pln gp(const Dlp& a, const Pss& b) {
  return Pln(a[2] * b[0], -a[1] * b[0], a[0] * b[0], a[3] * b[0]);
}
...
inline Pnt_Par gp(const Dlp& a, const Par& b) {
  return Pnt_Par(
      ...
      a[1] * b[5] - a[2] * b[4], a[0] * b[7] - a[1] * b[6] + a[3] * b[0],
      a[0] * b[8] - a[2] * b[6] + a[3] * b[1],
      a[1] * b[8] - a[2] * b[7] + a[3] * b[2], a[0] * b[9] + a[3] * b[3],
      a[1] * b[9] + a[3] * b[4], a[2] * b[9] + a[3] * b[5],
      a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}

inline Pnt_Cir gp(const Dlp& a, const Cir& b) {
  return Pnt_Cir(a[2] * b[9] - a[3] * b[0], -a[1] * b[9] - a[3] * b[1],
                 a[0] * b[9] - a[3] * b[2], -a[1] * b[0] - a[2] * b[1],
...
inline Pnt_Sph gp(const Dlp& a, const Sph& b) {
  return Pnt_Sph(a[2] * b[3], -a[1] * b[3], a[0] * b[3],
                 a[2] * b[4] - a[3] * b[0], -a[1] * b[4] - a[3] * b[1],
...
inline Pnt_Par gp(const Dlp& a, const Sta& b) {
  return Pnt_Par(
      ...
      a[0] * b[7] - a[1] * b[6] + a[3] * b[0],
      a[0] * b[8] - a[2] * b[6] + a[3] * b[1],
      a[1] * b[8] - a[2] * b[7] + a[3] * b[2], a[3] * b[3], a[3] * b[4],
...
inline Ori_Par gp(const Dlp& a, const Tnv& b) {
  return Ori_Par(a[3] * b[0], a[3] * b[1], a[3] * b[2],
...
inline Ori_Cir gp(const Dlp& a, const Tnb& b) {
  return Ori_Cir(-a[3] * b[0], -a[3] * b[1], -a[3] * b[2],
...
inline Ori_Sph gp(const Dlp& a, const Tnt& b) {
  return Ori_Sph(a[2] * b[0], -a[1] * b[0], a[0] * b[0], a[3] * b[0],
                 a[3] * b[0]);
}

inline Lin_Dlp gp(const Dlp& a, const Lin& b) {
  return Lin_Dlp(-a[1] * b[0] - a[2] * b[1] + a[3] * b[3],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[4],
                 a[0] * b[1] + a[1] * b[2] + a[3] * b[5],
                 a[0] * b[3] + a[1] * b[4] + a[2] * b[5],
                 a[0] * b[4] - a[1] * b[3], a[0] * b[5] - a[2] * b[3],
...
inline Pln_Dlp gp(const Dlp& a, const Pln& b) {
  return Pln_Dlp(a[2] * b[3] - a[3] * b[0], -a[1] * b[3] - a[3] * b[1],
...
inline Lin_Pln gp(const Dlp& a, const Dll& b) {
  return Lin_Pln(-a[1] * b[0] - a[2] * b[1], a[0] * b[0] - a[2] * b[2],
                 a[0] * b[1] + a[1] * b[2],
                 a[0] * b[3] + a[1] * b[4] + a[2] * b[5],
...
inline Mnk_Pln gp(const Dlp& a, const Tri& b) {
  return Mnk_Pln(a[2] * b[0], -a[1] * b[0], a[0] * b[0], -a[3] * b[0]);
}
...
inline Pnt_Afl gp(const Dlp& a, const Afl& b) {
  return Pnt_Afl(-a[1] * b[0] - a[2] * b[1] + a[3] * b[3],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[4],
                 a[0] * b[1] + a[1] * b[2] + a[3] * b[5],
                 a[0] * b[3] + a[1] * b[4] + a[2] * b[5],
                 a[0] * b[4] - a[1] * b[3], a[0] * b[5] - a[2] * b[3],
                 a[1] * b[5] - a[2] * b[4], a[3] * b[0], a[3] * b[1],
                 a[3] * b[2], a[3] * b[3], a[3] * b[4], a[3] * b[5],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Pnt_Dap gp(const Dlp& a, const Dap& b) {
  return Pnt_Dap(a[3] * b[0], a[3] * b[1], a[3] * b[2],
...
inline Pnt_Sph gp(const Dlp& a, const Daf& b) {
  return Pnt_Sph(a[2] * b[3], -a[1] * b[3], a[0] * b[3], -a[3] * b[0],
                 -a[3] * b[1], -a[3] * b[2], -a[1] * b[0] - a[2] * b[1],
                 a[0] * b[0] - a[2] * b[2], a[0] * b[1] + a[1] * b[2],
                 a[3] * b[3],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0] + a[3] * b[3]);
}
...
inline Pnt_Dal gp(const Dlp& a, const Dal& b) {
  return Pnt_Dal(-a[3] * b[0], -a[3] * b[1], -a[3] * b[2],
                 -a[1] * b[0] - a[2] * b[1], a[0] * b[0] - a[2] * b[2],
                 a[0] * b[1] + a[1] * b[2], a[3] * b[3], a[3] * b[4],
                 a[3] * b[5], a[0] * b[3] + a[1] * b[4] + a[2] * b[5],
                 a[0] * b[4] - a[1] * b[3] - a[3] * b[0],
                 a[0] * b[5] - a[2] * b[3] - a[3] * b[1],
                 a[1] * b[5] - a[2] * b[4] - a[3] * b[2],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
...
inline Pln_Biv gp(const Dlp& a, const Mnv& b) {
  return Pln_Biv(a[3] * b[0], a[3] * b[1], a[3] * b[2],
                 a[0] * b[0] + a[1] * b[1] + a[2] * b[2],
                 a[0] * b[1] - a[1] * b[0], a[0] * b[2] - a[2] * b[0],
                 a[1] * b[2] - a[2] * b[1]);
}
...
inline Inf_Dap gp(const Dlp& a, const Dil& b) {
  return Inf_Dap(a[0] * b[0], a[1] * b[0], a[2] * b[0],
...
inline Pnt_Dap gp(const Dlp& a, const Trv& b) {
  return Pnt_Dap(
      ...
      a[2] * b[0] + a[3] * b[3], a[0] * b[1] + a[1] * b[2] + a[2] * b[3],
      a[3] * b[0], a[0] * b[2] - a[1] * b[1], a[0] * b[3] - a[2] * b[1],
      a[1] * b[3] - a[2] * b[2], a[3] * b[1], a[3] * b[2], a[3] * b[3]);
}
...
inline Rtc gp(const Dlp& a, const Rtt& b) {
  return Rtc(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] + a[3] * b[4],
             ...
             a[0] * b[7] + a[1] * b[6] - a[2] * b[5], a[3] * b[1], a[3] * b[2],
...
inline Pnt_Dap gp(const Dlp& a, const Tvd& b) {
  return Pnt_Dap(a[0] * b[0] + a[3] * b[1], a[1] * b[0] + a[3] * b[2],
                 a[2] * b[0] + a[3] * b[3],
                 a[0] * b[1] + a[1] * b[2] + a[2] * b[3],
                 a[3] * b[0] - a[3] * b[4], a[0] * b[2] - a[1] * b[1],
                 a[0] * b[3] - a[2] * b[1], a[1] * b[3] - a[2] * b[2],
                 a[0] * b[4] + a[3] * b[1], a[1] * b[4] + a[3] * b[2],
                 a[2] * b[4] + a[3] * b[3]);
}
...
inline Pnt_Par gp(const Dlp& a, const Bst& b) {
  return Pnt_Par(
      ...
      a[0] * b[7] + a[1] * b[8] + a[2] * b[9] + a[3] * b[0] - a[3] * b[10],
      a[0] * b[5] - a[1] * b[4], a[0] * b[6] - a[2] * b[4],
      a[1] * b[6] - a[2] * b[5], a[0] * b[8] - a[1] * b[7] + a[3] * b[1],
      a[0] * b[9] - a[2] * b[7] + a[3] * b[2],
      a[1] * b[9] - a[2] * b[8] + a[3] * b[3], a[0] * b[10] + a[3] * b[4],
      a[1] * b[10] + a[3] * b[5], a[2] * b[10] + a[3] * b[6],
      a[0] * b[3] - a[1] * b[2] + a[2] * b[1]);
}
...
inline Sca op(const Dlp& a, const Pss& b) { return Sca(); }
...
inline Sph op(const Dlp& a, const Cir& b) {
  return Sph(a[0] * b[7] - a[1] * b[6] - a[3] * b[0],
             a[0] * b[8] - a[2] * b[6] - a[3] * b[1],
             a[1] * b[8] - a[2] * b[7] - a[3] * b[2],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0],
             a[0] * b[5] - a[1] * b[4] + a[2] * b[3] - a[3] * b[9]);
...
inline Sca op(const Dlp& a, const Drt& b) { return Sca(); }
...
inline Pss op(const Dlp& a, const Tnt& b) { return Pss(a[3] * b[0]); }
...
inline Dfp op(const Dlp& a, const Dll& b) {
  return Dfp(a[0] * b[4] - a[1] * b[3] + a[3] * b[0],
             a[0] * b[5] - a[2] * b[3] + a[3] * b[1],
             a[1] * b[5] - a[2] * b[4] + a[3] * b[2],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Dfp op(const Dlp& a, const Biv& b) {
  return Dfp(a[3] * b[0], a[3] * b[1], a[3] * b[2],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}

inline Drt op(const Dlp& a, const Tri& b) { return Drt(-a[3] * b[0]); }
...
inline Cir op(const Dlp& a, const Afl& b) {
  return Cir(a[0] * b[4] - a[1] * b[3], a[0] * b[5] - a[2] * b[3],
             a[1] * b[5] - a[2] * b[4], a[3] * b[0], a[3] * b[1], a[3] * b[2],
             a[3] * b[3], a[3] * b[4], a[3] * b[5],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}

inline Sph op(const Dlp& a, const Afp& b) {
  return Sph(-a[3] * b[0], -a[3] * b[1], -a[3] * b[2],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0], -a[3] * b[3]);
}
...
inline Sca ip(const Dlp& a, const Sca& b) { return Sca(); }

inline Sca ip(const Dlp& a, const Ori& b) { return Sca(-a[3] * b[0]); }

inline Sca ip(const Dlp& a, const Inf& b) { return Sca(); }

inline Inf ip(const Dlp& a, const Mnk& b) { return Inf(-a[3] * b[0]); }

inline Sca ip(const Dlp& a, const Hyp& b) { return Sca(-a[3] * b[0]); }
...
inline Pnt ip(const Dlp& a, const Par& b) {
  return Pnt(-a[1] * b[0] - a[2] * b[1] + a[3] * b[3],
             a[0] * b[0] - a[2] * b[2] + a[3] * b[4],
             a[0] * b[1] + a[1] * b[2] + a[3] * b[5],
             a[0] * b[3] + a[1] * b[4] + a[2] * b[5],
             a[0] * b[6] + a[1] * b[7] + a[2] * b[8] - a[3] * b[9]);
...
inline Par ip(const Dlp& a, const Cir& b) {
  return Par(a[2] * b[9] - a[3] * b[0], -a[1] * b[9] - a[3] * b[1],
             a[0] * b[9] - a[3] * b[2], -a[1] * b[0] - a[2] * b[1],
             a[0] * b[0] - a[2] * b[2], a[0] * b[1] + a[1] * b[2],
             -a[1] * b[3] - a[2] * b[4] + a[3] * b[6],
             a[0] * b[3] - a[2] * b[5] + a[3] * b[7],
...
inline Cir ip(const Dlp& a, const Sph& b) {
  return Cir(a[2] * b[3], -a[1] * b[3], a[0] * b[3], a[2] * b[4] - a[3] * b[0],
             -a[1] * b[4] - a[3] * b[1], a[0] * b[4] - a[3] * b[2],
             -a[1] * b[0] - a[2] * b[1], a[0] * b[0] - a[2] * b[2],
...
inline Afl ip(const Dlp& a, const Tnb& b) {
  return Afl(-a[3] * b[0], -a[3] * b[1], -a[3] * b[2],
             -a[1] * b[0] - a[2] * b[1], a[0] * b[0] - a[2] * b[2],
             a[0] * b[1] + a[1] * b[2]);
}
...
inline Flp ip(const Dlp& a, const Lin& b) {
  return Flp(-a[1] * b[0] - a[2] * b[1] + a[3] * b[3],
             a[0] * b[0] - a[2] * b[2] + a[3] * b[4],
             a[0] * b[1] + a[1] * b[2] + a[3] * b[5],
             a[0] * b[3] + a[1] * b[4] + a[2] * b[5]);
}
...
inline Lin ip(const Dlp& a, const Pln& b) {
  return Lin(a[2] * b[3] - a[3] * b[0], -a[1] * b[3] - a[3] * b[1],
             a[0] * b[3] - a[3] * b[2], -a[1] * b[0] - a[2] * b[1],
             a[0] * b[0] - a[2] * b[2], a[0] * b[1] + a[1] * b[2]);
}
...
inline Pnt ip(const Dlp& a, const Dap& b) {
  return Pnt(a[3] * b[0], a[3] * b[1], a[3] * b[2],
             a[0] * b[0] + a[1] * b[1] + a[2] * b[2], -a[3] * b[3]);
}

inline Cir ip(const Dlp& a, const Daf& b) {
  return Cir(a[2] * b[3], -a[1] * b[3], a[0] * b[3], -a[3] * b[0], -a[3] * b[1],
             -a[3] * b[2], -a[1] * b[0] - a[2] * b[1],
             a[0] * b[0] - a[2] * b[2], a[0] * b[1] + a[1] * b[2], a[3] * b[3]);
}

inline Par ip(const Dlp& a, const Dal& b) {
  return Par(-a[3] * b[0], -a[3] * b[1], -a[3] * b[2],
             -a[1] * b[0] - a[2] * b[1], a[0] * b[0] - a[2] * b[2],
...
inline Flp ip(const Dlp& a, const Mnv& b) {
  return Flp(a[3] * b[0], a[3] * b[1], a[3] * b[2],
             a[0] * b[0] + a[1] * b[1] + a[2] * b[2]);
}
...
inline Dlp sp(const Dlp& dlp, const Rot& rot) {
  ...
  const Rot& t4 = rot;
  Rot t5 = reverse(t4);
  return Dlp(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[7] * t5[3],
...
inline Dlp sp(const Dlp& dlp, const Dil& dil) {
  const Dil& t1 = dil;
  const Dlp& t2 = dlp;
  Inf_Dap t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2],
             t1[0] * t2[3] + t1[1] * t2[3], t1[1] * t2[0], t1[1] * t2[1],
             t1[1] * t2[2]);
  const Dil& t4 = dil;
  Dil t5 = reverse(t4);
  return Dlp(t3[0] * t5[0] + t3[4] * t5[1], t3[1] * t5[0] + t3[5] * t5[1],
...
inline Dlp sp(const Dlp& dlp, const Trv& trv) {
  const Trv& t1 = trv;
  const Dlp& t2 = dlp;
  Pnt_Dap t3(t1[0] * t2[0] - t1[1] * t2[3], t1[0] * t2[1] - t1[2] * t2[3],
             t1[0] * t2[2] - t1[3] * t2[3],
             -t1[1] * t2[0] - t1[2] * t2[1] - t1[3] * t2[2], t1[0] * t2[3],
             -t1[1] * t2[1] + t1[2] * t2[0], -t1[1] * t2[2] + t1[3] * t2[0],
             -t1[2] * t2[2] + t1[3] * t2[1], t1[1] * t2[3], t1[2] * t2[3],
             t1[3] * t2[3]);
  const Trv& t4 = trv;
  Trv t5 = reverse(t4);
  return Dlp(t3[0] * t5[0] + t3[4] * t5[1], t3[1] * t5[0] + t3[4] * t5[2],
             t3[2] * t5[0] + t3[4] * t5[3], t3[4] * t5[0]);
}
...
inline Dlp sp(const Dlp& dlp, const Trs& trs) {
  ...
  const Trs& t4 = trs;
  Trs t5 = reverse(t4);
  return Dlp(t3[0] * t5[0], t3[1] * t5[0], t3[2] * t5[0],
...
inline Dlp sp(const Dlp& dlp, const Rtc& rtc) {
  const Rtc& t1 = rtc;
  const Dlp& t2 = dlp;
  Mtt t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] - t1[3] * t2[3],
...
inline Dlp sp(const Dlp& dlp, const Rtt& rtt) {
  ...
  Rtc t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] - t1[4] * t2[3],
         t1[0] * t2[1] - t1[1] * t2[0] + t1[3] * t2[2] - t1[5] * t2[3],
         t1[0] * t2[2] - t1[2] * t2[0] - t1[3] * t2[1] - t1[6] * t2[3],
         -t1[4] * t2[0] - t1[5] * t2[1] - t1[6] * t2[2], t1[0] * t2[3],
         -t1[4] * t2[1] + t1[5] * t2[0] - t1[7] * t2[2],
         -t1[4] * t2[2] + t1[6] * t2[0] + t1[7] * t2[1],
         -t1[5] * t2[2] + t1[6] * t2[1] - t1[7] * t2[0], t1[1] * t2[3],
         t1[2] * t2[3], t1[3] * t2[3], t1[4] * t2[3], t1[5] * t2[3],
         t1[6] * t2[3],
...
inline Dlp sp(const Dlp& dlp, const Tvd& tvd) {
  ...
  Pnt_Dap t3(t1[0] * t2[0] - t1[1] * t2[3], t1[0] * t2[1] - t1[2] * t2[3],
             ...
             t1[0] * t2[3] + t1[4] * t2[3], -t1[1] * t2[1] + t1[2] * t2[0],
             -t1[1] * t2[2] + t1[3] * t2[0], -t1[2] * t2[2] + t1[3] * t2[1],
             t1[1] * t2[3] + t1[4] * t2[0], t1[2] * t2[3] + t1[4] * t2[1],
             t1[3] * t2[3] + t1[4] * t2[2]);
  const Tvd& t4 = tvd;
  Tvd t5 = reverse(t4);
  return Dlp(t3[0] * t5[0] + t3[4] * t5[1] + t3[8] * t5[4],
...
inline Dlp sp(const Dlp& dlp, const Tsd& tsd) {
  ...
  const Tsd& t4 = tsd;
  Tsd t5 = reverse(t4);
  return Dlp(t3[0] * t5[0] + t3[7] * t5[4], t3[1] * t5[0] + t3[8] * t5[4],
             t3[2] * t5[0] + t3[9] * t5[4],
             t3[0] * t5[1] + t3[1] * t5[2] + t3[2] * t5[3] + t3[3] * t5[0] -
...
inline Dlp sp(const Dlp& dlp, const Trt& trt) {
  ...
  const Trt& t4 = trt;
  Trt t5 = reverse(t4);
  return Dlp(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] + t3[3] * t5[7] +
             ...
             t3[0] * t5[7] + t3[1] * t5[8] + t3[2] * t5[9] + t3[4] * t5[0] -
                 t3[4] * t5[10] - t3[8] * t5[1] + t3[8] * t5[11] -
                 t3[9] * t5[2] + t3[9] * t5[12] - t3[10] * t5[3] +
                 t3[10] * t5[13] + t3[11] * t5[7] + t3[12] * t5[8] +
                 t3[13] * t5[9]);
}
...
inline Dlp sp(const Dlp& dlp, const Bst& bst) {
  const Bst& t1 = bst;
  const Dlp& t2 = dlp;
  Pnt_Par t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] - t1[4] * t2[3],
             t1[0] * t2[1] - t1[1] * t2[0] + t1[3] * t2[2] - t1[5] * t2[3],
             t1[0] * t2[2] - t1[2] * t2[0] - t1[3] * t2[1] - t1[6] * t2[3],
             -t1[4] * t2[0] - t1[5] * t2[1] - t1[6] * t2[2],
             t1[0] * t2[3] - t1[7] * t2[0] - t1[8] * t2[1] - t1[9] * t2[2] +
             ...
             t1[4] * t2[3] + t1[10] * t2[0], t1[5] * t2[3] + t1[10] * t2[1],
  ...
  return Dlp(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] + t3[3] * t5[7] +
             ...
             t3[0] * t5[7] + t3[1] * t5[8] + t3[2] * t5[9] + t3[4] * t5[0] -
                 t3[4] * t5[10] - t3[8] * t5[1] - t3[9] * t5[2] -
                 t3[10] * t5[3] + t3[11] * t5[7] + t3[12] * t5[8] +
                 t3[13] * t5[9]);
}
...
inline Dlp re(const Dlp& dlp, const Dll& dll) {
  ...
  const Dll& t5 = dll;
  Dll t6 = reverse(t5);
  return Dlp(-t4[1] * t6[0] - t4[2] * t6[1] - t4[7] * t6[2],
...
inline Dlp re(const Dlp& dlp, const Lin& lin) {
  ...
  const Dlp& t2 = dlp;
  Dlp t3 = involute(t2);
  Lin_Dlp t4(-t1[0] * t3[1] - t1[1] * t3[2] + t1[3] * t3[3],
  ...
  const Lin& t5 = lin;
  Lin t6 = reverse(t5);
  return Dlp(t4[3] * t6[3] + t4[4] * t6[4] + t4[5] * t6[5],
...
inline Dlp re(const Dlp& dlp, const Pnt& pnt) {
  ...
  Bst t4(t1[0] * t3[0] + t1[1] * t3[1] + t1[2] * t3[2] - t1[3] * t3[3],
         ...
         -t1[3] * t3[2], t1[0] * t3[3] - t1[4] * t3[0],
         t1[1] * t3[3] - t1[4] * t3[1], t1[2] * t3[3] - t1[4] * t3[2],
         t1[3] * t3[3]);
  const Pnt& t5 = pnt;
  Pnt t6 = reverse(t5);
  return Dlp(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[4] * t6[4] -
                 t4[7] * t6[3],
...
inline Dlp re(const Dlp& dlp, const Par& par) {
  ...
  const Dlp& t2 = dlp;
  Dlp t3 = involute(t2);
  Pnt_Par t4(t1[0] * t3[1] + t1[1] * t3[2] - t1[3] * t3[3],
             -t1[0] * t3[0] + t1[2] * t3[2] - t1[4] * t3[3],
             -t1[1] * t3[0] - t1[2] * t3[1] - t1[5] * t3[3],
             -t1[3] * t3[0] - t1[4] * t3[1] - t1[5] * t3[2],
             ...
             t1[3] * t3[3] + t1[9] * t3[0], t1[4] * t3[3] + t1[9] * t3[1],
             t1[5] * t3[3] + t1[9] * t3[2],
             t1[0] * t3[2] - t1[1] * t3[1] + t1[2] * t3[0]);
  const Par& t5 = par;
  Par t6 = reverse(t5);
  return Dlp(-t4[1] * t6[0] - t4[2] * t6[1] + t4[3] * t6[6] + t4[4] * t6[3] +
...
inline Dlp re(const Dlp& dlp, const Cir& cir) {
  ...
  const Dlp& t2 = dlp;
  Dlp t3 = involute(t2);
  Pnt_Cir t4(-t1[0] * t3[3] + t1[9] * t3[2], -t1[1] * t3[3] - t1[9] * t3[1],
             -t1[2] * t3[3] + t1[9] * t3[0], -t1[0] * t3[1] - t1[1] * t3[2],
             t1[0] * t3[0] - t1[2] * t3[2], t1[1] * t3[0] + t1[2] * t3[1],
  ...
  const Cir& t5 = cir;
  Cir t6 = reverse(t5);
  return Dlp(-t4[2] * t6[9] + t4[4] * t6[3] + t4[5] * t6[4] + t4[7] * t6[0] +
...
inline Dlp re(const Dlp& dlp, const Sph& sph) {
  ...
  const Dlp& t2 = dlp;
  Dlp t3 = involute(t2);
  Pnt_Sph t4(-t1[3] * t3[2], t1[3] * t3[1], -t1[3] * t3[0],
             t1[0] * t3[3] - t1[4] * t3[2], t1[1] * t3[3] + t1[4] * t3[1],
  ...
  const Sph& t5 = sph;
  Sph t6 = reverse(t5);
  return Dlp(-t4[2] * t6[4] - t4[5] * t6[3] - t4[7] * t6[0] - t4[8] * t6[1] -
                 t4[10] * t6[2],

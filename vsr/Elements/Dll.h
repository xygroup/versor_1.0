...
inline Dll gp(const Dll& a, const Sca& b) {
  return Dll(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0], a[4] * b[0],
             a[5] * b[0]);
}

inline Ori_Sta gp(const Dll& a, const Ori& b) {
  return Ori_Sta(-a[3] * b[0], -a[4] * b[0], -a[5] * b[0], a[0] * b[0],
...
inline Mnk_Dll gp(const Dll& a, const Mnk& b) {
  return Mnk_Dll(-a[3] * b[0], -a[4] * b[0], -a[5] * b[0], a[0] * b[0],
                 a[1] * b[0], a[2] * b[0]);
}

inline Hyp_Sta gp(const Dll& a, const Hyp& b) {
  return Hyp_Sta(-a[3] * b[0], -a[4] * b[0], -a[5] * b[0], a[0] * b[0],
                 a[1] * b[0], a[2] * b[0], a[0] * b[1], a[1] * b[1],
                 a[2] * b[1], -a[3] * b[0], -a[4] * b[0], -a[5] * b[0]);
}

inline Lin gp(const Dll& a, const Pss& b) {
  return Lin(a[5] * b[0], -a[4] * b[0], a[3] * b[0], -a[2] * b[0], a[1] * b[0],
             -a[0] * b[0]);
}
...
inline Pnt_Dll gp(const Dll& a, const Pnt& b) {
  return Pnt_Dll(
      ...
      -a[3] * b[0] - a[4] * b[1] - a[5] * b[2], a[0] * b[3], a[1] * b[3],
      a[2] * b[3], a[0] * b[4] - a[3] * b[1] + a[4] * b[0],
      a[1] * b[4] - a[3] * b[2] + a[5] * b[0],
      a[2] * b[4] - a[4] * b[2] + a[5] * b[1], -a[3] * b[3], -a[4] * b[3],
      -a[5] * b[3], a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Pnt_Lin gp(const Dll& a, const Sph& b) {
  return Pnt_Lin(a[5] * b[3], -a[4] * b[3], a[3] * b[3], -a[2] * b[3],
                 a[1] * b[3], -a[0] * b[3],
...
inline Mtt gp(const Dll& a, const Sta& b) {
  return Mtt(-a[0] * b[0] - a[1] * b[1] - a[2] * b[2] + a[3] * b[3] +
             ...
             -a[0] * b[6] + a[2] * b[8] + a[3] * b[0] - a[5] * b[2],
             -a[1] * b[6] - a[2] * b[7] + a[3] * b[1] + a[4] * b[2],
             a[3] * b[3] + a[4] * b[4] + a[5] * b[5], a[3] * b[4] - a[4] * b[3],
...
inline Rvd gp(const Dll& a, const Tnv& b) {
  return Rvd(a[3] * b[0] + a[4] * b[1] + a[5] * b[2], a[3] * b[1] - a[4] * b[0],
...
inline Par_Tnb gp(const Dll& a, const Tnb& b) {
  return Par_Tnb(a[4] * b[0] + a[5] * b[1], -a[3] * b[0] + a[5] * b[2],
                 -a[3] * b[1] - a[4] * b[2],
                 -a[0] * b[0] - a[1] * b[1] - a[2] * b[2],
                 -a[1] * b[2] + a[2] * b[1], a[0] * b[2] - a[2] * b[0],
...
inline Ori_Lin gp(const Dll& a, const Tnt& b) {
  return Ori_Lin(a[5] * b[0], -a[4] * b[0], a[3] * b[0], -a[2] * b[0],
...
inline Lin_Dlp gp(const Dll& a, const Pln& b) {
  return Lin_Dlp(-a[2] * b[3] + a[4] * b[0] + a[5] * b[1],
...
inline Lin_Dfp gp(const Dll& a, const Flp& b) {
  return Lin_Dfp(a[0] * b[1] + a[1] * b[2] - a[3] * b[3],
                 -a[0] * b[0] + a[2] * b[2] - a[4] * b[3],
...
inline Lin_Flp gp(const Dll& a, const Dfp& b) {
  return Lin_Flp(-a[2] * b[3], a[1] * b[3], -a[0] * b[3],
                 -a[0] * b[0] - a[1] * b[1] - a[2] * b[2],
                 -a[1] * b[2] + a[2] * b[1] - a[5] * b[3],
                 a[0] * b[2] - a[2] * b[0] + a[4] * b[3],
                 -a[0] * b[1] + a[1] * b[0] - a[3] * b[3]);
...
inline Mot gp(const Dll& a, const Dll& b) {
  return Mot(-a[0] * b[0] - a[1] * b[1] - a[2] * b[2],
             -a[1] * b[2] + a[2] * b[1], a[0] * b[2] - a[2] * b[0],
             -a[0] * b[1] + a[1] * b[0],
...
inline Lin_Pln gp(const Dll& a, const Dlp& b) {
  return Lin_Pln(a[0] * b[1] + a[1] * b[2], -a[0] * b[0] + a[2] * b[2],
                 -a[1] * b[0] - a[2] * b[1],
...
inline Mnk_Lin gp(const Dll& a, const Tri& b) {
  return Mnk_Lin(-a[2] * b[0], a[1] * b[0], -a[0] * b[0], -a[5] * b[0],
                 a[4] * b[0], -a[3] * b[0]);
}

inline Pnt_Dll gp(const Dll& a, const Aff& b) {
  return Pnt_Dll(a[0] * b[1] + a[1] * b[2] - a[3] * b[3],
                 -a[0] * b[0] + a[2] * b[2] - a[4] * b[3],
                 -a[1] * b[0] - a[2] * b[1] - a[5] * b[3],
...
inline Par_Afp gp(const Dll& a, const Afp& b) {
  return Par_Afp(-a[2] * b[3] + a[4] * b[0] + a[5] * b[1],
                 a[1] * b[3] - a[3] * b[0] + a[5] * b[2],
                 -a[0] * b[3] - a[3] * b[1] - a[4] * b[2],
                 -a[0] * b[0] - a[1] * b[1] - a[2] * b[2],
                 -a[1] * b[2] + a[2] * b[1], a[0] * b[2] - a[2] * b[0],
...
inline Tst gp(const Dll& a, const Dap& b) {
  return Tst(a[3] * b[0] + a[4] * b[1] + a[5] * b[2], a[3] * b[1] - a[4] * b[0],
             a[3] * b[2] - a[5] * b[0], a[4] * b[2] - a[5] * b[1],
             a[0] * b[1] + a[1] * b[2], -a[0] * b[0] + a[2] * b[2],
...
inline Lin_Dll gp(const Dll& a, const Mnv& b) {
  return Lin_Dll(a[3] * b[0] + a[4] * b[1] + a[5] * b[2],
                 a[3] * b[1] - a[4] * b[0], a[3] * b[2] - a[5] * b[0],
...
inline Mot gp(const Dll& a, const Rot& b) {
  return Mot(-a[0] * b[1] - a[1] * b[2] - a[2] * b[3],
...
inline Inf_Dal gp(const Dll& a, const Dil& b) {
  return Inf_Dal(a[0] * b[0], a[1] * b[0], a[2] * b[0],
...
inline Tst gp(const Dll& a, const Trv& b) {
  return Tst(a[3] * b[1] + a[4] * b[2] + a[5] * b[3],
             a[0] * b[0] + a[3] * b[2] - a[4] * b[1],
             a[1] * b[0] + a[3] * b[3] - a[5] * b[1],
             a[2] * b[0] + a[4] * b[3] - a[5] * b[2], a[0] * b[2] + a[1] * b[3],
             -a[0] * b[1] + a[2] * b[3], -a[1] * b[1] - a[2] * b[2],
             a[3] * b[0], a[4] * b[0], a[5] * b[0],
             a[3] * b[1] + a[4] * b[2] + a[5] * b[3], a[3] * b[2] - a[4] * b[1],
...
inline Pln_Flp gp(const Dll& a, const Trs& b) {
  return Pln_Flp(a[0] * b[0], a[1] * b[0], a[2] * b[0],
...
inline Rtc gp(const Dll& a, const Rtc& b) {
  return Rtc(
      a[0] * b[1] + a[1] * b[2] - a[2] * b[14] - a[3] * b[3] + a[4] * b[5] +
          a[5] * b[6],
      -a[0] * b[0] + a[1] * b[14] + a[2] * b[2] - a[3] * b[5] - a[4] * b[3] +
          a[5] * b[7],
      -a[0] * b[14] - a[1] * b[0] - a[2] * b[1] - a[3] * b[6] - a[4] * b[7] -
          a[5] * b[3],
      -a[0] * b[5] - a[1] * b[6] - a[2] * b[7],
      -a[0] * b[8] - a[1] * b[9] - a[2] * b[10] - a[3] * b[0] + a[3] * b[11] -
          a[4] * b[1] + a[4] * b[12] - a[5] * b[2] + a[5] * b[13],
      a[0] * b[3] - a[1] * b[7] + a[2] * b[6],
      a[0] * b[7] + a[1] * b[3] - a[2] * b[5],
      -a[0] * b[6] + a[1] * b[5] + a[2] * b[3],
      a[0] * b[4] - a[1] * b[10] + a[2] * b[9] - a[3] * b[1] + a[3] * b[12] +
          a[4] * b[0] - a[4] * b[11] - a[5] * b[14] + a[5] * b[15],
      a[0] * b[10] + a[1] * b[4] - a[2] * b[8] - a[3] * b[2] + a[3] * b[13] +
          a[4] * b[14] - a[4] * b[15] + a[5] * b[0] - a[5] * b[11],
      -a[0] * b[9] + a[1] * b[8] + a[2] * b[4] - a[3] * b[14] + a[3] * b[15] -
          a[4] * b[2] + a[4] * b[13] + a[5] * b[1] - a[5] * b[12],
      a[0] * b[12] + a[1] * b[13] - a[2] * b[15] - a[3] * b[3] + a[4] * b[5] +
          a[5] * b[6],
      -a[0] * b[11] + a[1] * b[15] + a[2] * b[13] - a[3] * b[5] - a[4] * b[3] +
          a[5] * b[7],
      -a[0] * b[15] - a[1] * b[11] - a[2] * b[12] - a[3] * b[6] - a[4] * b[7] -
          a[5] * b[3],
      a[0] * b[2] - a[1] * b[1] + a[2] * b[0] - a[3] * b[7] + a[4] * b[6] -
          a[5] * b[5],
      a[0] * b[13] - a[1] * b[12] + a[2] * b[11] - a[3] * b[7] + a[4] * b[6] -
          a[5] * b[5]);
}
...
inline Mtt gp(const Dll& a, const Mtt& b) {
  return Mtt(
      ...
      a[0] * b[0] - a[1] * b[3] + a[2] * b[2] + a[3] * b[5] - a[4] * b[4] +
          a[5] * b[14],
      a[0] * b[3] + a[1] * b[0] - a[2] * b[1] + a[3] * b[6] - a[4] * b[14] -
          a[5] * b[4],
      -a[0] * b[2] + a[1] * b[1] + a[2] * b[0] + a[3] * b[14] + a[4] * b[6] -
          a[5] * b[5],
      a[0] * b[5] + a[1] * b[6] - a[2] * b[14],
      -a[0] * b[4] + a[1] * b[14] + a[2] * b[6],
      -a[0] * b[14] - a[1] * b[4] - a[2] * b[5],
      a[0] * b[8] + a[1] * b[9] - a[2] * b[15] + a[3] * b[0] - a[3] * b[10] -
          a[4] * b[1] + a[4] * b[11] - a[5] * b[2] + a[5] * b[12],
      -a[0] * b[7] + a[1] * b[15] + a[2] * b[9] + a[3] * b[1] - a[3] * b[11] +
          a[4] * b[0] - a[4] * b[10] - a[5] * b[3] + a[5] * b[13],
      -a[0] * b[15] - a[1] * b[7] - a[2] * b[8] + a[3] * b[2] - a[3] * b[12] +
          a[4] * b[3] - a[4] * b[13] + a[5] * b[0] - a[5] * b[10],
      -a[0] * b[11] - a[1] * b[12] - a[2] * b[13] + a[3] * b[4] + a[4] * b[5] +
          a[5] * b[6],
      a[0] * b[10] - a[1] * b[13] + a[2] * b[12] + a[3] * b[5] - a[4] * b[4] +
          a[5] * b[14],
      a[0] * b[13] + a[1] * b[10] - a[2] * b[11] + a[3] * b[6] - a[4] * b[14] -
          a[5] * b[4],
      -a[0] * b[12] + a[1] * b[11] + a[2] * b[10] + a[3] * b[14] + a[4] * b[6] -
          a[5] * b[5],
      a[0] * b[6] - a[1] * b[5] + a[2] * b[4],
      a[0] * b[9] - a[1] * b[8] + a[2] * b[7] + a[3] * b[3] - a[3] * b[13] -
...
inline Mtd gp(const Dll& a, const Rtd& b) {
  return Mtd(-a[0] * b[1] - a[1] * b[2] - a[2] * b[3],
             a[0] * b[0] - a[1] * b[3] + a[2] * b[2],
             a[0] * b[3] + a[1] * b[0] - a[2] * b[1],
             -a[0] * b[2] + a[1] * b[1] + a[2] * b[0],
...
inline Tst gp(const Dll& a, const Tvd& b) {
  return Tst(a[3] * b[1] + a[4] * b[2] + a[5] * b[3],
             ...
             a[2] * b[0] + a[4] * b[3] - a[5] * b[2], a[0] * b[2] + a[1] * b[3],
             -a[0] * b[1] + a[2] * b[3], -a[1] * b[1] - a[2] * b[2],
             a[3] * b[0] - a[3] * b[4], a[4] * b[0] - a[4] * b[4],
             a[5] * b[0] - a[5] * b[4], a[3] * b[1] + a[4] * b[2] + a[5] * b[3],
...
inline Inf_Cir gp(const Dll& a, const Tsd& b) {
  return Inf_Cir(a[0] * b[0], a[1] * b[0], a[2] * b[0],
...
inline Mtt gp(const Dll& a, const Trt& b) {
  return Mtt(
      ...
      -a[1] * b[4] - a[2] * b[5],
      a[0] * b[8] + a[1] * b[9] + a[3] * b[0] - a[3] * b[10] - a[4] * b[1] +
          a[4] * b[11] - a[5] * b[2] + a[5] * b[12],
      -a[0] * b[7] + a[2] * b[9] + a[3] * b[1] - a[3] * b[11] + a[4] * b[0] -
          a[4] * b[10] - a[5] * b[3] + a[5] * b[13],
      -a[1] * b[7] - a[2] * b[8] + a[3] * b[2] - a[3] * b[12] + a[4] * b[3] -
...
inline Mtt gp(const Dll& a, const Tst& b) {
  return Mtt(-a[0] * b[1] - a[1] * b[2] - a[2] * b[3] + a[3] * b[4] +
             ...
             -a[0] * b[4] + a[1] * b[14] + a[2] * b[6],
             -a[0] * b[14] - a[1] * b[4] - a[2] * b[5],
             a[0] * b[8] + a[1] * b[9] + a[3] * b[0] - a[3] * b[10] -
                 a[4] * b[1] + a[4] * b[11] - a[5] * b[2] + a[5] * b[12],
             -a[0] * b[7] + a[2] * b[9] + a[3] * b[1] - a[3] * b[11] +
                 a[4] * b[0] - a[4] * b[10] - a[5] * b[3] + a[5] * b[13],
             -a[1] * b[7] - a[2] * b[8] + a[3] * b[2] - a[3] * b[12] +
                 a[4] * b[3] - a[4] * b[13] + a[5] * b[0] - a[5] * b[10],
             -a[0] * b[11] - a[1] * b[12] - a[2] * b[13] + a[3] * b[4] +
                 a[4] * b[5] + a[5] * b[6],
             a[0] * b[10] - a[1] * b[13] + a[2] * b[12] + a[3] * b[5] -
                 a[4] * b[4] + a[5] * b[14],
             a[0] * b[13] + a[1] * b[10] - a[2] * b[11] + a[3] * b[6] -
                 a[4] * b[14] - a[5] * b[4],
...
inline Mtt gp(const Dll& a, const Tvt& b) {
  return Mtt(
      ...
      a[0] * b[5] + a[1] * b[6], -a[0] * b[4] + a[2] * b[6],
      -a[1] * b[4] - a[2] * b[5],
      a[0] * b[8] + a[1] * b[9] - a[2] * b[14] + a[3] * b[0] - a[3] * b[10] -
          a[4] * b[1] + a[4] * b[11] - a[5] * b[2] + a[5] * b[12],
      -a[0] * b[7] + a[1] * b[14] + a[2] * b[9] + a[3] * b[1] - a[3] * b[11] +
          a[4] * b[0] - a[4] * b[10] - a[5] * b[3] + a[5] * b[13],
      -a[0] * b[14] - a[1] * b[7] - a[2] * b[8] + a[3] * b[2] - a[3] * b[12] +
          a[4] * b[3] - a[4] * b[13] + a[5] * b[0] - a[5] * b[10],
      -a[0] * b[11] - a[1] * b[12] - a[2] * b[13] + a[3] * b[4] + a[4] * b[5] +
          a[5] * b[6],
      a[0] * b[10] - a[1] * b[13] + a[2] * b[12] + a[3] * b[5] - a[4] * b[4],
...
inline Mtt gp(const Dll& a, const Bst& b) {
  return Mtt(
      ...
      a[0] * b[8] + a[1] * b[9] + a[3] * b[0] - a[3] * b[10] - a[4] * b[1] -
          a[5] * b[2],
      -a[0] * b[7] + a[2] * b[9] + a[3] * b[1] + a[4] * b[0] - a[4] * b[10] -
          a[5] * b[3],
...
inline Pss_Sta op(const Dll& a, const Hyp& b) {
  return Pss_Sta(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[0] * b[1],
                 a[1] * b[1], a[2] * b[1], -a[3] * b[0], -a[4] * b[0],
                 -a[5] * b[0]);
}

inline Sca op(const Dll& a, const Pss& b) { return Sca(); }

inline Cir op(const Dll& a, const Pnt& b) {
  return Cir(a[0] * b[3], a[1] * b[3], a[2] * b[3],
             a[0] * b[4] - a[3] * b[1] + a[4] * b[0],
             a[1] * b[4] - a[3] * b[2] + a[5] * b[0],
             a[2] * b[4] - a[4] * b[2] + a[5] * b[1], -a[3] * b[3],
             -a[4] * b[3], -a[5] * b[3],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}

inline Sph op(const Dll& a, const Par& b) {
  return Sph(a[0] * b[9] + a[3] * b[4] - a[4] * b[3],
             a[1] * b[9] + a[3] * b[5] - a[5] * b[3],
             a[2] * b[9] + a[4] * b[5] - a[5] * b[4],
             a[0] * b[5] - a[1] * b[4] + a[2] * b[3],
             a[0] * b[8] - a[1] * b[7] + a[2] * b[6] + a[3] * b[2] -
...
inline Sca op(const Dll& a, const Sph& b) { return Sca(); }

inline Sph op(const Dll& a, const Sta& b) {
  return Sph(a[3] * b[4] - a[4] * b[3], a[3] * b[5] - a[5] * b[3],
             a[4] * b[5] - a[5] * b[4], a[0] * b[5] - a[1] * b[4] + a[2] * b[3],
             a[0] * b[8] - a[1] * b[7] + a[2] * b[6] + a[3] * b[2] -
                 a[4] * b[1] + a[5] * b[0]);
}
...
inline Sca op(const Dll& a, const Drb& b) { return Sca(); }

inline Sca op(const Dll& a, const Drt& b) { return Sca(); }
...
inline Sca op(const Dll& a, const Tnt& b) { return Sca(); }

inline Pss op(const Dll& a, const Lin& b) {
  return Pss(a[0] * b[5] - a[1] * b[4] + a[2] * b[3]);
}

inline Sca op(const Dll& a, const Pln& b) { return Sca(); }
...
inline Sca op(const Dll& a, const Dfp& b) { return Sca(); }

inline Drt op(const Dll& a, const Dll& b) {
  return Drt(a[0] * b[5] - a[1] * b[4] + a[2] * b[3] + a[3] * b[2] -
             a[4] * b[1] + a[5] * b[0]);
}

inline Dfp op(const Dll& a, const Dlp& b) {
  return Dfp(a[0] * b[3] - a[3] * b[1] + a[4] * b[0],
             a[1] * b[3] - a[3] * b[2] + a[5] * b[0],
             a[2] * b[3] - a[4] * b[2] + a[5] * b[1],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Dfp op(const Dll& a, const Vec& b) {
  return Dfp(-a[3] * b[1] + a[4] * b[0], -a[3] * b[2] + a[5] * b[0],
             -a[4] * b[2] + a[5] * b[1],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}

inline Drt op(const Dll& a, const Biv& b) {
  return Drt(a[3] * b[2] - a[4] * b[1] + a[5] * b[0]);
}

inline Sca op(const Dll& a, const Tri& b) { return Sca(); }

inline Cir op(const Dll& a, const Aff& b) {
  return Cir(a[0] * b[3], a[1] * b[3], a[2] * b[3], -a[3] * b[1] + a[4] * b[0],
             -a[3] * b[2] + a[5] * b[0], -a[4] * b[2] + a[5] * b[1],
             -a[3] * b[3], -a[4] * b[3], -a[5] * b[3],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Sca op(const Dll& a, const Daf& b) { return Sca(); }
...
inline Sca ip(const Dll& a, const Sca& b) { return Sca(); }

inline Sca ip(const Dll& a, const Ori& b) { return Sca(); }

inline Sca ip(const Dll& a, const Inf& b) { return Sca(); }

inline Sca ip(const Dll& a, const Mnk& b) { return Sca(); }

inline Sca ip(const Dll& a, const Hyp& b) { return Sca(); }
...
inline Sca ip(const Dll& a, const Pnt& b) { return Sca(); }
...
inline Pnt ip(const Dll& a, const Cir& b) {
  return Pnt(-a[2] * b[9] + a[4] * b[0] + a[5] * b[1],
             a[1] * b[9] - a[3] * b[0] + a[5] * b[2],
             -a[0] * b[9] - a[3] * b[1] - a[4] * b[2],
             -a[0] * b[0] - a[1] * b[1] - a[2] * b[2],
             -a[0] * b[3] - a[1] * b[4] - a[2] * b[5] + a[3] * b[6] +
                 a[4] * b[7] + a[5] * b[8]);
}

inline Par ip(const Dll& a, const Sph& b) {
  return Par(a[5] * b[3], -a[4] * b[3], a[3] * b[3], -a[2] * b[3], a[1] * b[3],
             -a[0] * b[3], -a[2] * b[4] + a[4] * b[0] + a[5] * b[1],
             a[1] * b[4] - a[3] * b[0] + a[5] * b[2],
             -a[0] * b[4] - a[3] * b[1] - a[4] * b[2],
             -a[0] * b[0] - a[1] * b[1] - a[2] * b[2]);
}
...
inline Sca ip(const Dll& a, const Drv& b) { return Sca(); }
...
inline Flp ip(const Dll& a, const Pln& b) {
  return Flp(-a[2] * b[3] + a[4] * b[0] + a[5] * b[1],
             a[1] * b[3] - a[3] * b[0] + a[5] * b[2],
             -a[0] * b[3] - a[3] * b[1] - a[4] * b[2],
             -a[0] * b[0] - a[1] * b[1] - a[2] * b[2]);
}

inline Sca ip(const Dll& a, const Flp& b) { return Sca(); }
...
inline Sca ip(const Dll& a, const Dlp& b) { return Sca(); }

inline Sca ip(const Dll& a, const Vec& b) { return Sca(); }
...
inline Sca ip(const Dll& a, const Aff& b) { return Sca(); }
...
inline Inf ip(const Dll& a, const Mnv& b) {
  return Inf(a[3] * b[0] + a[4] * b[1] + a[5] * b[2]);
}
...
inline Dll sp(const Dll& dll, const Rot& rot) {
  const Rot& t1 = rot;
  const Dll& t2 = dll;
  Mot t3(-t1[1] * t2[0] - t1[2] * t2[1] - t1[3] * t2[2],
  ...
  const Rot& t4 = rot;
  Rot t5 = reverse(t4);
  return Dll(t3[0] * t5[1] + t3[1] * t5[0] - t3[2] * t5[3] + t3[3] * t5[2],
...
inline Dll sp(const Dll& dll, const Dil& dil) {
  const Dil& t1 = dil;
  const Dll& t2 = dll;
  Inf_Dal t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2],
             t1[0] * t2[3] + t1[1] * t2[3], t1[0] * t2[4] + t1[1] * t2[4],
             t1[0] * t2[5] + t1[1] * t2[5], t1[1] * t2[0], t1[1] * t2[1],
             t1[1] * t2[2]);
  const Dil& t4 = dil;
  Dil t5 = reverse(t4);
  return Dll(t3[0] * t5[0] + t3[6] * t5[1], t3[1] * t5[0] + t3[7] * t5[1],
...
inline Dll sp(const Dll& dll, const Trv& trv) {
  const Trv& t1 = trv;
  const Dll& t2 = dll;
  Tst t3(t1[1] * t2[3] + t1[2] * t2[4] + t1[3] * t2[5],
         ...
         t1[1] * t2[1] + t1[2] * t2[2], t1[0] * t2[3], t1[0] * t2[4],
         t1[0] * t2[5], -t1[1] * t2[3] - t1[2] * t2[4] - t1[3] * t2[5],
         -t1[1] * t2[4] + t1[2] * t2[3], -t1[1] * t2[5] + t1[3] * t2[3],
         -t1[2] * t2[5] + t1[3] * t2[4],
         t1[1] * t2[2] - t1[2] * t2[1] + t1[3] * t2[0]);
  const Trv& t4 = trv;
  Trv t5 = reverse(t4);
  return Dll(t3[1] * t5[0] + t3[7] * t5[2] - t3[8] * t5[1],
             t3[2] * t5[0] + t3[7] * t5[3] - t3[9] * t5[1],
             t3[3] * t5[0] + t3[8] * t5[3] - t3[9] * t5[2], t3[7] * t5[0],
             t3[8] * t5[0], t3[9] * t5[0]);
}
...
inline Dll sp(const Dll& dll, const Mtd& mtd) {
  const Mtd& t1 = mtd;
  const Dll& t2 = dll;
  Mtd t3(-t1[1] * t2[0] - t1[2] * t2[1] - t1[3] * t2[2],
         t1[0] * t2[0] - t1[2] * t2[2] + t1[3] * t2[1],
         t1[0] * t2[1] + t1[1] * t2[2] - t1[3] * t2[0],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[2] * t2[0],
         t1[0] * t2[3] + t1[1] * t2[4] + t1[2] * t2[5] - t1[5] * t2[0] -
...
inline Dll sp(const Dll& dll, const Trs& trs) {
  const Trs& t1 = trs;
  const Dll& t2 = dll;
  Pln_Flp t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2],
  ...
  const Trs& t4 = trs;
  Trs t5 = reverse(t4);
  return Dll(t3[0] * t5[0], t3[1] * t5[0], t3[2] * t5[0],
...
inline Dll sp(const Dll& dll, const Rtc& rtc) {
  const Rtc& t1 = rtc;
  const Dll& t2 = dll;
  Rtc t3(-t1[1] * t2[0] - t1[2] * t2[1] + t1[3] * t2[3] + t1[5] * t2[4] +
             t1[6] * t2[5] - t1[14] * t2[2],
         t1[0] * t2[0] - t1[2] * t2[2] + t1[3] * t2[4] - t1[5] * t2[3] +
             t1[7] * t2[5] + t1[14] * t2[1],
         t1[0] * t2[1] + t1[1] * t2[2] + t1[3] * t2[5] - t1[6] * t2[3] -
             t1[7] * t2[4] - t1[14] * t2[0],
         -t1[5] * t2[0] - t1[6] * t2[1] - t1[7] * t2[2],
         t1[0] * t2[3] + t1[1] * t2[4] + t1[2] * t2[5] - t1[8] * t2[0] -
             t1[9] * t2[1] - t1[10] * t2[2] + t1[11] * t2[3] + t1[12] * t2[4] +
             t1[13] * t2[5],
         ...
         t1[0] * t2[4] - t1[1] * t2[3] + t1[4] * t2[0] - t1[9] * t2[2] +
             t1[10] * t2[1] + t1[11] * t2[4] - t1[12] * t2[3] + t1[14] * t2[5] +
             t1[15] * t2[5],
         t1[0] * t2[5] - t1[2] * t2[3] + t1[4] * t2[1] + t1[8] * t2[2] -
             t1[10] * t2[0] + t1[11] * t2[5] - t1[13] * t2[3] - t1[14] * t2[4] -
             t1[15] * t2[4],
         t1[1] * t2[5] - t1[2] * t2[4] + t1[4] * t2[2] - t1[8] * t2[1] +
             t1[9] * t2[0] + t1[12] * t2[5] - t1[13] * t2[4] + t1[14] * t2[3] +
             t1[15] * t2[3],
         -t1[3] * t2[3] - t1[5] * t2[4] - t1[6] * t2[5] - t1[12] * t2[0] -
             t1[13] * t2[1] - t1[15] * t2[2],
         -t1[3] * t2[4] + t1[5] * t2[3] - t1[7] * t2[5] + t1[11] * t2[0] -
             t1[13] * t2[2] + t1[15] * t2[1],
         -t1[3] * t2[5] + t1[6] * t2[3] + t1[7] * t2[4] + t1[11] * t2[1] +
             t1[12] * t2[2] - t1[15] * t2[0],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[2] * t2[0] + t1[5] * t2[5] -
             t1[6] * t2[4] + t1[7] * t2[3],
         -t1[5] * t2[5] + t1[6] * t2[4] - t1[7] * t2[3] + t1[11] * t2[2] -
  ...
  return Dll(
      ...
      t3[0] * t5[4] - t3[1] * t5[8] - t3[2] * t5[9] - t3[4] * t5[0] +
          t3[4] * t5[11] - t3[8] * t5[1] + t3[8] * t5[12] - t3[9] * t5[2] +
          t3[9] * t5[13] + t3[10] * t5[14] - t3[10] * t5[15] + t3[11] * t5[4] -
          t3[12] * t5[8] - t3[13] * t5[9] - t3[14] * t5[10] - t3[15] * t5[10],
      t3[0] * t5[8] + t3[1] * t5[4] - t3[2] * t5[10] - t3[4] * t5[1] +
          t3[4] * t5[12] + t3[8] * t5[0] - t3[8] * t5[11] - t3[9] * t5[14] +
          t3[9] * t5[15] - t3[10] * t5[2] + t3[10] * t5[13] + t3[11] * t5[8] +
          t3[12] * t5[4] - t3[13] * t5[10] + t3[14] * t5[9] + t3[15] * t5[9],
      t3[0] * t5[9] + t3[1] * t5[10] + t3[2] * t5[4] - t3[4] * t5[2] +
          t3[4] * t5[13] + t3[8] * t5[14] - t3[8] * t5[15] + t3[9] * t5[0] -
          t3[9] * t5[11] + t3[10] * t5[1] - t3[10] * t5[12] + t3[11] * t5[9] +
          t3[12] * t5[10] + t3[13] * t5[4] - t3[14] * t5[8] - t3[15] * t5[8]);
}
...
inline Dll sp(const Dll& dll, const Mtt& mtt) {
  ...
  Mtt t3(-t1[1] * t2[0] - t1[2] * t2[1] - t1[3] * t2[2] + t1[4] * t2[3] +
         ...
         t1[0] * t2[0] - t1[2] * t2[2] + t1[3] * t2[1] + t1[4] * t2[4] -
             t1[5] * t2[3] + t1[14] * t2[5],
         t1[0] * t2[1] + t1[1] * t2[2] - t1[3] * t2[0] + t1[4] * t2[5] -
             t1[6] * t2[3] - t1[14] * t2[4],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[2] * t2[0] + t1[5] * t2[5] -
             t1[6] * t2[4] + t1[14] * t2[3],
         -t1[5] * t2[0] - t1[6] * t2[1] - t1[14] * t2[2],
         t1[4] * t2[0] - t1[6] * t2[2] + t1[14] * t2[1],
         t1[4] * t2[1] + t1[5] * t2[2] - t1[14] * t2[0],
         t1[0] * t2[3] + t1[1] * t2[4] + t1[2] * t2[5] - t1[8] * t2[0] -
             t1[9] * t2[1] + t1[10] * t2[3] + t1[11] * t2[4] + t1[12] * t2[5] -
             t1[15] * t2[2],
         t1[0] * t2[4] - t1[1] * t2[3] + t1[3] * t2[5] + t1[7] * t2[0] -
             t1[9] * t2[2] + t1[10] * t2[4] - t1[11] * t2[3] + t1[13] * t2[5] +
             t1[15] * t2[1],
         t1[0] * t2[5] - t1[2] * t2[3] - t1[3] * t2[4] + t1[7] * t2[1] +
             t1[8] * t2[2] + t1[10] * t2[5] - t1[12] * t2[3] - t1[13] * t2[4] -
             t1[15] * t2[0],
         -t1[4] * t2[3] - t1[5] * t2[4] - t1[6] * t2[5] - t1[11] * t2[0] -
             t1[12] * t2[1] - t1[13] * t2[2],
         -t1[4] * t2[4] + t1[5] * t2[3] + t1[10] * t2[0] - t1[12] * t2[2] +
             t1[13] * t2[1] - t1[14] * t2[5],
         -t1[4] * t2[5] + t1[6] * t2[3] + t1[10] * t2[1] + t1[11] * t2[2] -
             t1[13] * t2[0] + t1[14] * t2[4],
         -t1[5] * t2[5] + t1[6] * t2[4] + t1[10] * t2[2] - t1[11] * t2[1] +
             t1[12] * t2[0] - t1[14] * t2[3],
         t1[4] * t2[2] - t1[5] * t2[1] + t1[6] * t2[0],
         t1[1] * t2[5] - t1[2] * t2[4] + t1[3] * t2[3] + t1[7] * t2[2] -
             t1[8] * t2[1] + t1[9] * t2[0] + t1[11] * t2[5] - t1[12] * t2[4] +
             t1[13] * t2[3]);
  const Mtt& t4 = mtt;
  Mtt t5 = reverse(t4);
  return Dll(
...
inline Dll sp(const Dll& dll, const Rtt& rtt) {
  ...
  Rtt t5 = reverse(t4);
  return Dll(t3[0] * t5[1] + t3[1] * t5[0] - t3[2] * t5[3] + t3[3] * t5[2] +
                 t3[7] * t5[5] - t3[8] * t5[4] + t3[9] * t5[7] + t3[15] * t5[6],
             t3[0] * t5[2] + t3[1] * t5[3] + t3[2] * t5[0] - t3[3] * t5[1] +
                 t3[7] * t5[6] - t3[8] * t5[7] - t3[9] * t5[4] - t3[15] * t5[5],
             t3[0] * t5[3] - t3[1] * t5[2] + t3[2] * t5[1] + t3[3] * t5[0] +
                 t3[7] * t5[7] + t3[8] * t5[6] - t3[9] * t5[5] + t3[15] * t5[4],
...
inline Dll sp(const Dll& dll, const Tvd& tvd) {
  ...
  Tst t3(t1[1] * t2[3] + t1[2] * t2[4] + t1[3] * t2[5],
         ...
         t1[0] * t2[2] + t1[2] * t2[5] - t1[3] * t2[4],
         -t1[2] * t2[0] - t1[3] * t2[1], t1[1] * t2[0] - t1[3] * t2[2],
         t1[1] * t2[1] + t1[2] * t2[2], t1[0] * t2[3] + t1[4] * t2[3],
         t1[0] * t2[4] + t1[4] * t2[4], t1[0] * t2[5] + t1[4] * t2[5],
  ...
  const Tvd& t4 = tvd;
  Tvd t5 = reverse(t4);
  return Dll(t3[1] * t5[0] + t3[7] * t5[2] - t3[8] * t5[1] + t3[11] * t5[4],
             t3[2] * t5[0] + t3[7] * t5[3] - t3[9] * t5[1] + t3[12] * t5[4],
             t3[3] * t5[0] + t3[8] * t5[3] - t3[9] * t5[2] + t3[13] * t5[4],
             t3[7] * t5[0] - t3[7] * t5[4], t3[8] * t5[0] - t3[8] * t5[4],
             t3[9] * t5[0] - t3[9] * t5[4]);
}
...
inline Dll sp(const Dll& dll, const Tsd& tsd) {
  const Tsd& t1 = tsd;
  const Dll& t2 = dll;
  Inf_Cir t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2],
  ...
  const Tsd& t4 = tsd;
  Tsd t5 = reverse(t4);
  return Dll(t3[0] * t5[0] + t3[6] * t5[4], t3[1] * t5[0] + t3[7] * t5[4],
             t3[2] * t5[0] + t3[8] * t5[4],
...
inline Dll sp(const Dll& dll, const Rvd& rvd) {
  ...
  return Dll(
      t3[0] * t5[1] + t3[1] * t5[0] - t3[2] * t5[3] + t3[3] * t5[2] +
          t3[7] * t5[5] - t3[8] * t5[4] + t3[9] * t5[11] + t3[10] * t5[8] +
          t3[11] * t5[7] - t3[12] * t5[10] + t3[13] * t5[9] + t3[15] * t5[6],
      t3[0] * t5[2] + t3[1] * t5[3] + t3[2] * t5[0] - t3[3] * t5[1] +
          t3[7] * t5[6] - t3[8] * t5[11] - t3[9] * t5[4] + t3[10] * t5[9] +
          t3[11] * t5[10] + t3[12] * t5[7] - t3[13] * t5[8] - t3[15] * t5[5],
      t3[0] * t5[3] - t3[1] * t5[2] + t3[2] * t5[1] + t3[3] * t5[0] +
          t3[7] * t5[11] + t3[8] * t5[6] - t3[9] * t5[5] + t3[10] * t5[10] -
          t3[11] * t5[9] + t3[12] * t5[8] + t3[13] * t5[7] + t3[15] * t5[4],
      t3[7] * t5[0] - t3[7] * t5[7] - t3[8] * t5[1] + t3[8] * t5[8] -
          t3[9] * t5[2] + t3[9] * t5[9] - t3[15] * t5[3] + t3[15] * t5[10],
      t3[7] * t5[1] - t3[7] * t5[8] + t3[8] * t5[0] - t3[8] * t5[7] -
          t3[9] * t5[3] + t3[9] * t5[10] + t3[15] * t5[2] - t3[15] * t5[9],
      t3[7] * t5[2] - t3[7] * t5[9] + t3[8] * t5[3] - t3[8] * t5[10] +
          t3[9] * t5[0] - t3[9] * t5[7] - t3[15] * t5[1] + t3[15] * t5[8]);
}
...
inline Dll sp(const Dll& dll, const Bst& bst) {
  ...
  Mtt t3(-t1[1] * t2[0] - t1[2] * t2[1] - t1[3] * t2[2] + t1[4] * t2[3] +
         ...
         t1[4] * t2[1] + t1[5] * t2[2],
         t1[0] * t2[3] + t1[1] * t2[4] + t1[2] * t2[5] - t1[8] * t2[0] -
             t1[9] * t2[1] + t1[10] * t2[3],
         t1[0] * t2[4] - t1[1] * t2[3] + t1[3] * t2[5] + t1[7] * t2[0] -
             t1[9] * t2[2] + t1[10] * t2[4],
         t1[0] * t2[5] - t1[2] * t2[3] - t1[3] * t2[4] + t1[7] * t2[1] +
             t1[8] * t2[2] + t1[10] * t2[5],
         -t1[4] * t2[3] - t1[5] * t2[4] - t1[6] * t2[5],
  ...
  return Dll(
      ...
      t3[0] * t5[3] - t3[1] * t5[2] + t3[2] * t5[1] + t3[3] * t5[0] +
          ...
          t3[13] * t5[10] + t3[14] * t5[7] + t3[15] * t5[4],
      t3[0] * t5[7] + t3[1] * t5[8] + t3[2] * t5[9] + t3[7] * t5[0] -
          t3[7] * t5[10] - t3[8] * t5[1] - t3[9] * t5[2] + t3[10] * t5[7] +
          t3[11] * t5[8] + t3[12] * t5[9] - t3[15] * t5[3],
      t3[0] * t5[8] - t3[1] * t5[7] + t3[3] * t5[9] + t3[7] * t5[1] +
          t3[8] * t5[0] - t3[8] * t5[10] - t3[9] * t5[3] + t3[10] * t5[8] -
          t3[11] * t5[7] + t3[13] * t5[9] + t3[15] * t5[2],
      t3[0] * t5[9] - t3[2] * t5[7] - t3[3] * t5[8] + t3[7] * t5[2] +
          t3[8] * t5[3] + t3[9] * t5[0] - t3[9] * t5[10] + t3[10] * t5[9] -
          t3[12] * t5[7] - t3[13] * t5[8] - t3[15] * t5[1]);
}
...
inline Dll re(const Dll& dll, const Vec& vec) {
  ...
  const Dll& t2 = dll;
  Dll t3 = involute(t2);
  Lin_Pln t4(-t1[1] * t3[0] - t1[2] * t3[1], t1[0] * t3[0] - t1[2] * t3[2],
             t1[0] * t3[1] + t1[1] * t3[2],
  ...
  const Vec& t5 = vec;
  Vec t6 = reverse(t5);
  return Dll(t4[0] * t6[1] - t4[1] * t6[0] + t4[7] * t6[2],
...
inline Dll re(const Dll& dll, const Pln& pln) {
  ...
  const Dll& t2 = dll;
  Dll t3 = involute(t2);
  Lin_Dlp t4(t1[0] * t3[4] + t1[1] * t3[5] - t1[3] * t3[2],
  ...
  const Pln& t5 = pln;
  Pln t6 = reverse(t5);
  return Dll(t4[3] * t6[0] - t4[5] * t6[2] + t4[6] * t6[1],
...
inline Dll re(const Dll& dll, const Lin& lin) {
  ...
  const Lin& t5 = lin;
  Lin t6 = reverse(t5);
  return Dll(t4[4] * t6[4] - t4[5] * t6[3] + t4[7] * t6[5],
...
inline Dll re(const Dll& dll, const Pnt& pnt) {
  ...
  const Dll& t2 = dll;
  Dll t3 = involute(t2);
  Pnt_Dll t4(-t1[1] * t3[0] - t1[2] * t3[1] + t1[3] * t3[3],
             ...
             t1[1] * t3[5] - t1[2] * t3[4] + t1[4] * t3[2], -t1[3] * t3[3],
             -t1[3] * t3[4], -t1[3] * t3[5],
             t1[0] * t3[2] - t1[1] * t3[1] + t1[2] * t3[0]);
  const Pnt& t5 = pnt;
  Pnt t6 = reverse(t5);
  return Dll(t4[0] * t6[1] - t4[1] * t6[0] - t4[4] * t6[4] - t4[7] * t6[3] +
                 t4[13] * t6[2],
             t4[0] * t6[2] - t4[2] * t6[0] - t4[5] * t6[4] - t4[8] * t6[3] -
                 t4[13] * t6[1],
             t4[1] * t6[2] - t4[2] * t6[1] - t4[6] * t6[4] - t4[9] * t6[3] +
                 t4[13] * t6[0],
             t4[0] * t6[4] - t4[3] * t6[0] - t4[7] * t6[1] - t4[8] * t6[2] +
                 t4[10] * t6[4],
             t4[1] * t6[4] - t4[3] * t6[1] + t4[7] * t6[0] - t4[9] * t6[2] +
                 t4[11] * t6[4],
             t4[2] * t6[4] - t4[3] * t6[2] + t4[8] * t6[0] + t4[9] * t6[1] +
                 t4[12] * t6[4]);
}
...
inline Dll re(const Dll& dll, const Par& par) {
  ...
  const Par& t5 = par;
  Par t6 = reverse(t5);
  return Dll(t4[0] * t6[0] - t4[2] * t6[2] + t4[3] * t6[1] + t4[4] * t6[7] -
...
inline Dll re(const Dll& dll, const Cir& cir) {
  ...
  const Dll& t2 = dll;
  Dll t3 = involute(t2);
  Rtc t4(t1[0] * t3[4] + t1[1] * t3[5] - t1[9] * t3[2],
         -t1[0] * t3[3] + t1[2] * t3[5] + t1[9] * t3[1],
         -t1[1] * t3[3] - t1[2] * t3[4] - t1[9] * t3[0],
         -t1[0] * t3[0] - t1[1] * t3[1] - t1[2] * t3[2],
         -t1[3] * t3[0] - t1[4] * t3[1] - t1[5] * t3[2] + t1[6] * t3[3] +
             t1[7] * t3[4] + t1[8] * t3[5],
         -t1[1] * t3[2] + t1[2] * t3[1], t1[0] * t3[2] - t1[2] * t3[0],
         -t1[0] * t3[1] + t1[1] * t3[0],
  ...
  const Cir& t5 = cir;
  Cir t6 = reverse(t5);
  return Dll(t4[2] * t6[9] - t4[3] * t6[3] - t4[4] * t6[0] + t4[6] * t6[5] -
             ...
             -t4[1] * t6[3] - t4[2] * t6[4] + t4[4] * t6[6] + t4[8] * t6[7] +
                 t4[9] * t6[8] + t4[10] * t6[9] - t4[12] * t6[3] -
                 t4[13] * t6[4] - t4[14] * t6[5] - t4[15] * t6[5],
             t4[0] * t6[3] - t4[2] * t6[5] + t4[4] * t6[7] - t4[8] * t6[6] -
                 t4[9] * t6[9] + t4[10] * t6[8] + t4[11] * t6[3] -
                 t4[13] * t6[5] + t4[14] * t6[4] + t4[15] * t6[4],
             t4[0] * t6[4] + t4[1] * t6[5] + t4[4] * t6[8] + t4[8] * t6[9] -
                 t4[9] * t6[6] - t4[10] * t6[7] + t4[11] * t6[4] +
                 t4[12] * t6[5] - t4[14] * t6[3] - t4[15] * t6[3]);
}
...
inline Dll re(const Dll& dll, const Sph& sph) {
  ...
  const Dll& t2 = dll;
  Dll t3 = involute(t2);
  Pnt_Lin t4(t1[3] * t3[5], -t1[3] * t3[4], t1[3] * t3[3], -t1[3] * t3[2],
             t1[3] * t3[1], -t1[3] * t3[0],
  ...
  const Sph& t5 = sph;
  Sph t6 = reverse(t5);
  return Dll(t4[5] * t6[4] + t4[8] * t6[3] + t4[9] * t6[0] - t4[11] * t6[2] +
                 t4[12] * t6[1],
             -t4[4] * t6[4] - t4[7] * t6[3] + t4[9] * t6[1] + t4[10] * t6[2] -
                 t4[12] * t6[0],
             t4[3] * t6[4] + t4[6] * t6[3] + t4[9] * t6[2] - t4[10] * t6[1] +
                 t4[11] * t6[0],
             -t4[2] * t6[4] + t4[7] * t6[0] + t4[8] * t6[1] - t4[12] * t6[4] +
                 t4[13] * t6[2],
             t4[1] * t6[4] - t4[6] * t6[0] + t4[8] * t6[2] + t4[11] * t6[4] -
                 t4[13] * t6[1],
             -t4[0] * t6[4] - t4[6] * t6[1] - t4[7] * t6[2] - t4[10] * t6[4] +
                 t4[13] * t6[0]);
}

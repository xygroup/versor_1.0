...
inline Rtt gp(const Rtt& a, const Sca& b) {
  return Rtt(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0], a[4] * b[0],
             a[5] * b[0], a[6] * b[0], a[7] * b[0]);
}

inline Tnv_Vec gp(const Rtt& a, const Ori& b) {
  return Tnv_Vec(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0]);
}

inline Par_Drb gp(const Rtt& a, const Inf& b) {
  return Par_Drb(-a[4] * b[0], -a[5] * b[0], -a[6] * b[0], a[0] * b[0],
                 a[1] * b[0], a[2] * b[0], a[3] * b[0], a[4] * b[0],
                 a[5] * b[0], a[6] * b[0], -a[7] * b[0], a[7] * b[0]);
}

inline Vec_Dal gp(const Rtt& a, const Mnk& b) {
  return Vec_Dal(a[4] * b[0], a[5] * b[0], a[6] * b[0], a[0] * b[0],
                 a[1] * b[0], a[2] * b[0], a[3] * b[0], a[7] * b[0]);
}

inline Rtc gp(const Rtt& a, const Hyp& b) {
  return Rtc(-a[4] * b[1], -a[5] * b[1], -a[6] * b[1], a[0] * b[0], a[0] * b[1],
             a[1] * b[0], a[2] * b[0], a[3] * b[0], a[1] * b[1], a[2] * b[1],
             a[3] * b[1], a[4] * b[1], a[5] * b[1], a[6] * b[1], -a[7] * b[1],
             a[7] * b[1]);
}

inline Biv_Dal gp(const Rtt& a, const Pss& b) {
  return Biv_Dal(a[7] * b[0], -a[6] * b[0], a[5] * b[0], -a[4] * b[0],
...
inline Rtc gp(const Rtt& a, const Pnt& b) {
  return Rtc(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[4] * b[4],
             ...
             a[0] * b[3] - a[4] * b[0] - a[5] * b[1] - a[6] * b[2], a[0] * b[4],
             a[1] * b[3] - a[4] * b[1] + a[5] * b[0] - a[7] * b[2],
             a[2] * b[3] - a[4] * b[2] + a[6] * b[0] + a[7] * b[1],
             a[3] * b[3] - a[5] * b[2] + a[6] * b[1] - a[7] * b[0], a[1] * b[4],
...
inline Mtt gp(const Rtt& a, const Par& b) {
  return Mtt(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[4] * b[6] +
             ...
             a[0] * b[4] - a[1] * b[3] + a[3] * b[5] + a[4] * b[0] +
                 a[5] * b[9] - a[6] * b[2] + a[7] * b[1],
             a[0] * b[5] - a[2] * b[3] - a[3] * b[4] + a[4] * b[1] +
                 a[5] * b[2] + a[6] * b[9] - a[7] * b[0],
...
inline Par_Drb gp(const Rtt& a, const Drb& b) {
  return Par_Drb(a[5] * b[0] + a[6] * b[1] + a[7] * b[2],
...
inline Mtd gp(const Rtt& a, const Drt& b) {
  return Mtd(-a[7] * b[0], a[6] * b[0], -a[5] * b[0], a[4] * b[0], -a[3] * b[0],
             a[2] * b[0], -a[1] * b[0], a[7] * b[0], -a[6] * b[0], a[5] * b[0],
             -a[4] * b[0], a[0] * b[0]);
}
...
inline Tnv_Vec gp(const Rtt& a, const Tnb& b) {
  return Tnv_Vec(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Tnv_Biv gp(const Rtt& a, const Tnt& b) {
  return Tnv_Biv(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[0] * b[0]);
}

inline Rtc gp(const Rtt& a, const Lin& b) {
  return Rtc(a[5] * b[0] + a[6] * b[1] + a[7] * b[2],
             -a[4] * b[0] + a[6] * b[2] - a[7] * b[1],
             -a[4] * b[1] - a[5] * b[2] + a[7] * b[0],
...
inline Mtt gp(const Rtt& a, const Pln& b) {
  return Mtt(-a[7] * b[3], a[6] * b[3], -a[5] * b[3], a[4] * b[3],
             -a[5] * b[0] - a[6] * b[1] - a[7] * b[2],
             a[4] * b[0] - a[6] * b[2] + a[7] * b[1],
             a[4] * b[1] + a[5] * b[2] - a[7] * b[0], -a[3] * b[3], a[2] * b[3],
             -a[1] * b[3],
             ...
             a[4] * b[2] - a[5] * b[1] + a[6] * b[0], a[0] * b[3]);
}

inline Mtt gp(const Rtt& a, const Flp& b) {
  return Mtt(a[4] * b[0] + a[5] * b[1] + a[6] * b[2],
             a[4] * b[1] - a[5] * b[0] + a[7] * b[2],
             a[4] * b[2] - a[6] * b[0] - a[7] * b[1],
             a[5] * b[2] - a[6] * b[1] + a[7] * b[0], a[4] * b[3], a[5] * b[3],
             a[6] * b[3], a[0] * b[0] + a[1] * b[1] + a[2] * b[2],
             a[0] * b[1] - a[1] * b[0] + a[3] * b[2],
             a[0] * b[2] - a[2] * b[0] - a[3] * b[1],
             a[0] * b[3] - a[4] * b[0] - a[5] * b[1] - a[6] * b[2],
             a[1] * b[3] - a[4] * b[1] + a[5] * b[0] - a[7] * b[2],
             a[2] * b[3] - a[4] * b[2] + a[6] * b[0] + a[7] * b[1],
             a[3] * b[3] - a[5] * b[2] + a[6] * b[1] - a[7] * b[0], a[7] * b[3],
             a[1] * b[2] - a[2] * b[1] + a[3] * b[0]);
}

inline Rtc gp(const Rtt& a, const Dfp& b) {
  return Rtc(-a[3] * b[3] + a[5] * b[0] + a[6] * b[1] + a[7] * b[2],
             a[2] * b[3] - a[4] * b[0] + a[6] * b[2] - a[7] * b[1],
             -a[1] * b[3] - a[4] * b[1] - a[5] * b[2] + a[7] * b[0],
             a[7] * b[3], -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
...
inline Rtc gp(const Rtt& a, const Dlp& b) {
  return Rtc(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[4] * b[3],
             a[0] * b[1] - a[1] * b[0] + a[3] * b[2] - a[5] * b[3],
             a[0] * b[2] - a[2] * b[0] - a[3] * b[1] - a[6] * b[3],
             -a[4] * b[0] - a[5] * b[1] - a[6] * b[2], a[0] * b[3],
             -a[4] * b[1] + a[5] * b[0] - a[7] * b[2],
             -a[4] * b[2] + a[6] * b[0] + a[7] * b[1],
             -a[5] * b[2] + a[6] * b[1] - a[7] * b[0], a[1] * b[3], a[2] * b[3],
             a[3] * b[3], a[4] * b[3], a[5] * b[3], a[6] * b[3],
...
inline Rtt gp(const Rtt& a, const Biv& b) {
  return Rtt(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
             a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
             a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0],
             -a[5] * b[0] - a[6] * b[1] - a[7] * b[2],
...
inline Vec_Afl gp(const Rtt& a, const Tri& b) {
  return Vec_Afl(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[7] * b[0],
                 -a[6] * b[0], a[5] * b[0], -a[4] * b[0], a[0] * b[0]);
}
...
inline Vec_Afl gp(const Rtt& a, const Afp& b) {
  return Vec_Afl(-a[3] * b[3], a[2] * b[3], -a[1] * b[3],
                 -a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[7] * b[3],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1] - a[6] * b[3],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0] + a[5] * b[3],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0] - a[4] * b[3],
...
inline Vec_Dal gp(const Rtt& a, const Dap& b) {
  return Vec_Dal(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] + a[4] * b[3],
                 a[0] * b[1] - a[1] * b[0] + a[3] * b[2] + a[5] * b[3],
                 a[0] * b[2] - a[2] * b[0] - a[3] * b[1] + a[6] * b[3],
...
inline Vec_Dal gp(const Rtt& a, const Daf& b) {
  return Vec_Dal(-a[3] * b[3] - a[5] * b[0] - a[6] * b[1] - a[7] * b[2],
                 a[2] * b[3] + a[4] * b[0] - a[6] * b[2] + a[7] * b[1],
                 -a[1] * b[3] + a[4] * b[1] + a[5] * b[2] - a[7] * b[0],
                 -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
...
inline Biv_Dal gp(const Rtt& a, const Dal& b) {
  return Biv_Dal(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2] - a[4] * b[3] -
                     a[5] * b[4] - a[6] * b[5],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1] - a[4] * b[4] +
                     a[5] * b[3] - a[7] * b[5],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0] - a[4] * b[5] +
...
inline Biv_Dal gp(const Rtt& a, const Mnv& b) {
  return Biv_Dal(-a[4] * b[0] - a[5] * b[1] - a[6] * b[2],
                 -a[4] * b[1] + a[5] * b[0] - a[7] * b[2],
                 -a[4] * b[2] + a[6] * b[0] + a[7] * b[1],
                 -a[5] * b[2] + a[6] * b[1] - a[7] * b[0],
                 a[0] * b[0] + a[1] * b[1] + a[2] * b[2],
...
inline Rtt gp(const Rtt& a, const Rot& b) {
  return Rtt(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3],
...
inline Rvd gp(const Rtt& a, const Dil& b) {
  return Rvd(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0],
             ...
             a[6] * b[0] + a[6] * b[1], a[0] * b[1], a[1] * b[1], a[2] * b[1],
             a[3] * b[1], a[7] * b[0] + a[7] * b[1]);
}

inline Rtt gp(const Rtt& a, const Trv& b) {
  return Rtt(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0],
...
inline Mtt gp(const Rtt& a, const Mtd& b) {
  return Mtt(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] +
                 a[4] * b[4] + a[5] * b[5] + a[6] * b[6] - a[7] * b[11],
             a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] +
                 a[4] * b[5] - a[5] * b[4] + a[6] * b[11] + a[7] * b[6],
             a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] +
                 a[4] * b[6] - a[5] * b[11] - a[6] * b[4] - a[7] * b[5],
             a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] +
                 a[4] * b[11] + a[5] * b[6] - a[6] * b[5] + a[7] * b[4],
...
inline Rtc gp(const Rtt& a, const Rtc& b) {
  return Rtc(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[3] * b[14] -
             ...
             a[0] * b[14] + a[1] * b[2] - a[2] * b[1] + a[3] * b[0] -
                 a[4] * b[10] + a[5] * b[9] - a[6] * b[8] - a[7] * b[4],
...
inline Mtt gp(const Rtt& a, const Mtt& b) {
  return Mtt(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] +
                 a[4] * b[7] + a[5] * b[8] + a[6] * b[9] - a[7] * b[15],
             a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] +
                 a[4] * b[8] - a[5] * b[7] + a[6] * b[15] + a[7] * b[9],
             a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] +
                 a[4] * b[9] - a[5] * b[15] - a[6] * b[7] - a[7] * b[8],
             a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] +
                 a[4] * b[15] + a[5] * b[9] - a[6] * b[8] + a[7] * b[7],
             a[0] * b[4] + a[1] * b[5] + a[2] * b[6] - a[3] * b[14] +
                 a[4] * b[0] + a[4] * b[10] - a[5] * b[1] - a[5] * b[11] -
                 a[6] * b[2] - a[6] * b[12] - a[7] * b[3] - a[7] * b[13],
             a[0] * b[5] - a[1] * b[4] + a[2] * b[14] + a[3] * b[6] +
                 a[4] * b[1] + a[4] * b[11] + a[5] * b[0] + a[5] * b[10] -
                 a[6] * b[3] - a[6] * b[13] + a[7] * b[2] + a[7] * b[12],
             a[0] * b[6] - a[1] * b[14] - a[2] * b[4] - a[3] * b[5] +
                 a[4] * b[2] + a[4] * b[12] + a[5] * b[3] + a[5] * b[13] +
                 a[6] * b[0] + a[6] * b[10] - a[7] * b[1] - a[7] * b[11],
             ...
             a[0] * b[14] + a[1] * b[6] - a[2] * b[5] + a[3] * b[4] +
                 ...
                 a[6] * b[1] + a[6] * b[11] + a[7] * b[0] + a[7] * b[10],
...
inline Mtt gp(const Rtt& a, const Tsd& b) {
  return Mtt(a[0] * b[0] + a[4] * b[1] + a[5] * b[2] + a[6] * b[3],
             ...
             a[6] * b[0] + a[6] * b[4], a[0] * b[1] + a[1] * b[2] + a[2] * b[3],
             a[0] * b[2] - a[1] * b[1] + a[3] * b[3],
             a[0] * b[3] - a[2] * b[1] - a[3] * b[2],
...
inline Mtt gp(const Rtt& a, const Tvt& b) {
  return Mtt(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] +
                 a[4] * b[7] + a[5] * b[8] + a[6] * b[9] - a[7] * b[14],
             a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] +
                 a[4] * b[8] - a[5] * b[7] + a[6] * b[14] + a[7] * b[9],
             a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] +
                 a[4] * b[9] - a[5] * b[14] - a[6] * b[7] - a[7] * b[8],
             a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] +
...
inline Mtt gp(const Rtt& a, const Bst& b) {
  return Mtt(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] +
             ...
             a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] +
                 a[5] * b[9] - a[6] * b[8] + a[7] * b[7],
             a[0] * b[4] + a[1] * b[5] + a[2] * b[6] + a[4] * b[0] +
                 a[4] * b[10] - a[5] * b[1] - a[6] * b[2] - a[7] * b[3],
             a[0] * b[5] - a[1] * b[4] + a[3] * b[6] + a[4] * b[1] +
                 a[5] * b[0] + a[5] * b[10] - a[6] * b[3] + a[7] * b[2],
             a[0] * b[6] - a[2] * b[4] - a[3] * b[5] + a[4] * b[2] +
                 a[5] * b[3] + a[6] * b[0] + a[6] * b[10] - a[7] * b[1],
             a[0] * b[7] + a[1] * b[8] + a[2] * b[9],
             a[0] * b[8] - a[1] * b[7] + a[3] * b[9],
             a[0] * b[9] - a[2] * b[7] - a[3] * b[8],
             ...
             a[1] * b[6] - a[2] * b[5] + a[3] * b[4] + a[4] * b[3] -
                 a[5] * b[2] + a[6] * b[1] + a[7] * b[0] + a[7] * b[10],
             a[1] * b[9] - a[2] * b[8] + a[3] * b[7]);
}

inline Rtt ip(const Rtt& a, const Rtt& b) {
  return Rtt(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3], a[0] * b[1],
             a[0] * b[2], a[0] * b[3], a[0] * b[4] - a[3] * b[7],
             a[0] * b[5] + a[2] * b[7], a[0] * b[6] - a[1] * b[7], a[0] * b[7]);
}
...
inline Rtt sp(const Rtt& rtt, const Dil& dil) {
  ...
  Rvd t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2], t1[0] * t2[3],
         ...
         t1[0] * t2[6] - t1[1] * t2[6], t1[1] * t2[0], t1[1] * t2[1],
         t1[1] * t2[2], t1[1] * t2[3], t1[0] * t2[7] - t1[1] * t2[7]);
  const Dil& t4 = dil;
  Dil t5 = reverse(t4);
  return Rtt(t3[0] * t5[0] + t3[7] * t5[1], t3[1] * t5[0] + t3[8] * t5[1],
             t3[2] * t5[0] + t3[9] * t5[1], t3[3] * t5[0] + t3[10] * t5[1],
             t3[4] * t5[0] + t3[4] * t5[1], t3[5] * t5[0] + t3[5] * t5[1],
             t3[6] * t5[0] + t3[6] * t5[1], t3[11] * t5[0] + t3[11] * t5[1]);
}
...
inline Rtt sp(const Rtt& rtt, const Trv& trv) {
  const Trv& t1 = trv;
  const Rtt& t2 = rtt;
  Rtt t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2], t1[0] * t2[3],
  ...
  const Trv& t4 = trv;
  Trv t5 = reverse(t4);
  return Rtt(t3[0] * t5[0], t3[1] * t5[0], t3[2] * t5[0], t3[3] * t5[0],
...
inline Rtt sp(const Rtt& rtt, const Mtd& mtd) {
  ...
  const Rtt& t2 = rtt;
  Mtt t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3] +
             t1[4] * t2[4] + t1[5] * t2[5] + t1[6] * t2[6] - t1[11] * t2[7],
         t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] +
             t1[4] * t2[5] - t1[5] * t2[4] + t1[6] * t2[7] + t1[11] * t2[6],
         t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] +
             t1[4] * t2[6] - t1[5] * t2[7] - t1[6] * t2[4] - t1[11] * t2[5],
         t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] +
             t1[4] * t2[7] + t1[5] * t2[6] - t1[6] * t2[5] + t1[11] * t2[4],
         t1[0] * t2[4] + t1[1] * t2[5] + t1[2] * t2[6] - t1[3] * t2[7] -
             t1[7] * t2[4] - t1[8] * t2[5] - t1[9] * t2[6] + t1[10] * t2[7],
         t1[0] * t2[5] - t1[1] * t2[4] + t1[2] * t2[7] + t1[3] * t2[6] -
             t1[7] * t2[5] + t1[8] * t2[4] - t1[9] * t2[7] - t1[10] * t2[6],
         t1[0] * t2[6] - t1[1] * t2[7] - t1[2] * t2[4] - t1[3] * t2[5] -
             t1[7] * t2[6] + t1[8] * t2[7] + t1[9] * t2[4] + t1[10] * t2[5],
         ...
         t1[4] * t2[4] + t1[5] * t2[5] + t1[6] * t2[6] + t1[7] * t2[0] -
             t1[8] * t2[1] - t1[9] * t2[2] - t1[10] * t2[3] - t1[11] * t2[7],
         t1[4] * t2[5] - t1[5] * t2[4] + t1[6] * t2[7] + t1[7] * t2[1] +
             t1[8] * t2[0] - t1[9] * t2[3] + t1[10] * t2[2] + t1[11] * t2[6],
         t1[4] * t2[6] - t1[5] * t2[7] - t1[6] * t2[4] + t1[7] * t2[2] +
         ...
         t1[0] * t2[7] + t1[1] * t2[6] - t1[2] * t2[5] + t1[3] * t2[4] -
             t1[7] * t2[7] - t1[8] * t2[6] + t1[9] * t2[5] - t1[10] * t2[4],
...
inline Rtt sp(const Rtt& rtt, const Rtc& rtc) {
  ...
  Rtc t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] + t1[4] * t2[4] +
             t1[8] * t2[5] + t1[9] * t2[6] - t1[10] * t2[7] - t1[14] * t2[3],
         t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[4] * t2[5] -
             t1[8] * t2[4] + t1[9] * t2[7] + t1[10] * t2[6] + t1[14] * t2[2],
         t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] + t1[4] * t2[6] -
             t1[8] * t2[7] - t1[9] * t2[4] - t1[10] * t2[5] - t1[14] * t2[1],
         t1[0] * t2[4] + t1[1] * t2[5] + t1[2] * t2[6] + t1[3] * t2[0] -
             t1[5] * t2[1] - t1[6] * t2[2] - t1[7] * t2[3] - t1[11] * t2[4] -
             t1[12] * t2[5] - t1[13] * t2[6] - t1[14] * t2[7] + t1[15] * t2[7],
         t1[4] * t2[0] - t1[8] * t2[1] - t1[9] * t2[2] - t1[10] * t2[3],
         t1[0] * t2[5] - t1[1] * t2[4] + t1[2] * t2[7] + t1[3] * t2[1] +
             t1[5] * t2[0] - t1[6] * t2[3] + t1[7] * t2[2] - t1[11] * t2[5] +
             t1[12] * t2[4] - t1[13] * t2[7] + t1[14] * t2[6] - t1[15] * t2[6],
         t1[0] * t2[6] - t1[1] * t2[7] - t1[2] * t2[4] + t1[3] * t2[2] +
             t1[5] * t2[3] + t1[6] * t2[0] - t1[7] * t2[1] - t1[11] * t2[6] +
             t1[12] * t2[7] + t1[13] * t2[4] - t1[14] * t2[5] + t1[15] * t2[5],
         t1[0] * t2[7] + t1[1] * t2[6] - t1[2] * t2[5] + t1[3] * t2[3] -
             t1[5] * t2[2] + t1[6] * t2[1] + t1[7] * t2[0] - t1[11] * t2[7] -
         ...
         t1[4] * t2[4] + t1[8] * t2[5] + t1[9] * t2[6] - t1[10] * t2[7] +
             t1[11] * t2[0] - t1[12] * t2[1] - t1[13] * t2[2] - t1[15] * t2[3],
         t1[4] * t2[5] - t1[8] * t2[4] + t1[9] * t2[7] + t1[10] * t2[6] +
             t1[11] * t2[1] + t1[12] * t2[0] - t1[13] * t2[3] + t1[15] * t2[2],
         t1[4] * t2[6] - t1[8] * t2[7] - t1[9] * t2[4] - t1[10] * t2[5] +
             t1[11] * t2[2] + t1[12] * t2[3] + t1[13] * t2[0] - t1[15] * t2[1],
         t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[4] * t2[7] +
             t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[4] + t1[14] * t2[0],
         t1[4] * t2[7] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[4] +
...
inline Rtt sp(const Rtt& rtt, const Mtt& mtt) {
  ...
  const Rtt& t2 = rtt;
  Mtt t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3] +
             t1[7] * t2[4] + t1[8] * t2[5] + t1[9] * t2[6] - t1[15] * t2[7],
         t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] +
             t1[7] * t2[5] - t1[8] * t2[4] + t1[9] * t2[7] + t1[15] * t2[6],
         t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] +
             t1[7] * t2[6] - t1[8] * t2[7] - t1[9] * t2[4] - t1[15] * t2[5],
         t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] +
             t1[7] * t2[7] + t1[8] * t2[6] - t1[9] * t2[5] + t1[15] * t2[4],
         t1[0] * t2[4] + t1[1] * t2[5] + t1[2] * t2[6] - t1[3] * t2[7] +
             t1[4] * t2[0] - t1[5] * t2[1] - t1[6] * t2[2] - t1[10] * t2[4] -
             t1[11] * t2[5] - t1[12] * t2[6] + t1[13] * t2[7] - t1[14] * t2[3],
         t1[0] * t2[5] - t1[1] * t2[4] + t1[2] * t2[7] + t1[3] * t2[6] +
             t1[4] * t2[1] + t1[5] * t2[0] - t1[6] * t2[3] - t1[10] * t2[5] +
             t1[11] * t2[4] - t1[12] * t2[7] - t1[13] * t2[6] + t1[14] * t2[2],
         t1[0] * t2[6] - t1[1] * t2[7] - t1[2] * t2[4] - t1[3] * t2[5] +
             t1[4] * t2[2] + t1[5] * t2[3] + t1[6] * t2[0] - t1[10] * t2[6] +
             t1[11] * t2[7] + t1[12] * t2[4] + t1[13] * t2[5] - t1[14] * t2[1],
         ...
         t1[7] * t2[4] + t1[8] * t2[5] + t1[9] * t2[6] + t1[10] * t2[0] -
             t1[11] * t2[1] - t1[12] * t2[2] - t1[13] * t2[3] - t1[15] * t2[7],
         ...
         t1[0] * t2[7] + t1[1] * t2[6] - t1[2] * t2[5] + t1[3] * t2[4] +
             t1[4] * t2[3] - t1[5] * t2[2] + t1[6] * t2[1] - t1[10] * t2[7] -
             t1[11] * t2[6] + t1[12] * t2[5] - t1[13] * t2[4] + t1[14] * t2[0],
...
inline Rtt sp(const Rtt& rtt, const Tvd& tvd) {
  ...
  Rvd t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2], t1[0] * t2[3],
         ...
         t1[0] * t2[6] + t1[1] * t2[2] + t1[2] * t2[3] + t1[3] * t2[0] -
             t1[4] * t2[6],
         t1[4] * t2[0], t1[4] * t2[1], t1[4] * t2[2], t1[4] * t2[3],
         t1[0] * t2[7] + t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1] -
             t1[4] * t2[7]);
  const Tvd& t4 = tvd;
  Tvd t5 = reverse(t4);
  return Rtt(t3[0] * t5[0] + t3[7] * t5[4], t3[1] * t5[0] + t3[8] * t5[4],
...
inline Rtt sp(const Rtt& rtt, const Tsd& tsd) {
  ...
  return Rtt(t3[0] * t5[0] + t3[4] * t5[1] + t3[5] * t5[2] + t3[6] * t5[3] +
             ...
             t3[6] * t5[0] + t3[6] * t5[4], t3[14] * t5[0] + t3[14] * t5[4]);
}
...
inline Rtt sp(const Rtt& rtt, const Trt& trt) {
  ...
  const Rtt& t2 = rtt;
  Mtt t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3] +
             t1[7] * t2[4] + t1[8] * t2[5] + t1[9] * t2[6],
         t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] +
             t1[7] * t2[5] - t1[8] * t2[4] + t1[9] * t2[7],
         t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] +
             t1[7] * t2[6] - t1[8] * t2[7] - t1[9] * t2[4],
         t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] +
             t1[7] * t2[7] + t1[8] * t2[6] - t1[9] * t2[5],
         t1[0] * t2[4] + t1[1] * t2[5] + t1[2] * t2[6] - t1[3] * t2[7] +
             t1[4] * t2[0] - t1[5] * t2[1] - t1[6] * t2[2] - t1[10] * t2[4] -
             t1[11] * t2[5] - t1[12] * t2[6] + t1[13] * t2[7],
         t1[0] * t2[5] - t1[1] * t2[4] + t1[2] * t2[7] + t1[3] * t2[6] +
             t1[4] * t2[1] + t1[5] * t2[0] - t1[6] * t2[3] - t1[10] * t2[5] +
             t1[11] * t2[4] - t1[12] * t2[7] - t1[13] * t2[6],
         t1[0] * t2[6] - t1[1] * t2[7] - t1[2] * t2[4] - t1[3] * t2[5] +
             t1[4] * t2[2] + t1[5] * t2[3] + t1[6] * t2[0] - t1[10] * t2[6] +
             t1[11] * t2[7] + t1[12] * t2[4] + t1[13] * t2[5],
         ...
         t1[0] * t2[7] + t1[1] * t2[6] - t1[2] * t2[5] + t1[3] * t2[4] +
             t1[4] * t2[3] - t1[5] * t2[2] + t1[6] * t2[1] - t1[10] * t2[7] -
             t1[11] * t2[6] + t1[12] * t2[5] - t1[13] * t2[4],
...
inline Rtt sp(const Rtt& rtt, const Rvd& rvd) {
  ...
  Rvd t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3],
         ...
         t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0],
         t1[0] * t2[4] + t1[1] * t2[5] + t1[2] * t2[6] - t1[3] * t2[7] +
             t1[4] * t2[0] - t1[5] * t2[1] - t1[6] * t2[2] - t1[7] * t2[4] -
             t1[8] * t2[5] - t1[9] * t2[6] + t1[10] * t2[7] - t1[11] * t2[3],
         t1[0] * t2[5] - t1[1] * t2[4] + t1[2] * t2[7] + t1[3] * t2[6] +
             t1[4] * t2[1] + t1[5] * t2[0] - t1[6] * t2[3] - t1[7] * t2[5] +
             t1[8] * t2[4] - t1[9] * t2[7] - t1[10] * t2[6] + t1[11] * t2[2],
         t1[0] * t2[6] - t1[1] * t2[7] - t1[2] * t2[4] - t1[3] * t2[5] +
             t1[4] * t2[2] + t1[5] * t2[3] + t1[6] * t2[0] - t1[7] * t2[6] +
             t1[8] * t2[7] + t1[9] * t2[4] + t1[10] * t2[5] - t1[11] * t2[1],
         ...
         t1[0] * t2[7] + t1[1] * t2[6] - t1[2] * t2[5] + t1[3] * t2[4] +
             t1[4] * t2[3] - t1[5] * t2[2] + t1[6] * t2[1] - t1[7] * t2[7] -
             t1[8] * t2[6] + t1[9] * t2[5] - t1[10] * t2[4] + t1[11] * t2[0]);
  const Rvd& t4 = rvd;
  Rvd t5 = reverse(t4);
  return Rtt(
      t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3] +
...
inline Rtt sp(const Rtt& rtt, const Tvt& tvt) {
  ...
  const Rtt& t2 = rtt;
  Mtt t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3] +
             t1[7] * t2[4] + t1[8] * t2[5] + t1[9] * t2[6] - t1[14] * t2[7],
         t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] +
             t1[7] * t2[5] - t1[8] * t2[4] + t1[9] * t2[7] + t1[14] * t2[6],
         t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] +
             t1[7] * t2[6] - t1[8] * t2[7] - t1[9] * t2[4] - t1[14] * t2[5],
         t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] +
             t1[7] * t2[7] + t1[8] * t2[6] - t1[9] * t2[5] + t1[14] * t2[4],
         t1[0] * t2[4] + t1[1] * t2[5] + t1[2] * t2[6] - t1[3] * t2[7] +
             t1[4] * t2[0] - t1[5] * t2[1] - t1[6] * t2[2] - t1[10] * t2[4] -
             t1[11] * t2[5] - t1[12] * t2[6] + t1[13] * t2[7],
         t1[0] * t2[5] - t1[1] * t2[4] + t1[2] * t2[7] + t1[3] * t2[6] +
         ...
         t1[7] * t2[4] + t1[8] * t2[5] + t1[9] * t2[6] + t1[10] * t2[0] -
             t1[11] * t2[1] - t1[12] * t2[2] - t1[13] * t2[3] - t1[14] * t2[7],
         t1[7] * t2[5] - t1[8] * t2[4] + t1[9] * t2[7] + t1[10] * t2[1] +
...
inline Rtt re(const Rtt& rtt, const Vec& vec) {
  ...
  const Rtt& t2 = rtt;
  Rtt t3 = involute(t2);
  Vec_Afl t4(t1[0] * t3[0] - t1[1] * t3[1] - t1[2] * t3[2],
  ...
  const Vec& t5 = vec;
  Vec t6 = reverse(t5);
  return Rtt(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2],
...
inline Rtt re(const Rtt& rtt, const Dlp& dlp) {
  ...
  Rtc t4(t1[0] * t3[0] - t1[1] * t3[1] - t1[2] * t3[2] + t1[3] * t3[4],
         ...
         t1[0] * t3[5] - t1[1] * t3[4] + t1[2] * t3[7],
         t1[0] * t3[6] - t1[1] * t3[7] - t1[2] * t3[4],
         t1[0] * t3[7] + t1[1] * t3[6] - t1[2] * t3[5], t1[3] * t3[1],
  ...
  const Dlp& t5 = dlp;
  Dlp t6 = reverse(t5);
  return Rtt(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[3] * t6[3],
...
inline Rtt re(const Rtt& rtt, const Pln& pln) {
  ...
  const Rtt& t2 = rtt;
  Rtt t3 = involute(t2);
  Mtt t4(-t1[3] * t3[7], t1[3] * t3[6], -t1[3] * t3[5], t1[3] * t3[4],
         -t1[0] * t3[5] - t1[1] * t3[6] + t1[2] * t3[7],
         t1[0] * t3[4] - t1[1] * t3[7] - t1[2] * t3[6],
         t1[0] * t3[7] + t1[1] * t3[4] + t1[2] * t3[5], -t1[3] * t3[3],
         t1[3] * t3[2], -t1[3] * t3[1],
  ...
  const Pln& t5 = pln;
  Pln t6 = reverse(t5);
  return Rtt(-t4[11] * t6[0] - t4[12] * t6[1] - t4[13] * t6[2] - t4[14] * t6[3],
...
inline Rtt re(const Rtt& rtt, const Dll& dll) {
  ...
  const Dll& t5 = dll;
  Dll t6 = reverse(t5);
  return Rtt(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2] + t4[4] * t6[3] +
                 t4[5] * t6[4] + t4[6] * t6[5],
...
inline Rtt re(const Rtt& rtt, const Lin& lin) {
  ...
  const Rtt& t2 = rtt;
  Rtt t3 = involute(t2);
  Rtc t4(t1[0] * t3[5] + t1[1] * t3[6] - t1[2] * t3[7],
         -t1[0] * t3[4] + t1[1] * t3[7] + t1[2] * t3[6],
         -t1[0] * t3[7] - t1[1] * t3[4] - t1[2] * t3[5],
         -t1[3] * t3[4] - t1[4] * t3[5] - t1[5] * t3[6],
         ...
         t1[0] * t3[5] + t1[1] * t3[6] - t1[2] * t3[7] + t1[3] * t3[0] -
             t1[4] * t3[1] - t1[5] * t3[2],
         -t1[0] * t3[4] + t1[1] * t3[7] + t1[2] * t3[6] + t1[3] * t3[1] +
             t1[4] * t3[0] - t1[5] * t3[3],
         -t1[0] * t3[7] - t1[1] * t3[4] - t1[2] * t3[5] + t1[3] * t3[2] +
             t1[4] * t3[3] + t1[5] * t3[0],
         t1[0] * t3[6] - t1[1] * t3[5] + t1[2] * t3[4],
  ...
  const Lin& t5 = lin;
  Lin t6 = reverse(t5);
  return Rtt(t4[5] * t6[0] + t4[6] * t6[1] + t4[7] * t6[2] + t4[11] * t6[3] +
...
inline Rtt re(const Rtt& rtt, const Pnt& pnt) {
  ...
  const Pnt& t5 = pnt;
  Pnt t6 = reverse(t5);
  return Rtt(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[3] * t6[4] -
                 t4[4] * t6[3],
...
inline Rtt re(const Rtt& rtt, const Par& par) {
  ...
  Mtt t4(-t1[0] * t3[1] - t1[1] * t3[2] - t1[2] * t3[3] + t1[6] * t3[4] +
         ...
         t1[0] * t3[3] + t1[1] * t3[0] - t1[2] * t3[1] + t1[6] * t3[6] -
             t1[7] * t3[7] - t1[8] * t3[4],
         -t1[0] * t3[2] + t1[1] * t3[1] + t1[2] * t3[0] + t1[6] * t3[7] +
             t1[7] * t3[6] - t1[8] * t3[5],
         t1[0] * t3[5] + t1[1] * t3[6] - t1[2] * t3[7] + t1[3] * t3[0] -
             t1[4] * t3[1] - t1[5] * t3[2] - t1[9] * t3[4],
         -t1[0] * t3[4] + t1[1] * t3[7] + t1[2] * t3[6] + t1[3] * t3[1] +
             t1[4] * t3[0] - t1[5] * t3[3] - t1[9] * t3[5],
         -t1[0] * t3[7] - t1[1] * t3[4] - t1[2] * t3[5] + t1[3] * t3[2] +
             t1[4] * t3[3] + t1[5] * t3[0] - t1[9] * t3[6],
         ...
         t1[0] * t3[6] - t1[1] * t3[5] + t1[2] * t3[4] + t1[3] * t3[3] -
             t1[4] * t3[2] + t1[5] * t3[1] - t1[9] * t3[7],
         t1[6] * t3[3] - t1[7] * t3[2] + t1[8] * t3[1]);
  const Par& t5 = par;
  Par t6 = reverse(t5);
  return Rtt(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2] + t4[4] * t6[6] +
...
inline Rtt re(const Rtt& rtt, const Cir& cir) {
  ...
  const Rtt& t2 = rtt;
  Rtt t3 = involute(t2);
  Rtc t4(t1[3] * t3[5] + t1[4] * t3[6] - t1[5] * t3[7] - t1[9] * t3[3],
         ...
         t1[0] * t3[0] - t1[1] * t3[3] + t1[2] * t3[2] - t1[6] * t3[5] +
             t1[7] * t3[4] - t1[8] * t3[7] + t1[9] * t3[6],
         t1[0] * t3[3] + t1[1] * t3[0] - t1[2] * t3[1] - t1[6] * t3[6] +
             t1[7] * t3[7] + t1[8] * t3[4] - t1[9] * t3[5],
         -t1[0] * t3[2] + t1[1] * t3[1] + t1[2] * t3[0] - t1[6] * t3[7] -
             t1[7] * t3[6] + t1[8] * t3[5] + t1[9] * t3[4],
         t1[3] * t3[0] - t1[4] * t3[3] + t1[5] * t3[2],
         t1[3] * t3[3] + t1[4] * t3[0] - t1[5] * t3[1],
         -t1[3] * t3[2] + t1[4] * t3[1] + t1[5] * t3[0],
         t1[3] * t3[5] + t1[4] * t3[6] - t1[5] * t3[7] + t1[6] * t3[0] -
             t1[7] * t3[1] - t1[8] * t3[2],
         -t1[3] * t3[4] + t1[4] * t3[7] + t1[5] * t3[6] + t1[6] * t3[1] +
             t1[7] * t3[0] - t1[8] * t3[3],
         -t1[3] * t3[7] - t1[4] * t3[4] - t1[5] * t3[5] + t1[6] * t3[2] +
             t1[7] * t3[3] + t1[8] * t3[0],
  ...
  const Cir& t5 = cir;
  Cir t6 = reverse(t5);
  return Rtt(t4[5] * t6[3] + t4[6] * t6[4] + t4[7] * t6[5] + t4[8] * t6[0] +
...
inline Rtt re(const Rtt& rtt, const Sph& sph) {
  ...
  const Sph& t5 = sph;
  Sph t6 = reverse(t5);
  return Rtt(-t4[11] * t6[0] - t4[12] * t6[1] - t4[13] * t6[2] -

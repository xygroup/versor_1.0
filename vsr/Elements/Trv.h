...
inline Trv gp(const Trv& a, const Sca& b) {
  return Trv(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0]);
}

inline Ori gp(const Trv& a, const Ori& b) { return Ori(a[0] * b[0]); }

inline Inf_Dap gp(const Trv& a, const Inf& b) {
  return Inf_Dap(-a[1] * b[0], -a[2] * b[0], -a[3] * b[0], a[0] * b[0],
                 a[1] * b[0], a[2] * b[0], a[3] * b[0]);
}

inline Dap gp(const Trv& a, const Mnk& b) {
  return Dap(a[1] * b[0], a[2] * b[0], a[3] * b[0], a[0] * b[0]);
}

inline Hyp_Flp gp(const Trv& a, const Hyp& b) {
  return Hyp_Flp(-a[1] * b[1], -a[2] * b[1], -a[3] * b[1], a[0] * b[0],
                 a[0] * b[1], a[1] * b[1], a[2] * b[1], a[3] * b[1]);
}

inline Mnk_Afp gp(const Trv& a, const Pss& b) {
  return Mnk_Afp(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[0] * b[0]);
}

inline Pnt_Dap gp(const Trv& a, const Pnt& b) {
  return Pnt_Dap(a[0] * b[0] - a[1] * b[4], a[0] * b[1] - a[2] * b[4],
                 a[0] * b[2] - a[3] * b[4],
                 a[0] * b[3] - a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 a[0] * b[4], -a[1] * b[1] + a[2] * b[0],
...
inline Tst gp(const Trv& a, const Par& b) {
  return Tst(a[1] * b[6] + a[2] * b[7] + a[3] * b[8],
             ...
             a[0] * b[5] + a[1] * b[1] + a[2] * b[2] + a[3] * b[9], a[0] * b[6],
             a[0] * b[7], a[0] * b[8],
             a[0] * b[9] - a[1] * b[6] - a[2] * b[7] - a[3] * b[8],
             -a[1] * b[7] + a[2] * b[6], -a[1] * b[8] + a[3] * b[6],
             -a[2] * b[8] + a[3] * b[7],
...
inline Par_Afp gp(const Trv& a, const Cir& b) {
  return Par_Afp(
      a[2] * b[3] + a[3] * b[4], -a[1] * b[3] + a[3] * b[5],
      -a[1] * b[4] - a[2] * b[5], -a[1] * b[6] - a[2] * b[7] - a[3] * b[8],
      a[0] * b[0] - a[1] * b[7] + a[2] * b[6] - a[3] * b[9],
      a[0] * b[1] - a[1] * b[8] + a[2] * b[9] + a[3] * b[6],
      a[0] * b[2] - a[1] * b[9] - a[2] * b[8] + a[3] * b[7], a[0] * b[3],
      a[0] * b[4], a[0] * b[5], a[0] * b[6] - a[2] * b[3] - a[3] * b[4],
...
inline Pnt_Afp gp(const Trv& a, const Sph& b) {
  return Pnt_Afp(a[3] * b[4], -a[2] * b[4], a[1] * b[4],
                 -a[2] * b[0] - a[3] * b[1], a[1] * b[0] - a[3] * b[2],
                 a[1] * b[1] + a[2] * b[2], a[0] * b[0] - a[3] * b[4],
                 a[0] * b[1] + a[2] * b[4], a[0] * b[2] - a[1] * b[4],
...
inline Tst gp(const Trv& a, const Sta& b) {
  return Tst(a[1] * b[6] + a[2] * b[7] + a[3] * b[8],
             ...
             a[0] * b[5] + a[1] * b[1] + a[2] * b[2], a[0] * b[6], a[0] * b[7],
             a[0] * b[8], -a[1] * b[6] - a[2] * b[7] - a[3] * b[8],
             -a[1] * b[7] + a[2] * b[6], -a[1] * b[8] + a[3] * b[6],
             -a[2] * b[8] + a[3] * b[7],
             a[1] * b[2] - a[2] * b[1] + a[3] * b[0]);
}
...
inline Drv_Dap gp(const Trv& a, const Drv& b) {
  return Drv_Dap(a[1] * b[0] + a[2] * b[1] + a[3] * b[2],
                 ...
                 a[0] * b[2], -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 -a[1] * b[1] + a[2] * b[0], -a[1] * b[2] + a[3] * b[0],
                 -a[2] * b[2] + a[3] * b[1]);
}
...
inline Drv_Afp gp(const Trv& a, const Drb& b) {
  return Drv_Afp(a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2], a[0] * b[0], a[0] * b[1],
...
inline Tnt gp(const Trv& a, const Tnt& b) { return Tnt(a[0] * b[0]); }

inline Par_Afp gp(const Trv& a, const Lin& b) {
  return Par_Afp(a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2],
                 -a[1] * b[3] - a[2] * b[4] - a[3] * b[5],
                 -a[1] * b[4] + a[2] * b[3], -a[1] * b[5] + a[3] * b[3],
                 -a[2] * b[5] + a[3] * b[4], a[0] * b[0], a[0] * b[1],
                 a[0] * b[2], a[0] * b[3] - a[2] * b[0] - a[3] * b[1],
                 a[0] * b[4] + a[1] * b[0] - a[3] * b[2],
...
inline Pnt_Afp gp(const Trv& a, const Pln& b) {
  return Pnt_Afp(a[3] * b[3], -a[2] * b[3], a[1] * b[3],
                 -a[2] * b[0] - a[3] * b[1], a[1] * b[0] - a[3] * b[2],
                 a[1] * b[1] + a[2] * b[2], a[0] * b[0] - a[3] * b[3],
                 a[0] * b[1] + a[2] * b[3], a[0] * b[2] - a[1] * b[3],
                 a[1] * b[2] - a[2] * b[1] + a[3] * b[0], a[0] * b[3]);
}

inline Trt gp(const Trv& a, const Flp& b) {
  return Trt(a[1] * b[0] + a[2] * b[1] + a[3] * b[2], a[1] * b[1] - a[2] * b[0],
             a[1] * b[2] - a[3] * b[0], a[2] * b[2] - a[3] * b[1], a[1] * b[3],
             a[2] * b[3], a[3] * b[3], a[0] * b[0], a[0] * b[1], a[0] * b[2],
             a[0] * b[3] - a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
             -a[1] * b[1] + a[2] * b[0], -a[1] * b[2] + a[3] * b[0],
             -a[2] * b[2] + a[3] * b[1]);
}
...
inline Tst gp(const Trv& a, const Dll& b) {
  return Tst(
      ...
      a[0] * b[2] + a[2] * b[5] - a[3] * b[4], -a[2] * b[0] - a[3] * b[1],
      a[1] * b[0] - a[3] * b[2], a[1] * b[1] + a[2] * b[2], a[0] * b[3],
      a[0] * b[4], a[0] * b[5], -a[1] * b[3] - a[2] * b[4] - a[3] * b[5],
      -a[1] * b[4] + a[2] * b[3], -a[1] * b[5] + a[3] * b[3],
      -a[2] * b[5] + a[3] * b[4], a[1] * b[2] - a[2] * b[1] + a[3] * b[0]);
}

inline Pnt_Dap gp(const Trv& a, const Dlp& b) {
  return Pnt_Dap(
      a[0] * b[0] - a[1] * b[3], a[0] * b[1] - a[2] * b[3],
      a[0] * b[2] - a[3] * b[3], -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
      a[0] * b[3], -a[1] * b[1] + a[2] * b[0], -a[1] * b[2] + a[3] * b[0],
      -a[2] * b[2] + a[3] * b[1], a[1] * b[3], a[2] * b[3], a[3] * b[3]);
}

inline Biv_Afp gp(const Trv& a, const Vec& b) {
  return Biv_Afp(a[0] * b[0], a[0] * b[1], a[0] * b[2],
...
inline Vec_Afp gp(const Trv& a, const Biv& b) {
  return Vec_Afp(a[0] * b[0], a[0] * b[1], a[0] * b[2],
                 -a[2] * b[0] - a[3] * b[1], a[1] * b[0] - a[3] * b[2],
                 a[1] * b[1] + a[2] * b[2],
                 a[1] * b[2] - a[2] * b[1] + a[3] * b[0]);
}
...
inline Afp gp(const Trv& a, const Tri& b) {
  return Afp(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[0] * b[0]);
}
...
inline Afp gp(const Trv& a, const Afp& b) {
  return Afp(a[0] * b[0] - a[3] * b[3], a[0] * b[1] + a[2] * b[3],
             a[0] * b[2] - a[1] * b[3], a[0] * b[3]);
}

inline Dap gp(const Trv& a, const Dap& b) {
  return Dap(a[0] * b[0] + a[1] * b[3], a[0] * b[1] + a[2] * b[3],
             a[0] * b[2] + a[3] * b[3], a[0] * b[3]);
}

inline Biv_Dap gp(const Trv& a, const Daf& b) {
  return Biv_Dap(-a[2] * b[0] - a[3] * b[1], a[1] * b[0] - a[3] * b[2],
                 a[1] * b[1] + a[2] * b[2], a[0] * b[0], a[0] * b[1],
                 a[0] * b[2],
                 a[0] * b[3] + a[1] * b[2] - a[2] * b[1] + a[3] * b[0]);
}
...
inline Vec_Dap gp(const Trv& a, const Dal& b) {
  return Vec_Dap(-a[1] * b[3] - a[2] * b[4] - a[3] * b[5],
                 a[0] * b[0] - a[1] * b[4] + a[2] * b[3],
                 a[0] * b[1] - a[1] * b[5] + a[3] * b[3],
                 a[0] * b[2] - a[2] * b[5] + a[3] * b[4], a[0] * b[3],
                 a[0] * b[4], a[0] * b[5]);
}

inline Vec_Dap gp(const Trv& a, const Mnv& b) {
  return Vec_Dap(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 -a[1] * b[1] + a[2] * b[0], -a[1] * b[2] + a[3] * b[0],
                 -a[2] * b[2] + a[3] * b[1], a[0] * b[0], a[0] * b[1],
                 a[0] * b[2]);
}
...
inline Rtt gp(const Trv& a, const Rot& b) {
  return Rtt(a[0] * b[0], a[0] * b[1], a[0] * b[2], a[0] * b[3],
             a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
...
inline Mtt gp(const Trv& a, const Mot& b) {
  return Mtt(a[0] * b[0] + a[1] * b[4] + a[2] * b[5] + a[3] * b[6],
             ...
             a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
             a[1] * b[1] + a[2] * b[0] - a[3] * b[3],
             a[1] * b[2] + a[2] * b[3] + a[3] * b[0], a[0] * b[4], a[0] * b[5],
             a[0] * b[6], -a[1] * b[4] - a[2] * b[5] - a[3] * b[6],
             -a[1] * b[5] + a[2] * b[4] - a[3] * b[7],
             -a[1] * b[6] + a[2] * b[7] + a[3] * b[4],
             -a[1] * b[7] - a[2] * b[6] + a[3] * b[5],
             a[1] * b[3] - a[2] * b[2] + a[3] * b[1], a[0] * b[7]);
}

inline Tvd gp(const Trv& a, const Dil& b) {
  return Tvd(a[0] * b[0], a[1] * b[0] + a[1] * b[1], a[2] * b[0] + a[2] * b[1],
             a[3] * b[0] + a[3] * b[1], a[0] * b[1]);
}

inline Trv gp(const Trv& a, const Trv& b) {
  return Trv(a[0] * b[0], a[0] * b[1] + a[1] * b[0], a[0] * b[2] + a[2] * b[0],
             a[0] * b[3] + a[3] * b[0]);
}
...
inline Mtt gp(const Trv& a, const Mtd& b) {
  return Mtt(a[0] * b[0] + a[1] * b[4] + a[2] * b[5] + a[3] * b[6],
             ...
             a[1] * b[0] + a[1] * b[7] - a[2] * b[1] - a[2] * b[8] -
                 a[3] * b[2] - a[3] * b[9],
             a[1] * b[1] + a[1] * b[8] + a[2] * b[0] + a[2] * b[7] -
                 a[3] * b[3] - a[3] * b[10],
             a[1] * b[2] + a[1] * b[9] + a[2] * b[3] + a[2] * b[10] +
                 a[3] * b[0] + a[3] * b[7],
             ...
             a[1] * b[3] + a[1] * b[10] - a[2] * b[2] - a[2] * b[9] +
                 a[3] * b[1] + a[3] * b[8],
             a[0] * b[11]);
}
...
inline Rtc gp(const Trv& a, const Rtc& b) {
  return Rtc(a[0] * b[0] - a[1] * b[4] + a[2] * b[8] + a[3] * b[9],
             a[0] * b[1] - a[1] * b[8] - a[2] * b[4] + a[3] * b[10],
             a[0] * b[2] - a[1] * b[9] - a[2] * b[10] - a[3] * b[4],
             a[0] * b[3] - a[1] * b[0] - a[1] * b[11] - a[2] * b[1] -
                 a[2] * b[12] - a[3] * b[2] - a[3] * b[13],
             a[0] * b[4],
             a[0] * b[5] - a[1] * b[1] - a[1] * b[12] + a[2] * b[0] +
                 a[2] * b[11] - a[3] * b[14] - a[3] * b[15],
             a[0] * b[6] - a[1] * b[2] - a[1] * b[13] + a[2] * b[14] +
                 a[2] * b[15] + a[3] * b[0] + a[3] * b[11],
             a[0] * b[7] - a[1] * b[14] - a[1] * b[15] - a[2] * b[2] -
                 a[2] * b[13] + a[3] * b[1] + a[3] * b[12],
             a[0] * b[8], a[0] * b[9], a[0] * b[10],
...
inline Mtt gp(const Trv& a, const Mtt& b) {
  return Mtt(a[0] * b[0] + a[1] * b[7] + a[2] * b[8] + a[3] * b[9],
             a[0] * b[1] + a[1] * b[8] - a[2] * b[7] + a[3] * b[15],
             a[0] * b[2] + a[1] * b[9] - a[2] * b[15] - a[3] * b[7],
             a[0] * b[3] + a[1] * b[15] + a[2] * b[9] - a[3] * b[8],
             a[0] * b[4] + a[1] * b[0] + a[1] * b[10] - a[2] * b[1] -
                 a[2] * b[11] - a[3] * b[2] - a[3] * b[12],
             a[0] * b[5] + a[1] * b[1] + a[1] * b[11] + a[2] * b[0] +
                 a[2] * b[10] - a[3] * b[3] - a[3] * b[13],
             a[0] * b[6] + a[1] * b[2] + a[1] * b[12] + a[2] * b[3] +
                 a[2] * b[13] + a[3] * b[0] + a[3] * b[10],
             ...
             a[0] * b[14] + a[1] * b[3] + a[1] * b[13] - a[2] * b[2] -
                 a[2] * b[12] + a[3] * b[1] + a[3] * b[11],
             a[0] * b[15]);
}
...
inline Rvd gp(const Trv& a, const Rtd& b) {
  return Rvd(a[0] * b[0], a[0] * b[1], a[0] * b[2], a[0] * b[3],
             ...
             a[1] * b[2] + a[1] * b[6] + a[2] * b[3] + a[2] * b[7] +
                 a[3] * b[0] + a[3] * b[4],
             a[0] * b[4], a[0] * b[5], a[0] * b[6], a[0] * b[7],
             a[1] * b[3] + a[1] * b[7] - a[2] * b[2] - a[2] * b[6] +
                 a[3] * b[1] + a[3] * b[5]);
}

inline Tvd gp(const Trv& a, const Tvd& b) {
  return Tvd(a[0] * b[0], a[0] * b[1] + a[1] * b[0] + a[1] * b[4],
             a[0] * b[2] + a[2] * b[0] + a[2] * b[4],
             a[0] * b[3] + a[3] * b[0] + a[3] * b[4], a[0] * b[4]);
}
...
inline Trt gp(const Trv& a, const Tsd& b) {
  return Trt(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] + a[3] * b[3],
             ...
             a[2] * b[0] + a[2] * b[4], a[3] * b[0] + a[3] * b[4], a[0] * b[1],
             a[0] * b[2], a[0] * b[3],
...
inline Tst gp(const Trv& a, const Trt& b) {
  return Tst(a[0] * b[0] + a[1] * b[7] + a[2] * b[8] + a[3] * b[9],
             ...
             a[1] * b[3] + a[1] * b[13] - a[2] * b[2] - a[2] * b[12] +
                 a[3] * b[1] + a[3] * b[11]);
}
...
inline Rvd gp(const Trv& a, const Rvd& b) {
  return Rvd(a[0] * b[0], a[0] * b[1], a[0] * b[2], a[0] * b[3],
             a[0] * b[4] + a[1] * b[0] + a[1] * b[7] - a[2] * b[1] -
                 a[2] * b[8] - a[3] * b[2] - a[3] * b[9],
             a[0] * b[5] + a[1] * b[1] + a[1] * b[8] + a[2] * b[0] +
                 a[2] * b[7] - a[3] * b[3] - a[3] * b[10],
             a[0] * b[6] + a[1] * b[2] + a[1] * b[9] + a[2] * b[3] +
                 a[2] * b[10] + a[3] * b[0] + a[3] * b[7],
             a[0] * b[7], a[0] * b[8], a[0] * b[9], a[0] * b[10],
             a[0] * b[11] + a[1] * b[3] + a[1] * b[10] - a[2] * b[2] -
                 a[2] * b[9] + a[3] * b[1] + a[3] * b[8]);
}
...
inline Tst gp(const Trv& a, const Bst& b) {
  return Tst(
      ...
      a[0] * b[7], a[0] * b[8], a[0] * b[9],
      a[0] * b[10] - a[1] * b[7] - a[2] * b[8] - a[3] * b[9],
      -a[1] * b[8] + a[2] * b[7], -a[1] * b[9] + a[3] * b[7],
      -a[2] * b[9] + a[3] * b[8], a[1] * b[3] - a[2] * b[2] + a[3] * b[1]);
}
...
inline Trv sp(const Trv& trv, const Rot& rot) {
  ...
  const Rot& t4 = rot;
  Rot t5 = reverse(t4);
  return Trv(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3],
...
inline Trv sp(const Trv& trv, const Mot& mot) {
  ...
  Mtt t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3],
         ...
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2], t1[4] * t2[0],
         t1[5] * t2[0], t1[6] * t2[0],
...
inline Trv sp(const Trv& trv, const Dil& dil) {
  const Dil& t1 = dil;
  const Trv& t2 = trv;
  Tvd t3(t1[0] * t2[0], t1[0] * t2[1] - t1[1] * t2[1],
         t1[0] * t2[2] - t1[1] * t2[2], t1[0] * t2[3] - t1[1] * t2[3],
         t1[1] * t2[0]);
  const Dil& t4 = dil;
  Dil t5 = reverse(t4);
  return Trv(t3[0] * t5[0] + t3[4] * t5[1], t3[1] * t5[0] + t3[1] * t5[1],
...
inline Trv sp(const Trv& trv, const Trs& trs) {
  ...
  Trt t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] + t1[3] * t2[3],
         ...
         t1[0] * t2[3], t1[1] * t2[0], t1[2] * t2[0], t1[3] * t2[0],
         t1[1] * t2[1] + t1[2] * t2[2] + t1[3] * t2[3],
         t1[1] * t2[2] - t1[2] * t2[1], t1[1] * t2[3] - t1[3] * t2[1],
         t1[2] * t2[3] - t1[3] * t2[2]);
  const Trs& t4 = trs;
  Trs t5 = reverse(t4);
  return Trv(t3[0] * t5[0] + t3[4] * t5[1] + t3[5] * t5[2] + t3[6] * t5[3],
...
inline Trv sp(const Trv& trv, const Rtc& rtc) {
  ...
  Rtc t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3],
         ...
         t1[4] * t2[0],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[5] * t2[0] - t1[11] * t2[2] +
             t1[12] * t2[1] + t1[14] * t2[3] - t1[15] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] + t1[6] * t2[0] - t1[11] * t2[3] +
             t1[13] * t2[1] - t1[14] * t2[2] + t1[15] * t2[2],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[7] * t2[0] - t1[12] * t2[3] +
...
inline Trv sp(const Trv& trv, const Mtt& mtt) {
  ...
  Mtt t3(t1[0] * t2[0] + t1[7] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3],
         ...
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[4] * t2[0] -
             t1[10] * t2[1] - t1[11] * t2[2] - t1[12] * t2[3],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3] + t1[5] * t2[0] -
             t1[10] * t2[2] + t1[11] * t2[1] - t1[13] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[6] * t2[0] -
             t1[10] * t2[3] + t1[12] * t2[1] + t1[13] * t2[2],
         ...
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1] - t1[11] * t2[3] +
             t1[12] * t2[2] - t1[13] * t2[1] + t1[14] * t2[0],
         t1[15] * t2[0]);
  const Mtt& t4 = mtt;
  Mtt t5 = reverse(t4);
  return Trv(
...
inline Trv sp(const Trv& trv, const Tvd& tvd) {
  const Tvd& t1 = tvd;
  const Trv& t2 = trv;
  Tvd t3(t1[0] * t2[0], t1[0] * t2[1] + t1[1] * t2[0] - t1[4] * t2[1],
         t1[0] * t2[2] + t1[2] * t2[0] - t1[4] * t2[2],
         t1[0] * t2[3] + t1[3] * t2[0] - t1[4] * t2[3], t1[4] * t2[0]);
  const Tvd& t4 = tvd;
  Tvd t5 = reverse(t4);
  return Trv(t3[0] * t5[0] + t3[4] * t5[4],
...
inline Trv sp(const Trv& trv, const Rvd& rvd) {
  ...
  Rvd t3(t1[0] * t2[0], t1[1] * t2[0], t1[2] * t2[0], t1[3] * t2[0],
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[4] * t2[0] -
             t1[7] * t2[1] - t1[8] * t2[2] - t1[9] * t2[3],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3] + t1[5] * t2[0] -
             t1[7] * t2[2] + t1[8] * t2[1] - t1[10] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[6] * t2[0] -
             t1[7] * t2[3] + t1[9] * t2[1] + t1[10] * t2[2],
         t1[7] * t2[0], t1[8] * t2[0], t1[9] * t2[0], t1[10] * t2[0],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1] - t1[8] * t2[3] +
             t1[9] * t2[2] - t1[10] * t2[1] + t1[11] * t2[0]);
  const Rvd& t4 = rvd;
  Rvd t5 = reverse(t4);
  return Trv(
      t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3] +
...
inline Trv sp(const Trv& trv, const Bst& bst) {
  ...
  Tst t3(t1[0] * t2[0] + t1[7] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3],
         ...
         t1[7] * t2[0], t1[8] * t2[0], t1[9] * t2[0],
         t1[7] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3] + t1[10] * t2[0],
         t1[7] * t2[2] - t1[8] * t2[1], t1[7] * t2[3] - t1[9] * t2[1],
         t1[8] * t2[3] - t1[9] * t2[2],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1]);
  const Bst& t4 = bst;
  Bst t5 = reverse(t4);
...
inline Trv re(const Trv& trv, const Vec& vec) {
  ...
  const Trv& t2 = trv;
  Trv t3 = involute(t2);
  Biv_Afp t4(t1[0] * t3[0], t1[1] * t3[0], t1[2] * t3[0],
             t1[0] * t3[1] + t1[1] * t3[2] + t1[2] * t3[3],
             t1[0] * t3[2] - t1[1] * t3[1], t1[0] * t3[3] - t1[2] * t3[1],
             t1[1] * t3[3] - t1[2] * t3[2]);
  const Vec& t5 = vec;
  Vec t6 = reverse(t5);
  return Trv(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2],
...
inline Trv re(const Trv& trv, const Dlp& dlp) {
  ...
  Pnt_Dap t4(t1[0] * t3[0] + t1[3] * t3[1], t1[1] * t3[0] + t1[3] * t3[2],
             ...
             t1[0] * t3[2] - t1[1] * t3[1], t1[0] * t3[3] - t1[2] * t3[1],
             t1[1] * t3[3] - t1[2] * t3[2], t1[3] * t3[1], t1[3] * t3[2],
             t1[3] * t3[3]);
  const Dlp& t5 = dlp;
  Dlp t6 = reverse(t5);
  return Trv(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[3] * t6[3],
...
inline Trv re(const Trv& trv, const Pln& pln) {
  ...
  const Trv& t2 = trv;
  Trv t3 = involute(t2);
  Pnt_Afp t4(t1[3] * t3[3], -t1[3] * t3[2], t1[3] * t3[1],
             -t1[0] * t3[2] - t1[1] * t3[3], t1[0] * t3[1] - t1[2] * t3[3],
             t1[1] * t3[1] + t1[2] * t3[2], t1[0] * t3[0] + t1[3] * t3[3],
             t1[1] * t3[0] - t1[3] * t3[2], t1[2] * t3[0] + t1[3] * t3[1],
             -t1[0] * t3[3] + t1[1] * t3[2] - t1[2] * t3[1], t1[3] * t3[0]);
  const Pln& t5 = pln;
  Pln t6 = reverse(t5);
  return Trv(-t4[6] * t6[0] - t4[7] * t6[1] - t4[8] * t6[2] - t4[9] * t6[3],
...
inline Trv re(const Trv& trv, const Dll& dll) {
  ...
  Tst t4(t1[3] * t3[1] + t1[4] * t3[2] + t1[5] * t3[3],
         ...
         t1[0] * t3[2] + t1[1] * t3[3], -t1[0] * t3[1] + t1[2] * t3[3],
         -t1[1] * t3[1] - t1[2] * t3[2], t1[3] * t3[0], t1[4] * t3[0],
         t1[5] * t3[0], t1[3] * t3[1] + t1[4] * t3[2] + t1[5] * t3[3],
         t1[3] * t3[2] - t1[4] * t3[1], t1[3] * t3[3] - t1[5] * t3[1],
         t1[4] * t3[3] - t1[5] * t3[2],
         t1[0] * t3[3] - t1[1] * t3[2] + t1[2] * t3[1]);
  const Dll& t5 = dll;
  Dll t6 = reverse(t5);
  return Trv(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2] + t4[4] * t6[3] +
                 t4[5] * t6[4] + t4[6] * t6[5],
...
inline Trv re(const Trv& trv, const Lin& lin) {
  ...
  const Trv& t2 = trv;
  Trv t3 = involute(t2);
  Par_Afp t4(t1[0] * t3[2] + t1[1] * t3[3], -t1[0] * t3[1] + t1[2] * t3[3],
             -t1[1] * t3[1] - t1[2] * t3[2],
             -t1[3] * t3[1] - t1[4] * t3[2] - t1[5] * t3[3],
             -t1[3] * t3[2] + t1[4] * t3[1], -t1[3] * t3[3] + t1[5] * t3[1],
             -t1[4] * t3[3] + t1[5] * t3[2], t1[0] * t3[0], t1[1] * t3[0],
             t1[2] * t3[0], t1[0] * t3[2] + t1[1] * t3[3] + t1[3] * t3[0],
  ...
  const Lin& t5 = lin;
  Lin t6 = reverse(t5);
  return Trv(t4[4] * t6[0] + t4[5] * t6[1] + t4[6] * t6[2] + t4[10] * t6[3] +
...
inline Trv re(const Trv& trv, const Pnt& pnt) {
  ...
  Pnt_Dap t4(t1[0] * t3[0] + t1[4] * t3[1], t1[1] * t3[0] + t1[4] * t3[2],
             t1[2] * t3[0] + t1[4] * t3[3],
             t1[0] * t3[1] + t1[1] * t3[2] + t1[2] * t3[3] + t1[3] * t3[0],
             t1[4] * t3[0], t1[0] * t3[2] - t1[1] * t3[1],
             t1[0] * t3[3] - t1[2] * t3[1], t1[1] * t3[3] - t1[2] * t3[2],
             t1[4] * t3[1], t1[4] * t3[2], t1[4] * t3[3]);
  const Pnt& t5 = pnt;
  Pnt t6 = reverse(t5);
  return Trv(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[3] * t6[4] -
                 t4[4] * t6[3],
...
inline Trv re(const Trv& trv, const Par& par) {
  ...
  const Trv& t2 = trv;
  Trv t3 = involute(t2);
  Tst t4(t1[6] * t3[1] + t1[7] * t3[2] + t1[8] * t3[3],
         ...
         t1[6] * t3[0], t1[7] * t3[0], t1[8] * t3[0],
         t1[6] * t3[1] + t1[7] * t3[2] + t1[8] * t3[3] + t1[9] * t3[0],
         t1[6] * t3[2] - t1[7] * t3[1], t1[6] * t3[3] - t1[8] * t3[1],
         t1[7] * t3[3] - t1[8] * t3[2],
         t1[0] * t3[3] - t1[1] * t3[2] + t1[2] * t3[1]);
  const Par& t5 = par;
  Par t6 = reverse(t5);
  return Trv(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2] + t4[4] * t6[6] +
...
inline Trv re(const Trv& trv, const Cir& cir) {
  ...
  const Trv& t2 = trv;
  Trv t3 = involute(t2);
  Par_Afp t4(t1[3] * t3[2] + t1[4] * t3[3], -t1[3] * t3[1] + t1[5] * t3[3],
             -t1[4] * t3[1] - t1[5] * t3[2],
  ...
  const Cir& t5 = cir;
  Cir t6 = reverse(t5);
  return Trv(t4[4] * t6[3] + t4[5] * t6[4] + t4[6] * t6[5] + t4[7] * t6[0] +
...
inline Trv re(const Trv& trv, const Sph& sph) {
  ...
  const Trv& t2 = trv;
  Trv t3 = involute(t2);
  Pnt_Afp t4(t1[4] * t3[3], -t1[4] * t3[2], t1[4] * t3[1],
             -t1[0] * t3[2] - t1[1] * t3[3], t1[0] * t3[1] - t1[2] * t3[3],
             t1[1] * t3[1] + t1[2] * t3[2], t1[0] * t3[0] + t1[4] * t3[3],
             t1[1] * t3[0] - t1[4] * t3[2], t1[2] * t3[0] + t1[4] * t3[1],
             -t1[0] * t3[3] + t1[1] * t3[2] - t1[2] * t3[1] + t1[3] * t3[0],
             t1[4] * t3[0]);
  const Sph& t5 = sph;
  Sph t6 = reverse(t5);
  return Trv(-t4[6] * t6[0] - t4[7] * t6[1] - t4[8] * t6[2] - t4[9] * t6[4] -
                 t4[10] * t6[3],

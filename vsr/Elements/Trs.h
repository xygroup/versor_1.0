...
inline Trs gp(const Trs& a, const Sca& b) {
  return Trs(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0]);
}

inline Ori_Flp gp(const Trs& a, const Ori& b) {
  return Ori_Flp(-a[1] * b[0], -a[2] * b[0], -a[3] * b[0], a[0] * b[0],
                 -a[1] * b[0], -a[2] * b[0], -a[3] * b[0]);
}

inline Inf gp(const Trs& a, const Inf& b) { return Inf(a[0] * b[0]); }

inline Flp gp(const Trs& a, const Mnk& b) {
  return Flp(-a[1] * b[0], -a[2] * b[0], -a[3] * b[0], a[0] * b[0]);
}

inline Hyp_Flp gp(const Trs& a, const Hyp& b) {
  return Hyp_Flp(-a[1] * b[0], -a[2] * b[0], -a[3] * b[0], a[0] * b[0],
                 a[0] * b[1], -a[1] * b[0], -a[2] * b[0], -a[3] * b[0]);
}

inline Mnk_Dfp gp(const Trs& a, const Pss& b) {
  return Mnk_Dfp(a[3] * b[0], -a[2] * b[0], a[1] * b[0], a[0] * b[0]);
}
...
inline Pnt_Flp gp(const Trs& a, const Pnt& b) {
  return Pnt_Flp(a[0] * b[0] - a[1] * b[3], a[0] * b[1] - a[2] * b[3],
                 ...
                 -a[2] * b[2] + a[3] * b[1], -a[1] * b[3], -a[2] * b[3],
                 -a[3] * b[3]);
}
...
inline Tvt gp(const Trs& a, const Par& b) {
  return Tvt(a[1] * b[3] + a[2] * b[4] + a[3] * b[5],
             ...
             a[0] * b[2] + a[2] * b[5] - a[3] * b[4], a[0] * b[3], a[0] * b[4],
             a[0] * b[5], a[0] * b[6] - a[1] * b[9] - a[2] * b[0] - a[3] * b[1],
...
inline Par_Dfp gp(const Trs& a, const Cir& b) {
  return Par_Dfp(a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2],
                 a[1] * b[6] + a[2] * b[7] + a[3] * b[8], a[0] * b[0],
                 a[0] * b[1], a[0] * b[2],
...
inline Pnt_Dfp gp(const Trs& a, const Sph& b) {
  return Pnt_Dfp(a[3] * b[3], -a[2] * b[3], a[1] * b[3],
...
inline Tvt gp(const Trs& a, const Sta& b) {
  return Tvt(a[1] * b[3] + a[2] * b[4] + a[3] * b[5],
             ...
             a[0] * b[1] + a[1] * b[5] - a[3] * b[3],
             a[0] * b[2] + a[2] * b[5] - a[3] * b[4], a[0] * b[3], a[0] * b[4],
             a[0] * b[5], a[0] * b[6] - a[2] * b[0] - a[3] * b[1],
             a[0] * b[7] + a[1] * b[0] - a[3] * b[2],
             a[0] * b[8] + a[1] * b[1] + a[2] * b[2],
             a[1] * b[3] + a[2] * b[4] + a[3] * b[5], a[1] * b[4] - a[2] * b[3],
...
inline Drt gp(const Trs& a, const Drt& b) { return Drt(a[0] * b[0]); }
...
inline Pln_Dfp gp(const Trs& a, const Lin& b) {
  return Pln_Dfp(a[1] * b[3] + a[2] * b[4] + a[3] * b[5],
                 a[0] * b[0] + a[1] * b[4] - a[2] * b[3],
                 a[0] * b[1] + a[1] * b[5] - a[3] * b[3],
...
inline Lin_Dfp gp(const Trs& a, const Pln& b) {
  return Lin_Dfp(a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2], a[0] * b[0], a[0] * b[1],
                 a[0] * b[2],
...
inline Flp gp(const Trs& a, const Flp& b) {
  return Flp(a[0] * b[0] - a[1] * b[3], a[0] * b[1] - a[2] * b[3],
             a[0] * b[2] - a[3] * b[3], a[0] * b[3]);
}

inline Dfp gp(const Trs& a, const Dfp& b) {
  return Dfp(a[0] * b[0] - a[3] * b[3], a[0] * b[1] + a[2] * b[3],
             a[0] * b[2] - a[1] * b[3], a[0] * b[3]);
}

inline Pln_Flp gp(const Trs& a, const Dll& b) {
  return Pln_Flp(a[0] * b[0], a[0] * b[1], a[0] * b[2],
...
inline Lin_Flp gp(const Trs& a, const Dlp& b) {
  return Lin_Flp(a[0] * b[0], a[0] * b[1], a[0] * b[2],
...
inline Dfp gp(const Trs& a, const Tri& b) {
  return Dfp(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[0] * b[0]);
}
...
inline Tvt gp(const Trs& a, const Afl& b) {
  return Tvt(a[1] * b[3] + a[2] * b[4] + a[3] * b[5],
             ...
             a[0] * b[1] + a[1] * b[5] - a[3] * b[3],
             a[0] * b[2] + a[2] * b[5] - a[3] * b[4], a[0] * b[3], a[0] * b[4],
             a[0] * b[5], -a[2] * b[0] - a[3] * b[1], a[1] * b[0] - a[3] * b[2],
...
inline Flp_Afp gp(const Trs& a, const Afp& b) {
  return Flp_Afp(a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2], a[0] * b[0], a[0] * b[1],
                 a[0] * b[2], -a[3] * b[3], a[2] * b[3], -a[1] * b[3],
                 a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2],
                 a[0] * b[3] - a[1] * b[2] + a[2] * b[1] - a[3] * b[0],
                 -a[1] * b[2] + a[2] * b[1] - a[3] * b[0]);
...
inline Trt gp(const Trs& a, const Dap& b) {
  return Trt(a[1] * b[0] + a[2] * b[1] + a[3] * b[2], a[1] * b[1] - a[2] * b[0],
             a[1] * b[2] - a[3] * b[0], a[2] * b[2] - a[3] * b[1], a[0] * b[0],
             a[0] * b[1], a[0] * b[2], -a[1] * b[3], -a[2] * b[3], -a[3] * b[3],
             a[0] * b[3] + a[1] * b[0] + a[2] * b[1] + a[3] * b[2],
             a[1] * b[1] - a[2] * b[0], a[1] * b[2] - a[3] * b[0],
             a[2] * b[2] - a[3] * b[1]);
}
...
inline Par_Dfp gp(const Trs& a, const Dal& b) {
  return Par_Dfp(a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2],
                 a[1] * b[3] + a[2] * b[4] + a[3] * b[5], a[0] * b[0],
                 a[0] * b[1], a[0] * b[2], a[1] * b[4] - a[2] * b[3],
                 a[1] * b[5] - a[3] * b[3], a[2] * b[5] - a[3] * b[4],
                 a[0] * b[3] + a[2] * b[0] + a[3] * b[1],
                 a[0] * b[4] - a[1] * b[0] + a[3] * b[2],
                 a[0] * b[5] - a[1] * b[1] - a[2] * b[2],
...
inline Pln_Dfp gp(const Trs& a, const Mnv& b) {
  return Pln_Dfp(a[1] * b[0] + a[2] * b[1] + a[3] * b[2],
                 a[1] * b[1] - a[2] * b[0], a[1] * b[2] - a[3] * b[0],
                 a[2] * b[2] - a[3] * b[1], a[0] * b[0], a[0] * b[1],
                 a[0] * b[2]);
}
...
inline Mot gp(const Trs& a, const Rot& b) {
  return Mot(a[0] * b[0], a[0] * b[1], a[0] * b[2], a[0] * b[3],
             a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
...
inline Tsd gp(const Trs& a, const Dil& b) {
  return Tsd(a[0] * b[0], a[1] * b[0] - a[1] * b[1], a[2] * b[0] - a[2] * b[1],
...
inline Trt gp(const Trs& a, const Trv& b) {
  return Trt(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] + a[3] * b[3],
             ...
             a[2] * b[3] - a[3] * b[2], a[0] * b[1], a[0] * b[2], a[0] * b[3],
             a[1] * b[0], a[2] * b[0], a[3] * b[0],
             a[1] * b[1] + a[2] * b[2] + a[3] * b[3], a[1] * b[2] - a[2] * b[1],
...
inline Trs gp(const Trs& a, const Trs& b) {
  return Trs(a[0] * b[0], a[0] * b[1] + a[1] * b[0], a[0] * b[2] + a[2] * b[0],
             a[0] * b[3] + a[3] * b[0]);
}

inline Rtc gp(const Trs& a, const Rtc& b) {
  return Rtc(a[0] * b[0] - a[1] * b[3] + a[2] * b[5] + a[3] * b[6],
             a[0] * b[1] - a[1] * b[5] - a[2] * b[3] + a[3] * b[7],
             a[0] * b[2] - a[1] * b[6] - a[2] * b[7] - a[3] * b[3], a[0] * b[3],
             a[0] * b[4] - a[1] * b[0] + a[1] * b[11] - a[2] * b[1] +
                 a[2] * b[12] - a[3] * b[2] + a[3] * b[13],
             a[0] * b[5], a[0] * b[6], a[0] * b[7],
             a[0] * b[8] - a[1] * b[1] + a[1] * b[12] + a[2] * b[0] -
                 a[2] * b[11] - a[3] * b[14] + a[3] * b[15],
             a[0] * b[9] - a[1] * b[2] + a[1] * b[13] + a[2] * b[14] -
                 a[2] * b[15] + a[3] * b[0] - a[3] * b[11],
             a[0] * b[10] - a[1] * b[14] + a[1] * b[15] - a[2] * b[2] +
...
inline Mtt gp(const Trs& a, const Mtt& b) {
  return Mtt(a[0] * b[0] + a[1] * b[4] + a[2] * b[5] + a[3] * b[6],
             ...
             a[0] * b[7] + a[1] * b[0] - a[1] * b[10] - a[2] * b[1] +
                 a[2] * b[11] - a[3] * b[2] + a[3] * b[12],
             a[0] * b[8] + a[1] * b[1] - a[1] * b[11] + a[2] * b[0] -
                 a[2] * b[10] - a[3] * b[3] + a[3] * b[13],
             a[0] * b[9] + a[1] * b[2] - a[1] * b[12] + a[2] * b[3] -
             ...
             a[0] * b[14],
             a[0] * b[15] + a[1] * b[3] - a[1] * b[13] - a[2] * b[2] +
...
inline Mtt gp(const Trs& a, const Rtt& b) {
  return Mtt(a[0] * b[0] + a[1] * b[4] + a[2] * b[5] + a[3] * b[6],
             ...
             a[0] * b[3] + a[1] * b[7] + a[2] * b[6] - a[3] * b[5], a[0] * b[4],
             a[0] * b[5], a[0] * b[6], a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
             a[1] * b[1] + a[2] * b[0] - a[3] * b[3],
             a[1] * b[2] + a[2] * b[3] + a[3] * b[0],
             a[1] * b[4] + a[2] * b[5] + a[3] * b[6],
             a[1] * b[5] - a[2] * b[4] + a[3] * b[7],
             a[1] * b[6] - a[2] * b[7] - a[3] * b[4],
             a[1] * b[7] + a[2] * b[6] - a[3] * b[5], a[0] * b[7],
             a[1] * b[3] - a[2] * b[2] + a[3] * b[1]);
}
...
inline Tvt gp(const Trs& a, const Bst& b) {
  return Tvt(
      ...
      a[0] * b[10] + a[1] * b[4] + a[2] * b[5] + a[3] * b[6],
      a[1] * b[5] - a[2] * b[4], a[1] * b[6] - a[3] * b[4],
      a[2] * b[6] - a[3] * b[5], a[1] * b[3] - a[2] * b[2] + a[3] * b[1]);
}
...
inline Trs sp(const Trs& trs, const Rot& rot) {
  ...
  const Rot& t4 = rot;
  Rot t5 = reverse(t4);
  return Trs(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3],
...
inline Trs sp(const Trs& trs, const Dil& dil) {
  const Dil& t1 = dil;
  const Trs& t2 = trs;
  Tsd t3(t1[0] * t2[0], t1[0] * t2[1] + t1[1] * t2[1],
         t1[0] * t2[2] + t1[1] * t2[2], t1[0] * t2[3] + t1[1] * t2[3],
         t1[1] * t2[0]);
  const Dil& t4 = dil;
  Dil t5 = reverse(t4);
  return Trs(t3[0] * t5[0] + t3[4] * t5[1], t3[1] * t5[0] - t3[1] * t5[1],
...
inline Trs sp(const Trs& trs, const Trv& trv) {
  ...
  Trt t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] + t1[3] * t2[3],
         ...
         t1[2] * t2[3] - t1[3] * t2[2], t1[1] * t2[0], t1[2] * t2[0],
         t1[3] * t2[0], t1[0] * t2[1], t1[0] * t2[2], t1[0] * t2[3],
         -t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3],
         -t1[1] * t2[2] + t1[2] * t2[1], -t1[1] * t2[3] + t1[3] * t2[1],
         -t1[2] * t2[3] + t1[3] * t2[2]);
  const Trv& t4 = trv;
  Trv t5 = reverse(t4);
  return Trs(t3[0] * t5[0] + t3[7] * t5[1] + t3[8] * t5[2] + t3[9] * t5[3],
...
inline Trs sp(const Trs& trs, const Rtc& rtc) {
  ...
  Rtc t3(t1[0] * t2[0] + t1[3] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3],
         ...
         t1[5] * t2[0], t1[6] * t2[0], t1[7] * t2[0],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[8] * t2[0] + t1[11] * t2[2] -
             t1[12] * t2[1] + t1[14] * t2[3] + t1[15] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] + t1[9] * t2[0] + t1[11] * t2[3] -
             t1[13] * t2[1] - t1[14] * t2[2] - t1[15] * t2[2],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[10] * t2[0] + t1[12] * t2[3] -
...
inline Trs sp(const Trs& trs, const Rtt& rtt) {
  ...
  Mtt t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3],
         ...
         -t1[5] * t2[3] + t1[6] * t2[2] - t1[7] * t2[1], t1[7] * t2[0],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1]);
  const Rtt& t4 = rtt;
  Rtt t5 = reverse(t4);
  return Trs(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3] +
...
inline Trs sp(const Trs& trs, const Tsd& tsd) {
  const Tsd& t1 = tsd;
  const Trs& t2 = trs;
  Tsd t3(t1[0] * t2[0], t1[0] * t2[1] + t1[1] * t2[0] + t1[4] * t2[1],
         t1[0] * t2[2] + t1[2] * t2[0] + t1[4] * t2[2],
         t1[0] * t2[3] + t1[3] * t2[0] + t1[4] * t2[3], t1[4] * t2[0]);
  const Tsd& t4 = tsd;
  Tsd t5 = reverse(t4);
  return Trs(t3[0] * t5[0] + t3[4] * t5[4],
...
inline Trs sp(const Trs& trs, const Trt& trt) {
  ...
  Tvt t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3],
         ...
         t1[3] * t2[0] + t1[5] * t2[3] - t1[6] * t2[2], t1[4] * t2[0],
         t1[5] * t2[0], t1[6] * t2[0],
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[7] * t2[0] +
             t1[10] * t2[1] + t1[11] * t2[2] + t1[12] * t2[3],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3] + t1[8] * t2[0] +
...
inline Trs sp(const Trs& trs, const Bst& bst) {
  ...
  Tvt t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[5] * t2[2] + t1[6] * t2[3],
         ...
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[9] * t2[0] +
             t1[10] * t2[3],
         -t1[4] * t2[1] - t1[5] * t2[2] - t1[6] * t2[3] + t1[10] * t2[0],
         -t1[4] * t2[2] + t1[5] * t2[1], -t1[4] * t2[3] + t1[6] * t2[1],
         -t1[5] * t2[3] + t1[6] * t2[2],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1]);
  const Bst& t4 = bst;
  Bst t5 = reverse(t4);
...
inline Trs re(const Trs& trs, const Vec& vec) {
  ...
  const Trs& t2 = trs;
  Trs t3 = involute(t2);
  Lin_Flp t4(t1[0] * t3[0], t1[1] * t3[0], t1[2] * t3[0],
             t1[0] * t3[1] + t1[1] * t3[2] + t1[2] * t3[3],
             t1[0] * t3[2] - t1[1] * t3[1], t1[0] * t3[3] - t1[2] * t3[1],
             t1[1] * t3[3] - t1[2] * t3[2]);
  const Vec& t5 = vec;
  Vec t6 = reverse(t5);
  return Trs(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2],
...
inline Trs re(const Trs& trs, const Pln& pln) {
  ...
  const Trs& t2 = trs;
  Trs t3 = involute(t2);
  Lin_Dfp t4(t1[0] * t3[2] + t1[1] * t3[3], -t1[0] * t3[1] + t1[2] * t3[3],
             -t1[1] * t3[1] - t1[2] * t3[2], t1[0] * t3[0], t1[1] * t3[0],
             t1[2] * t3[0],
             t1[0] * t3[3] - t1[1] * t3[2] + t1[2] * t3[1] + t1[3] * t3[0]);
  const Pln& t5 = pln;
  Pln t6 = reverse(t5);
  return Trs(-t4[3] * t6[0] - t4[4] * t6[1] - t4[5] * t6[2],
...
inline Trs re(const Trs& trs, const Dll& dll) {
  ...
  const Trs& t2 = trs;
  Trs t3 = involute(t2);
  Pln_Flp t4(t1[0] * t3[0], t1[1] * t3[0], t1[2] * t3[0],
...
inline Trs re(const Trs& trs, const Lin& lin) {
  ...
  const Trs& t2 = trs;
  Trs t3 = involute(t2);
  Pln_Dfp t4(t1[3] * t3[1] + t1[4] * t3[2] + t1[5] * t3[3],
             t1[0] * t3[0] + t1[3] * t3[2] - t1[4] * t3[1],
             t1[1] * t3[0] + t1[3] * t3[3] - t1[5] * t3[1],
             t1[2] * t3[0] + t1[4] * t3[3] - t1[5] * t3[2], t1[3] * t3[0],
             t1[4] * t3[0], t1[5] * t3[0]);
  const Lin& t5 = lin;
  Lin t6 = reverse(t5);
  return Trs(t4[4] * t6[3] + t4[5] * t6[4] + t4[6] * t6[5],
...
inline Trs re(const Trs& trs, const Pnt& pnt) {
  ...
  const Pnt& t5 = pnt;
  Pnt t6 = reverse(t5);
  return Trs(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[3] * t6[4] -
                 t4[4] * t6[3],
...
inline Trs re(const Trs& trs, const Par& par) {
  ...
  const Trs& t2 = trs;
  Trs t3 = involute(t2);
  Tvt t4(t1[3] * t3[1] + t1[4] * t3[2] + t1[5] * t3[3],
         t1[0] * t3[0] + t1[3] * t3[2] - t1[4] * t3[1],
         t1[1] * t3[0] + t1[3] * t3[3] - t1[5] * t3[1],
         t1[2] * t3[0] + t1[4] * t3[3] - t1[5] * t3[2], t1[3] * t3[0],
         t1[4] * t3[0], t1[5] * t3[0],
  ...
  const Par& t5 = par;
  Par t6 = reverse(t5);
  return Trs(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2] + t4[4] * t6[6] +
...
inline Trs re(const Trs& trs, const Cir& cir) {
  ...
  const Trs& t2 = trs;
  Trs t3 = involute(t2);
  Par_Dfp t4(t1[0] * t3[2] + t1[1] * t3[3], -t1[0] * t3[1] + t1[2] * t3[3],
             -t1[1] * t3[1] - t1[2] * t3[2],
             t1[6] * t3[1] + t1[7] * t3[2] + t1[8] * t3[3], t1[0] * t3[0],
             t1[1] * t3[0], t1[2] * t3[0],
  ...
  const Cir& t5 = cir;
  Cir t6 = reverse(t5);
  return Trs(t4[4] * t6[3] + t4[5] * t6[4] + t4[6] * t6[5] + t4[7] * t6[0] +
...
inline Trs re(const Trs& trs, const Sph& sph) {
  ...
  const Trs& t2 = trs;
  Trs t3 = involute(t2);
  Pnt_Dfp t4(t1[3] * t3[3], -t1[3] * t3[2], t1[3] * t3[1],
  ...
  const Sph& t5 = sph;
  Sph t6 = reverse(t5);
  return Trs(-t4[6] * t6[0] - t4[7] * t6[1] - t4[8] * t6[2] - t4[9] * t6[4] -
                 t4[10] * t6[3],

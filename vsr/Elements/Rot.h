...
inline Rot gp(const Rot& a, const Sca& b) {
  return Rot(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0]);
}
...
inline Mtt gp(const Rot& a, const Par& b) {
  return Mtt(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
             ...
             a[0] * b[8] - a[2] * b[6] - a[3] * b[7], a[0] * b[9], a[1] * b[9],
             a[2] * b[9], a[3] * b[9], a[1] * b[5] - a[2] * b[4] + a[3] * b[3],
             a[1] * b[8] - a[2] * b[7] + a[3] * b[6]);
}

inline Rtc gp(const Rot& a, const Cir& b) {
  return Rtc(-a[3] * b[9], a[2] * b[9], -a[1] * b[9],
             ...
             a[0] * b[6] + a[1] * b[7] + a[2] * b[8],
             a[0] * b[7] - a[1] * b[6] + a[3] * b[8],
             a[0] * b[8] - a[2] * b[6] - a[3] * b[7], a[0] * b[9],
             a[1] * b[8] - a[2] * b[7] + a[3] * b[6]);
}

inline Mnk_Sta_Biv gp(const Rot& a, const Sph& b) {
  return Mnk_Sta_Biv(
      -a[3] * b[3], a[2] * b[3], -a[1] * b[3], -a[3] * b[4], a[2] * b[4],
      -a[1] * b[4], -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
      a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
      a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
      a[0] * b[2] - a[1] * b[1] + a[2] * b[0], a[0] * b[3], a[0] * b[4]);
}

inline Sta_Biv gp(const Rot& a, const Sta& b) {
  return Sta_Biv(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0],
                 a[0] * b[3] + a[1] * b[4] + a[2] * b[5],
...
inline Lin_Dll gp(const Rot& a, const Lin& b) {
  return Lin_Dll(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0],
                 a[0] * b[3] + a[1] * b[4] + a[2] * b[5],
...
inline Lin_Dlp gp(const Rot& a, const Pln& b) {
  return Lin_Dlp(-a[3] * b[3], a[2] * b[3], -a[1] * b[3],
                 -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0], a[0] * b[3]);
}
...
inline Rot gp(const Rot& a, const Biv& b) {
  return Rot(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
             a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
             a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
             a[0] * b[2] - a[1] * b[1] + a[2] * b[0]);
}
...
inline Vec_Biv gp(const Rot& a, const Tri& b) {
  return Vec_Biv(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[0] * b[0]);
}
...
inline Vec_Dal gp(const Rot& a, const Daf& b) {
  return Vec_Dal(-a[3] * b[3], a[2] * b[3], -a[1] * b[3],
                 -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0], a[0] * b[3]);
...
inline Biv_Dal gp(const Rot& a, const Dal& b) {
  return Biv_Dal(-a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 a[0] * b[0] - a[2] * b[2] + a[3] * b[1],
                 a[0] * b[1] + a[1] * b[2] - a[3] * b[0],
                 a[0] * b[2] - a[1] * b[1] + a[2] * b[0],
                 a[0] * b[3] + a[1] * b[4] + a[2] * b[5],
...
inline Rot gp(const Rot& a, const Rot& b) {
  return Rot(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3],
...
inline Rtd gp(const Rot& a, const Dil& b) {
  return Rtd(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0], a[0] * b[1],
...
inline Rvd gp(const Rot& a, const Tvd& b) {
  return Rvd(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0],
             a[0] * b[1] + a[1] * b[2] + a[2] * b[3],
             a[0] * b[2] - a[1] * b[1] + a[3] * b[3],
             a[0] * b[3] - a[2] * b[1] - a[3] * b[2], a[0] * b[4], a[1] * b[4],
             a[2] * b[4], a[3] * b[4], a[1] * b[3] - a[2] * b[2] + a[3] * b[1]);
}
...
inline Mtt gp(const Rot& a, const Bst& b) {
  return Mtt(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3],
             ...
             a[0] * b[7] + a[1] * b[8] + a[2] * b[9],
             a[0] * b[8] - a[1] * b[7] + a[3] * b[9],
             a[0] * b[9] - a[2] * b[7] - a[3] * b[8], a[0] * b[10],
             a[1] * b[10], a[2] * b[10], a[3] * b[10],
             a[1] * b[6] - a[2] * b[5] + a[3] * b[4],
             a[1] * b[9] - a[2] * b[8] + a[3] * b[7]);
}

inline Rot ip(const Rot& a, const Rot& b) {
  return Rot(a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3], a[0] * b[1],
             a[0] * b[2], a[0] * b[3]);
}
...
inline Rot sp(const Rot& rot, const Dil& dil) {
  const Dil& t1 = dil;
  const Rot& t2 = rot;
  Rtd t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2], t1[0] * t2[3],
         t1[1] * t2[0], t1[1] * t2[1], t1[1] * t2[2], t1[1] * t2[3]);
  const Dil& t4 = dil;
  Dil t5 = reverse(t4);
  return Rot(t3[0] * t5[0] + t3[4] * t5[1], t3[1] * t5[0] + t3[5] * t5[1],
...
inline Rot sp(const Rot& rot, const Trv& trv) {
  ...
  const Trv& t4 = trv;
  Trv t5 = reverse(t4);
  return Rot(t3[0] * t5[0], t3[1] * t5[0], t3[2] * t5[0], t3[3] * t5[0]);
}
...
inline Rot sp(const Rot& rot, const Rtc& rtc) {
  const Rtc& t1 = rtc;
  const Rot& t2 = rot;
  Rtc t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[14] * t2[3],
...
inline Rot sp(const Rot& rot, const Tvd& tvd) {
  ...
  Rvd t3(t1[0] * t2[0], t1[0] * t2[1], t1[0] * t2[2], t1[0] * t2[3],
         t1[1] * t2[0] - t1[2] * t2[1] - t1[3] * t2[2],
         t1[1] * t2[1] + t1[2] * t2[0] - t1[3] * t2[3],
         t1[1] * t2[2] + t1[2] * t2[3] + t1[3] * t2[0], t1[4] * t2[0],
         t1[4] * t2[1], t1[4] * t2[2], t1[4] * t2[3],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[3] * t2[1]);
  const Tvd& t4 = tvd;
  Tvd t5 = reverse(t4);
  return Rot(t3[0] * t5[0] + t3[7] * t5[4], t3[1] * t5[0] + t3[8] * t5[4],
...
inline Rot sp(const Rot& rot, const Bst& bst) {
  ...
  Mtt t3(t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3],
         ...
         t1[7] * t2[0] - t1[8] * t2[1] - t1[9] * t2[2],
         t1[7] * t2[1] + t1[8] * t2[0] - t1[9] * t2[3],
         t1[7] * t2[2] + t1[8] * t2[3] + t1[9] * t2[0], t1[10] * t2[0],
         t1[10] * t2[1], t1[10] * t2[2], t1[10] * t2[3],
         t1[4] * t2[3] - t1[5] * t2[2] + t1[6] * t2[1],
         t1[7] * t2[3] - t1[8] * t2[2] + t1[9] * t2[1]);
  const Bst& t4 = bst;
  Bst t5 = reverse(t4);
...
inline Rot re(const Rot& rot, const Dlp& dlp) {
  ...
  Lin_Pln t4(t1[0] * t3[0] - t1[1] * t3[1] - t1[2] * t3[2],
             t1[0] * t3[1] + t1[1] * t3[0] - t1[2] * t3[3],
             t1[0] * t3[2] + t1[1] * t3[3] + t1[2] * t3[0], t1[3] * t3[0],
...
inline Rot re(const Rot& rot, const Pln& pln) {
  ...
  const Rot& t2 = rot;
  Rot t3 = involute(t2);
  Lin_Dlp t4(-t1[3] * t3[3], t1[3] * t3[2], -t1[3] * t3[1],
             -t1[0] * t3[1] - t1[1] * t3[2] - t1[2] * t3[3],
             t1[0] * t3[0] - t1[1] * t3[3] + t1[2] * t3[2],
             t1[0] * t3[3] + t1[1] * t3[0] - t1[2] * t3[1],
             -t1[0] * t3[2] + t1[1] * t3[1] + t1[2] * t3[0], t1[3] * t3[0]);
  const Pln& t5 = pln;
  Pln t6 = reverse(t5);
  return Rot(-t4[4] * t6[0] - t4[5] * t6[1] - t4[6] * t6[2],
...
inline Rot re(const Rot& rot, const Dll& dll) {
  ...
  const Dll& t5 = dll;
  Dll t6 = reverse(t5);
  return Rot(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2],
...
inline Rot re(const Rot& rot, const Lin& lin) {
  ...
  const Rot& t2 = rot;
  Rot t3 = involute(t2);
  Lin_Dll t4(-t1[0] * t3[1] - t1[1] * t3[2] - t1[2] * t3[3],
             t1[0] * t3[0] - t1[1] * t3[3] + t1[2] * t3[2],
             t1[0] * t3[3] + t1[1] * t3[0] - t1[2] * t3[1],
             -t1[0] * t3[2] + t1[1] * t3[1] + t1[2] * t3[0],
             t1[3] * t3[0] - t1[4] * t3[1] - t1[5] * t3[2],
  ...
  const Lin& t5 = lin;
  Lin t6 = reverse(t5);
  return Rot(t4[4] * t6[3] + t4[5] * t6[4] + t4[6] * t6[5],
...
inline Rot re(const Rot& rot, const Pnt& pnt) {
  ...
  const Rot& t2 = rot;
  Rot t3 = involute(t2);
  Sta_Vec t4(t1[0] * t3[0] - t1[1] * t3[1] - t1[2] * t3[2],
             t1[0] * t3[1] + t1[1] * t3[0] - t1[2] * t3[3],
             t1[0] * t3[2] + t1[1] * t3[3] + t1[2] * t3[0], t1[3] * t3[0],
             t1[4] * t3[0], t1[3] * t3[1], t1[3] * t3[2], t1[3] * t3[3],
             t1[4] * t3[1], t1[4] * t3[2], t1[4] * t3[3],
             t1[0] * t3[3] - t1[1] * t3[2] + t1[2] * t3[1]);
  const Pnt& t5 = pnt;
  Pnt t6 = reverse(t5);
  return Rot(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[3] * t6[4] -
                 t4[4] * t6[3],
...
inline Rot re(const Rot& rot, const Par& par) {
  ...
  const Rot& t2 = rot;
  Rot t3 = involute(t2);
  Mtt t4(-t1[0] * t3[1] - t1[1] * t3[2] - t1[2] * t3[3],
         t1[0] * t3[0] - t1[1] * t3[3] + t1[2] * t3[2],
         t1[0] * t3[3] + t1[1] * t3[0] - t1[2] * t3[1],
         -t1[0] * t3[2] + t1[1] * t3[1] + t1[2] * t3[0],
         t1[3] * t3[0] - t1[4] * t3[1] - t1[5] * t3[2],
         ...
         t1[6] * t3[2] + t1[7] * t3[3] + t1[8] * t3[0], t1[9] * t3[0],
         t1[9] * t3[1], t1[9] * t3[2], t1[9] * t3[3],
         t1[3] * t3[3] - t1[4] * t3[2] + t1[5] * t3[1],
         t1[6] * t3[3] - t1[7] * t3[2] + t1[8] * t3[1]);
  const Par& t5 = par;
  Par t6 = reverse(t5);
  return Rot(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2] + t4[4] * t6[6] +
...
inline Rot re(const Rot& rot, const Cir& cir) {
  ...
  const Rot& t2 = rot;
  Rot t3 = involute(t2);
  Rtc t4(-t1[9] * t3[3], t1[9] * t3[2], -t1[9] * t3[1],
         -t1[0] * t3[1] - t1[1] * t3[2] - t1[2] * t3[3],
  ...
  const Cir& t5 = cir;
  Cir t6 = reverse(t5);
  return Rot(t4[5] * t6[3] + t4[6] * t6[4] + t4[7] * t6[5] + t4[8] * t6[0] +
...
inline Rot re(const Rot& rot, const Sph& sph) {
  ...
  const Rot& t2 = rot;
  Rot t3 = involute(t2);
  Mnk_Sta_Biv t4(-t1[3] * t3[3], t1[3] * t3[2], -t1[3] * t3[1], -t1[4] * t3[3],
                 t1[4] * t3[2], -t1[4] * t3[1],
                 -t1[0] * t3[1] - t1[1] * t3[2] - t1[2] * t3[3],
                 t1[0] * t3[0] - t1[1] * t3[3] + t1[2] * t3[2],
                 t1[0] * t3[3] + t1[1] * t3[0] - t1[2] * t3[1],
  ...
  const Sph& t5 = sph;
  Sph t6 = reverse(t5);
  return Rot(-t4[7] * t6[0] - t4[8] * t6[1] - t4[9] * t6[2] - t4[10] * t6[4] -
                 t4[11] * t6[3],
             t4[2] * t6[4] + t4[5] * t6[3] + t4[6] * t6[0] - t4[8] * t6[2] +
                 t4[9] * t6[1],

...
inline Tvd gp(const Tvd& a, const Sca& b) {
  return Tvd(a[0] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0], a[4] * b[0]);
}

inline Ori gp(const Tvd& a, const Ori& b) {
  return Ori(a[0] * b[0] - a[4] * b[0]);
}

inline Inf_Dap gp(const Tvd& a, const Inf& b) {
  return Inf_Dap(-a[1] * b[0], -a[2] * b[0], -a[3] * b[0],
                 a[0] * b[0] + a[4] * b[0], a[1] * b[0], a[2] * b[0],
                 a[3] * b[0]);
}

inline Tvd gp(const Tvd& a, const Mnk& b) {
  return Tvd(a[4] * b[0], a[1] * b[0], a[2] * b[0], a[3] * b[0], a[0] * b[0]);
}

inline Hyp_Flp gp(const Tvd& a, const Hyp& b) {
  return Hyp_Flp(-a[1] * b[1], -a[2] * b[1], -a[3] * b[1],
                 a[0] * b[0] - a[4] * b[0], a[0] * b[1] + a[4] * b[1],
                 a[1] * b[1], a[2] * b[1], a[3] * b[1]);
}

inline Ori_Sph gp(const Tvd& a, const Pss& b) {
  return Ori_Sph(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[4] * b[0],
                 a[0] * b[0]);
}

inline Pnt_Dap gp(const Tvd& a, const Pnt& b) {
  return Pnt_Dap(
      a[0] * b[0] - a[1] * b[4], a[0] * b[1] - a[2] * b[4],
      a[0] * b[2] - a[3] * b[4],
      a[0] * b[3] - a[1] * b[0] - a[2] * b[1] - a[3] * b[2] - a[4] * b[3],
      a[0] * b[4] + a[4] * b[4], -a[1] * b[1] + a[2] * b[0],
      -a[1] * b[2] + a[3] * b[0], -a[2] * b[2] + a[3] * b[1],
      a[1] * b[4] + a[4] * b[0], a[2] * b[4] + a[4] * b[1],
      a[3] * b[4] + a[4] * b[2]);
}
...
inline Tst gp(const Tvd& a, const Par& b) {
  return Tst(
      ...
      a[0] * b[6] + a[4] * b[6], a[0] * b[7] + a[4] * b[7],
      a[0] * b[8] + a[4] * b[8],
...
inline Par_Afp gp(const Tvd& a, const Cir& b) {
  return Par_Afp(
      ...
      a[0] * b[3] + a[4] * b[3], a[0] * b[4] + a[4] * b[4],
      a[0] * b[5] + a[4] * b[5], a[0] * b[6] - a[2] * b[3] - a[3] * b[4],
...
inline Pnt_Afp gp(const Tvd& a, const Sph& b) {
  return Pnt_Afp(
      a[3] * b[4] + a[4] * b[0], -a[2] * b[4] + a[4] * b[1],
      a[1] * b[4] + a[4] * b[2], -a[2] * b[0] - a[3] * b[1],
      a[1] * b[0] - a[3] * b[2], a[1] * b[1] + a[2] * b[2],
      a[0] * b[0] - a[3] * b[4], a[0] * b[1] + a[2] * b[4],
      a[0] * b[2] - a[1] * b[4],
...
inline Tst gp(const Tvd& a, const Sta& b) {
  return Tst(a[1] * b[6] + a[2] * b[7] + a[3] * b[8],
             a[0] * b[0] + a[1] * b[7] - a[2] * b[6],
             a[0] * b[1] + a[1] * b[8] - a[3] * b[6],
             a[0] * b[2] + a[2] * b[8] - a[3] * b[7],
...
inline Drv_Dap gp(const Tvd& a, const Drv& b) {
  return Drv_Dap(a[1] * b[0] + a[2] * b[1] + a[3] * b[2],
...
inline Drv_Afp gp(const Tvd& a, const Drb& b) {
  return Drv_Afp(a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
...
inline Inf_Afp gp(const Tvd& a, const Drt& b) {
  return Inf_Afp(a[3] * b[0], -a[2] * b[0], a[1] * b[0], -a[3] * b[0],
                 a[2] * b[0], -a[1] * b[0], a[0] * b[0] + a[4] * b[0]);
}

inline Tnv gp(const Tvd& a, const Tnv& b) {
  return Tnv(a[0] * b[0] - a[4] * b[0], a[0] * b[1] - a[4] * b[1],
             a[0] * b[2] - a[4] * b[2]);
}

inline Tnb gp(const Tvd& a, const Tnb& b) {
  return Tnb(a[0] * b[0] - a[4] * b[0], a[0] * b[1] - a[4] * b[1],
             a[0] * b[2] - a[4] * b[2]);
}

inline Tnt gp(const Tvd& a, const Tnt& b) {
  return Tnt(a[0] * b[0] - a[4] * b[0]);
}

inline Par_Afp gp(const Tvd& a, const Lin& b) {
  return Par_Afp(a[2] * b[0] + a[3] * b[1] + a[4] * b[3],
                 -a[1] * b[0] + a[3] * b[2] + a[4] * b[4],
                 -a[1] * b[1] - a[2] * b[2] + a[4] * b[5],
                 -a[1] * b[3] - a[2] * b[4] - a[3] * b[5],
                 -a[1] * b[4] + a[2] * b[3], -a[1] * b[5] + a[3] * b[3],
                 -a[2] * b[5] + a[3] * b[4], a[0] * b[0] + a[4] * b[0],
                 a[0] * b[1] + a[4] * b[1], a[0] * b[2] + a[4] * b[2],
...
inline Pnt_Afp gp(const Tvd& a, const Pln& b) {
  return Pnt_Afp(a[3] * b[3] + a[4] * b[0], -a[2] * b[3] + a[4] * b[1],
...
inline Trt gp(const Tvd& a, const Flp& b) {
  return Trt(a[1] * b[0] + a[2] * b[1] + a[3] * b[2] + a[4] * b[3],
             a[1] * b[1] - a[2] * b[0], a[1] * b[2] - a[3] * b[0],
             a[2] * b[2] - a[3] * b[1], a[1] * b[3], a[2] * b[3], a[3] * b[3],
             a[0] * b[0] + a[4] * b[0], a[0] * b[1] + a[4] * b[1],
             a[0] * b[2] + a[4] * b[2],
...
inline Flp_Afp gp(const Tvd& a, const Dfp& b) {
  return Flp_Afp(a[2] * b[0] + a[3] * b[1], -a[1] * b[0] + a[3] * b[2],
                 -a[1] * b[1] - a[2] * b[2], -a[3] * b[3], a[2] * b[3],
                 -a[1] * b[3], a[0] * b[0] + a[4] * b[0],
                 a[0] * b[1] + a[4] * b[1], a[0] * b[2] + a[4] * b[2],
                 -a[2] * b[0] - a[3] * b[1], a[1] * b[0] - a[3] * b[2],
                 a[1] * b[1] + a[2] * b[2],
...
inline Pnt_Dap gp(const Tvd& a, const Dlp& b) {
  return Pnt_Dap(a[0] * b[0] - a[1] * b[3], a[0] * b[1] - a[2] * b[3],
                 a[0] * b[2] - a[3] * b[3],
                 -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 a[0] * b[3] + a[4] * b[3], -a[1] * b[1] + a[2] * b[0],
                 -a[1] * b[2] + a[3] * b[0], -a[2] * b[2] + a[3] * b[1],
                 a[1] * b[3] + a[4] * b[0], a[2] * b[3] + a[4] * b[1],
                 a[3] * b[3] + a[4] * b[2]);
}

inline Ori_Par gp(const Tvd& a, const Vec& b) {
  return Ori_Par(a[0] * b[0], a[0] * b[1], a[0] * b[2],
                 -a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
                 -a[1] * b[1] + a[2] * b[0], -a[1] * b[2] + a[3] * b[0],
...
inline Ori_Cir gp(const Tvd& a, const Biv& b) {
  return Ori_Cir(a[0] * b[0], a[0] * b[1], a[0] * b[2],
                 -a[2] * b[0] - a[3] * b[1], a[1] * b[0] - a[3] * b[2],
...
inline Ori_Sph gp(const Tvd& a, const Tri& b) {
  return Ori_Sph(-a[3] * b[0], a[2] * b[0], -a[1] * b[0], a[0] * b[0],
                 a[4] * b[0]);
}
...
inline Ori_Sph gp(const Tvd& a, const Afp& b) {
  return Ori_Sph(a[0] * b[0] - a[3] * b[3] - a[4] * b[0],
...
inline Tvd gp(const Tvd& a, const Dap& b) {
  return Tvd(a[4] * b[3], a[0] * b[0] + a[1] * b[3] - a[4] * b[0],
             a[0] * b[1] + a[2] * b[3] - a[4] * b[1],
...
inline Ori_Par gp(const Tvd& a, const Dal& b) {
  return Ori_Par(a[4] * b[3], a[4] * b[4], a[4] * b[5],
                 -a[1] * b[3] - a[2] * b[4] - a[3] * b[5],
...
inline Mtt gp(const Tvd& a, const Mot& b) {
  return Mtt(a[0] * b[0] + a[1] * b[4] + a[2] * b[5] + a[3] * b[6],
             ...
             a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
             a[1] * b[1] + a[2] * b[0] - a[3] * b[3],
             a[1] * b[2] + a[2] * b[3] + a[3] * b[0], a[0] * b[4] + a[4] * b[4],
...
inline Tvd gp(const Tvd& a, const Dil& b) {
  return Tvd(a[0] * b[0] + a[4] * b[1], a[1] * b[0] + a[1] * b[1],
             a[2] * b[0] + a[2] * b[1], a[3] * b[0] + a[3] * b[1],
             a[0] * b[1] + a[4] * b[0]);
}

inline Tvd gp(const Tvd& a, const Trv& b) {
  return Tvd(a[0] * b[0], a[0] * b[1] + a[1] * b[0] - a[4] * b[1],
...
inline Trt gp(const Tvd& a, const Trs& b) {
  return Trt(a[0] * b[0] + a[1] * b[1] + a[2] * b[2] + a[3] * b[3],
             ...
             a[2] * b[3] - a[3] * b[2], a[1] * b[0], a[2] * b[0], a[3] * b[0],
             a[0] * b[1] + a[4] * b[1], a[0] * b[2] + a[4] * b[2],
             a[0] * b[3] + a[4] * b[3],
...
inline Rtc gp(const Tvd& a, const Rtc& b) {
  return Rtc(
      ...
      a[0] * b[3] - a[1] * b[0] - a[1] * b[11] - a[2] * b[1] - a[2] * b[12] -
          a[3] * b[2] - a[3] * b[13] - a[4] * b[3],
      a[0] * b[4] + a[4] * b[4],
      a[0] * b[5] - a[1] * b[1] - a[1] * b[12] + a[2] * b[0] + a[2] * b[11] -
          a[3] * b[14] - a[3] * b[15] - a[4] * b[5],
      a[0] * b[6] - a[1] * b[2] - a[1] * b[13] + a[2] * b[14] + a[2] * b[15] +
          a[3] * b[0] + a[3] * b[11] - a[4] * b[6],
      a[0] * b[7] - a[1] * b[14] - a[1] * b[15] - a[2] * b[2] - a[2] * b[13] +
          a[3] * b[1] + a[3] * b[12] - a[4] * b[7],
      a[0] * b[8] + a[4] * b[8], a[0] * b[9] + a[4] * b[9],
      a[0] * b[10] + a[4] * b[10],
...
inline Mtt gp(const Tvd& a, const Mtt& b) {
  return Mtt(
      ...
      a[0] * b[4] + a[1] * b[0] + a[1] * b[10] - a[2] * b[1] - a[2] * b[11] -
          a[3] * b[2] - a[3] * b[12] - a[4] * b[4],
      a[0] * b[5] + a[1] * b[1] + a[1] * b[11] + a[2] * b[0] + a[2] * b[10] -
          a[3] * b[3] - a[3] * b[13] - a[4] * b[5],
      a[0] * b[6] + a[1] * b[2] + a[1] * b[12] + a[2] * b[3] + a[2] * b[13] +
          a[3] * b[0] + a[3] * b[10] - a[4] * b[6],
      a[0] * b[7] + a[4] * b[7], a[0] * b[8] + a[4] * b[8],
      a[0] * b[9] + a[4] * b[9],
...
inline Rvd gp(const Tvd& a, const Rtd& b) {
  return Rvd(a[0] * b[0] + a[4] * b[4], a[0] * b[1] + a[4] * b[5],
...
inline Trt gp(const Tvd& a, const Tsd& b) {
  return Trt(
      ...
      a[1] * b[2] - a[2] * b[1], a[1] * b[3] - a[3] * b[1],
      a[2] * b[3] - a[3] * b[2], a[1] * b[0] + a[1] * b[4],
      a[2] * b[0] + a[2] * b[4], a[3] * b[0] + a[3] * b[4],
      a[0] * b[1] + a[4] * b[1], a[0] * b[2] + a[4] * b[2],
      a[0] * b[3] + a[4] * b[3],
...
inline Rvd gp(const Tvd& a, const Rvd& b) {
  return Rvd(a[0] * b[0] + a[4] * b[7], a[0] * b[1] + a[4] * b[8],
...
inline Tvd ip(const Tvd& a, const Tvd& b) {
  return Tvd(a[0] * b[0] + a[4] * b[4], a[0] * b[1], a[0] * b[2], a[0] * b[3],
             a[0] * b[4]);
}
...
inline Tvd sp(const Tvd& tvd, const Rot& rot) {
  ...
  const Rot& t4 = rot;
  Rot t5 = reverse(t4);
  return Tvd(t3[0] * t5[0] - t3[1] * t5[1] - t3[2] * t5[2] - t3[3] * t5[3],
...
inline Tvd sp(const Tvd& tvd, const Dil& dil) {
  const Dil& t1 = dil;
  const Tvd& t2 = tvd;
  Tvd t3(t1[0] * t2[0] + t1[1] * t2[4], t1[0] * t2[1] - t1[1] * t2[1],
         t1[0] * t2[2] - t1[1] * t2[2], t1[0] * t2[3] - t1[1] * t2[3],
         t1[0] * t2[4] + t1[1] * t2[0]);
  const Dil& t4 = dil;
  Dil t5 = reverse(t4);
  return Tvd(t3[0] * t5[0] + t3[4] * t5[1], t3[1] * t5[0] + t3[1] * t5[1],
...
inline Tvd sp(const Tvd& tvd, const Trv& trv) {
  const Trv& t1 = trv;
  const Tvd& t2 = tvd;
  Tvd t3(t1[0] * t2[0], t1[0] * t2[1] + t1[1] * t2[0] + t1[1] * t2[4],
         t1[0] * t2[2] + t1[2] * t2[0] + t1[2] * t2[4],
         t1[0] * t2[3] + t1[3] * t2[0] + t1[3] * t2[4], t1[0] * t2[4]);
  const Trv& t4 = trv;
  Trv t5 = reverse(t4);
  return Tvd(t3[0] * t5[0], t3[0] * t5[1] + t3[1] * t5[0] - t3[4] * t5[1],
...
inline Tvd sp(const Tvd& tvd, const Trs& trs) {
  ...
  Trt t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] + t1[3] * t2[3],
         ...
         t1[2] * t2[3] - t1[3] * t2[2], t1[0] * t2[1], t1[0] * t2[2],
         t1[0] * t2[3], t1[1] * t2[0] - t1[1] * t2[4],
  ...
  const Trs& t4 = trs;
  Trs t5 = reverse(t4);
  return Tvd(t3[0] * t5[0] + t3[4] * t5[1] + t3[5] * t5[2] + t3[6] * t5[3],
...
inline Tvd sp(const Tvd& tvd, const Rtc& rtc) {
  const Rtc& t1 = rtc;
  const Tvd& t2 = tvd;
  Rtc t3(t1[0] * t2[0] + t1[4] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3] +
             t1[11] * t2[4],
         t1[1] * t2[0] + t1[4] * t2[2] - t1[8] * t2[1] + t1[10] * t2[3] +
             t1[12] * t2[4],
         t1[2] * t2[0] + t1[4] * t2[3] - t1[9] * t2[1] - t1[10] * t2[2] +
             t1[13] * t2[4],
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[3] * t2[0] +
             t1[3] * t2[4] - t1[11] * t2[1] - t1[12] * t2[2] - t1[13] * t2[3],
         t1[4] * t2[0] - t1[4] * t2[4],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[5] * t2[0] + t1[5] * t2[4] -
             t1[11] * t2[2] + t1[12] * t2[1] + t1[14] * t2[3] - t1[15] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] + t1[6] * t2[0] + t1[6] * t2[4] -
             t1[11] * t2[3] + t1[13] * t2[1] - t1[14] * t2[2] + t1[15] * t2[2],
         t1[1] * t2[3] - t1[2] * t2[2] + t1[7] * t2[0] + t1[7] * t2[4] -
             t1[12] * t2[3] + t1[13] * t2[2] + t1[14] * t2[1] - t1[15] * t2[1],
         t1[8] * t2[0] - t1[8] * t2[4], t1[9] * t2[0] - t1[9] * t2[4],
         t1[10] * t2[0] - t1[10] * t2[4],
         t1[0] * t2[4] + t1[4] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3] +
             t1[11] * t2[0],
         t1[1] * t2[4] + t1[4] * t2[2] - t1[8] * t2[1] + t1[10] * t2[3] +
             t1[12] * t2[0],
         t1[2] * t2[4] + t1[4] * t2[3] - t1[9] * t2[1] - t1[10] * t2[2] +
             t1[13] * t2[0],
         t1[8] * t2[3] - t1[9] * t2[2] + t1[10] * t2[1] + t1[14] * t2[0] +
             t1[15] * t2[4],
         t1[8] * t2[3] - t1[9] * t2[2] + t1[10] * t2[1] + t1[14] * t2[4] +
             t1[15] * t2[0]);
  const Rtc& t4 = rtc;
  Rtc t5 = reverse(t4);
  return Tvd(
...
inline Tvd sp(const Tvd& tvd, const Mtt& mtt) {
  const Mtt& t1 = mtt;
  const Tvd& t2 = tvd;
  Mtt t3(t1[0] * t2[0] + t1[7] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3] +
             t1[10] * t2[4],
         ...
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[4] * t2[0] +
             t1[4] * t2[4] - t1[10] * t2[1] - t1[11] * t2[2] - t1[12] * t2[3],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3] + t1[5] * t2[0] +
             t1[5] * t2[4] - t1[10] * t2[2] + t1[11] * t2[1] - t1[13] * t2[3],
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[6] * t2[0] +
             t1[6] * t2[4] - t1[10] * t2[3] + t1[12] * t2[1] + t1[13] * t2[2],
         t1[7] * t2[0] - t1[7] * t2[4], t1[8] * t2[0] - t1[8] * t2[4],
         t1[9] * t2[0] - t1[9] * t2[4],
         t1[0] * t2[4] + t1[7] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3] +
             t1[10] * t2[0],
...
inline Tvd sp(const Tvd& tvd, const Rtd& rtd) {
  const Rtd& t1 = rtd;
  const Tvd& t2 = tvd;
  Rvd t3(t1[0] * t2[0] + t1[4] * t2[4], t1[1] * t2[0] + t1[5] * t2[4],
...
inline Tvd sp(const Tvd& tvd, const Tsd& tsd) {
  ...
  Trt t3(t1[0] * t2[0] + t1[1] * t2[1] + t1[2] * t2[2] + t1[3] * t2[3] +
             t1[4] * t2[4],
         t1[1] * t2[2] - t1[2] * t2[1], t1[1] * t2[3] - t1[3] * t2[1],
         t1[2] * t2[3] - t1[3] * t2[2], t1[0] * t2[1] - t1[4] * t2[1],
         t1[0] * t2[2] - t1[4] * t2[2], t1[0] * t2[3] - t1[4] * t2[3],
         t1[1] * t2[0] - t1[1] * t2[4], t1[2] * t2[0] - t1[2] * t2[4],
         t1[3] * t2[0] - t1[3] * t2[4],
         t1[0] * t2[4] + t1[1] * t2[1] + t1[2] * t2[2] + t1[3] * t2[3] +
             t1[4] * t2[0],
         t1[1] * t2[2] - t1[2] * t2[1], t1[1] * t2[3] - t1[3] * t2[1],
...
inline Tvd sp(const Tvd& tvd, const Trt& trt) {
  const Trt& t1 = trt;
  const Tvd& t2 = tvd;
  Tst t3(t1[0] * t2[0] + t1[7] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3] +
             t1[10] * t2[4],
         t1[1] * t2[0] + t1[7] * t2[2] - t1[8] * t2[1] + t1[11] * t2[4],
         t1[2] * t2[0] + t1[7] * t2[3] - t1[9] * t2[1] + t1[12] * t2[4],
         t1[3] * t2[0] + t1[8] * t2[3] - t1[9] * t2[2] + t1[13] * t2[4],
...
inline Tvd sp(const Tvd& tvd, const Rvd& rvd) {
  const Rvd& t1 = rvd;
  const Tvd& t2 = tvd;
  Rvd t3(t1[0] * t2[0] + t1[7] * t2[4], t1[1] * t2[0] + t1[8] * t2[4],
...
inline Tvd sp(const Tvd& tvd, const Bst& bst) {
  ...
  Tst t3(t1[0] * t2[0] + t1[7] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3] +
         ...
         t1[0] * t2[1] + t1[1] * t2[2] + t1[2] * t2[3] + t1[4] * t2[0] +
             t1[4] * t2[4] - t1[10] * t2[1],
         t1[0] * t2[2] - t1[1] * t2[1] + t1[3] * t2[3] + t1[5] * t2[0] +
             t1[5] * t2[4] - t1[10] * t2[2],
         t1[0] * t2[3] - t1[2] * t2[1] - t1[3] * t2[2] + t1[6] * t2[0] +
             t1[6] * t2[4] - t1[10] * t2[3],
         t1[7] * t2[0] - t1[7] * t2[4], t1[8] * t2[0] - t1[8] * t2[4],
         t1[9] * t2[0] - t1[9] * t2[4],
         t1[0] * t2[4] + t1[7] * t2[1] + t1[8] * t2[2] + t1[9] * t2[3] +
             t1[10] * t2[0],
...
inline Tvd re(const Tvd& tvd, const Vec& vec) {
  ...
  const Tvd& t2 = tvd;
  Tvd t3 = involute(t2);
  Ori_Par t4(t1[0] * t3[0], t1[1] * t3[0], t1[2] * t3[0],
  ...
  const Vec& t5 = vec;
  Vec t6 = reverse(t5);
  return Tvd(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2],
...
inline Tvd re(const Tvd& tvd, const Dlp& dlp) {
  ...
  const Tvd& t2 = tvd;
  Tvd t3 = involute(t2);
  Pnt_Dap t4(t1[0] * t3[0] + t1[3] * t3[1], t1[1] * t3[0] + t1[3] * t3[2],
             t1[2] * t3[0] + t1[3] * t3[3],
             t1[0] * t3[1] + t1[1] * t3[2] + t1[2] * t3[3],
             t1[3] * t3[0] - t1[3] * t3[4], t1[0] * t3[2] - t1[1] * t3[1],
             t1[0] * t3[3] - t1[2] * t3[1], t1[1] * t3[3] - t1[2] * t3[2],
             t1[0] * t3[4] + t1[3] * t3[1], t1[1] * t3[4] + t1[3] * t3[2],
             t1[2] * t3[4] + t1[3] * t3[3]);
  const Dlp& t5 = dlp;
  Dlp t6 = reverse(t5);
  return Tvd(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[3] * t6[3],
...
inline Tvd re(const Tvd& tvd, const Pln& pln) {
  ...
  const Tvd& t2 = tvd;
  Tvd t3 = involute(t2);
  Pnt_Afp t4(t1[0] * t3[4] + t1[3] * t3[3], t1[1] * t3[4] - t1[3] * t3[2],
  ...
  const Pln& t5 = pln;
  Pln t6 = reverse(t5);
  return Tvd(-t4[6] * t6[0] - t4[7] * t6[1] - t4[8] * t6[2] - t4[9] * t6[3],
...
inline Tvd re(const Tvd& tvd, const Dll& dll) {
  ...
  const Tvd& t2 = tvd;
  Tvd t3 = involute(t2);
  Tst t4(t1[3] * t3[1] + t1[4] * t3[2] + t1[5] * t3[3],
         ...
         -t1[1] * t3[1] - t1[2] * t3[2], t1[3] * t3[0] - t1[3] * t3[4],
         t1[4] * t3[0] - t1[4] * t3[4], t1[5] * t3[0] - t1[5] * t3[4],
  ...
  const Dll& t5 = dll;
  Dll t6 = reverse(t5);
  return Tvd(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2] + t4[4] * t6[3] +
                 t4[5] * t6[4] + t4[6] * t6[5],
...
inline Tvd re(const Tvd& tvd, const Lin& lin) {
  ...
  const Tvd& t2 = tvd;
  Tvd t3 = involute(t2);
  Par_Afp t4(t1[0] * t3[2] + t1[1] * t3[3] + t1[3] * t3[4],
             -t1[0] * t3[1] + t1[2] * t3[3] + t1[4] * t3[4],
             -t1[1] * t3[1] - t1[2] * t3[2] + t1[5] * t3[4],
             -t1[3] * t3[1] - t1[4] * t3[2] - t1[5] * t3[3],
             -t1[3] * t3[2] + t1[4] * t3[1], -t1[3] * t3[3] + t1[5] * t3[1],
             -t1[4] * t3[3] + t1[5] * t3[2], t1[0] * t3[0] - t1[0] * t3[4],
             t1[1] * t3[0] - t1[1] * t3[4], t1[2] * t3[0] - t1[2] * t3[4],
  ...
  const Lin& t5 = lin;
  Lin t6 = reverse(t5);
  return Tvd(t4[4] * t6[0] + t4[5] * t6[1] + t4[6] * t6[2] + t4[10] * t6[3] +
...
inline Tvd re(const Tvd& tvd, const Pnt& pnt) {
  ...
  const Tvd& t2 = tvd;
  Tvd t3 = involute(t2);
  Pnt_Dap t4(t1[0] * t3[0] + t1[4] * t3[1], t1[1] * t3[0] + t1[4] * t3[2],
             t1[2] * t3[0] + t1[4] * t3[3],
             t1[0] * t3[1] + t1[1] * t3[2] + t1[2] * t3[3] + t1[3] * t3[0] +
                 t1[3] * t3[4],
             t1[4] * t3[0] - t1[4] * t3[4], t1[0] * t3[2] - t1[1] * t3[1],
             t1[0] * t3[3] - t1[2] * t3[1], t1[1] * t3[3] - t1[2] * t3[2],
             t1[0] * t3[4] + t1[4] * t3[1], t1[1] * t3[4] + t1[4] * t3[2],
             t1[2] * t3[4] + t1[4] * t3[3]);
  const Pnt& t5 = pnt;
  Pnt t6 = reverse(t5);
  return Tvd(t4[0] * t6[0] + t4[1] * t6[1] + t4[2] * t6[2] - t4[3] * t6[4] -
                 t4[4] * t6[3],
...
inline Tvd re(const Tvd& tvd, const Par& par) {
  ...
  const Tvd& t2 = tvd;
  Tvd t3 = involute(t2);
  Tst t4(t1[6] * t3[1] + t1[7] * t3[2] + t1[8] * t3[3] + t1[9] * t3[4],
         ...
         -t1[1] * t3[1] - t1[2] * t3[2] + t1[5] * t3[0] + t1[5] * t3[4] -
             t1[9] * t3[3],
         t1[6] * t3[0] - t1[6] * t3[4], t1[7] * t3[0] - t1[7] * t3[4],
         t1[8] * t3[0] - t1[8] * t3[4],
  ...
  const Par& t5 = par;
  Par t6 = reverse(t5);
  return Tvd(-t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[2] + t4[4] * t6[6] +
...
inline Tvd re(const Tvd& tvd, const Cir& cir) {
  ...
  const Tvd& t2 = tvd;
  Tvd t3 = involute(t2);
  Par_Afp t4(t1[3] * t3[2] + t1[4] * t3[3] + t1[6] * t3[4],
             -t1[3] * t3[1] + t1[5] * t3[3] + t1[7] * t3[4],
             -t1[4] * t3[1] - t1[5] * t3[2] + t1[8] * t3[4],
             -t1[6] * t3[1] - t1[7] * t3[2] - t1[8] * t3[3],
             t1[0] * t3[0] + t1[0] * t3[4] - t1[6] * t3[2] + t1[7] * t3[1] +
                 t1[9] * t3[3],
             t1[1] * t3[0] + t1[1] * t3[4] - t1[6] * t3[3] + t1[8] * t3[1] -
                 t1[9] * t3[2],
             t1[2] * t3[0] + t1[2] * t3[4] - t1[7] * t3[3] + t1[8] * t3[2] +
                 t1[9] * t3[1],
  ...
  const Cir& t5 = cir;
  Cir t6 = reverse(t5);
  return Tvd(t4[4] * t6[3] + t4[5] * t6[4] + t4[6] * t6[5] + t4[7] * t6[0] +
                 t4[8] * t6[1] + t4[9] * t6[2] + t4[10] * t6[6] +
                 t4[11] * t6[7] + t4[12] * t6[8] - t4[13] * t6[9],
             -t4[1] * t6[0] - t4[2] * t6[1] - t4[3] * t6[6] - t4[4] * t6[7] -
...
inline Tvd re(const Tvd& tvd, const Sph& sph) {
  ...
  const Tvd& t2 = tvd;
  Tvd t3 = involute(t2);
  Pnt_Afp t4(t1[0] * t3[4] + t1[4] * t3[3], t1[1] * t3[4] - t1[4] * t3[2],
             t1[2] * t3[4] + t1[4] * t3[1], -t1[0] * t3[2] - t1[1] * t3[3],
             t1[0] * t3[1] - t1[2] * t3[3], t1[1] * t3[1] + t1[2] * t3[2],
             t1[0] * t3[0] + t1[4] * t3[3], t1[1] * t3[0] - t1[4] * t3[2],
             t1[2] * t3[0] + t1[4] * t3[1],
  ...
  const Sph& t5 = sph;
  Sph t6 = reverse(t5);
  return Tvd(-t4[6] * t6[0] - t4[7] * t6[1] - t4[8] * t6[2] - t4[9] * t6[4] -
                 t4[10] * t6[3],

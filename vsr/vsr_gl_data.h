...
/*
    ...
    Higher Level Data containers, combine VBOs with Meshes, Framebuffers with
   Textures, etc
...
struct MBO {
  ...
  //                mCount +=1;
  //                VBO( &mesh.vertices()[0].Pos[0], mesh.num(), mesh.num() *
  //                sizeof(Vertex), GL::VERTEXBUFFER ); VBO( &mesh.indices()[0],
  //                mesh.numIdx(), mesh.numIdx() * sizeof(GLuint),
  //                GL::ELEMENTBUFFER ); return tmp;
  //            }
};
